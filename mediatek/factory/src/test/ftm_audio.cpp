...
#include <include/AudioMTKHeadsetMessager.h>
...
static item_t audio_items_loopback[] = {
    ...
    {ITEM_MIC1, uistr_info_audio_loopback_dualmic_mi1, 0},
    {ITEM_MIC2, uistr_info_audio_loopback_dualmic_mi2, 0},
#endif
...
#ifdef MTK_DUAL_MIC_SUPPORT
	{ITEM_DUALMIC_DMNR, uistr_info_audio_acoustic_loopback_DMNR, 0},
#endif
	{ITEM_DUALMIC_NO_DMNR, uistr_info_audio_acoustic_loopback_without_DMNR, 0},
	{ITEM_PASS,  uistr_pass, 0},
    {ITEM_FAIL,  uistr_fail, 0},
    {-1, NULL, 0},
};
...
static item_t receiver_items[] = {
    ...
    {ITEM_MIC2, uistr_info_audio_loopback_dualmic_mi2, 0},
#else
    {ITEM_MIC1, uistr_info_audio_loopback_dualmic_mic, 0},
#endif
    {ITEM_PASS, uistr_pass, 0},
    {ITEM_FAIL, uistr_fail, 0},
	{-1, NULL, 0},
...
//    dumpFlag=true;//for test
    ...
    while (1) {
       ...
       int readSize  = readRecordData(pbuffer,512*2);
       for(int i = 0 ; i < 256 ; i++)
       {
