...
//auto test
#define camera_autoTest 2 //  0: disable auto test, 1: pin error method , 2: test pattern method 
...
#if (camera_autoTest == 1)
        err = camera_capture_autotest();
#elif (camera_autoTest == 2)
