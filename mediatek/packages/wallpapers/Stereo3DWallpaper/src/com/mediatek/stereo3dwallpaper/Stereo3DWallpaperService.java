...
public class Stereo3DWallpaperService extends StageWallpaperService {
    ...
    private static final float EYE_DIST = 37.033f;
    ...
    class Stereo3DWallpaperEngine extends StageEngine {
        ...
        class WallpaperObserver extends BroadcastReceiver {
            public void onReceive(Context context, Intent intent) {
                ...
                Stereo3DLog.log(TAG, "Receive wallpaper update intent");
                // use for auto test
                ...
                int prefWallpaperId = getPrefsWallpaperId();

                if (mWallpaperId != prefWallpaperId) {
                    updateWallpaper(prefWallpaperId);
                }
            }
        }
        ...
        public void onCreate(SurfaceHolder surfaceHolder) {
            ...
            IntentFilter wallpaperFilter = new IntentFilter(
                    Stereo3DWallpaperChooserFragment.WALLPAPER_CHANGED);
            registerReceiver(mReceiver, wallpaperFilter);
        ...
        public void onVisibilityChanged(boolean visible) {
            ...
            if (visible) {
                ...
                mEngine.set3DLayout(WindowManager.LayoutParams.LAYOUT3D_SIDE_BY_SIDE);
                mStage.setStereo3D(true, EYE_DIST);
            } else {
                Stereo3DLog.log(TAG, "onVisibilityChanged() - 3D mode: DISABLE");
                mEngine.set3DLayout(WindowManager.LayoutParams.LAYOUT3D_DISABLED);
