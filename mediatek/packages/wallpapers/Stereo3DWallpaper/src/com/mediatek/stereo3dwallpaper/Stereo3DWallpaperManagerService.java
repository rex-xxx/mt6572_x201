...
public class Stereo3DWallpaperManagerService extends Service {
    ...
    protected static final String WALLPAPER_CHANGED
        = "com.mediatek.stereo3dwallpaper.ACTION_WALLPAPER_CHANGED";
    ...
    private void setWallpaperService() {
        ...
        try {
            ...
            WallpaperInfo info = wallpaperManager.getIWallpaperManager().getWallpaperInfo();
            ...
            if (info == null || (WALLPAPER_SERVICE_NAME).compareTo(info.getServiceName()) != 0) {
                ...
                // notify Stereo3DPairWallpaperService about the change
                final Intent intent = new Intent(WALLPAPER_CHANGED);
