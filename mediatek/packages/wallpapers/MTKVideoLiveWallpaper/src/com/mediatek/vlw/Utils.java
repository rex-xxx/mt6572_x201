...
public final class Utils {
    ...
    /**
     * This method used to get all the video in a folder.
     * 
     * @param context
     * @param bucketId The bucketId of the folder will be checked.
     */
    public static ArrayList<Uri> getUrisFromBucketId(Context context,
            String bucketId) {
        ArrayList<Uri> uris = new ArrayList<Uri>();
        Cursor cursor = null;
        try {
            String where = MediaStore.Video.VideoColumns.BUCKET_ID + EQUALS
                    + bucketId;
    ...
    public static String queryBucketId(Context context, String videoPath) {
        ...
        try {
            ...
            String where = MediaStore.Video.VideoColumns.DATA + EQUALS 
                    + "'" + videoPath + "'";
            ContentResolver cr = context.getContentResolver();
