...
public class VideoEditor extends Activity {
    ...
    private static final String VIDEO_LIVE_WALLPAPER_CLASS = "com.mediatek.vlw.VideoLiveWallpaper";
                ...
                if (mPrevUri != null && mPrevBucketId != null
                    ...
                    Xlog.d(TAG,
                            "Receive ACTION_MEDIA_SCANNER_FINISHED , mBucketId"
                                    + mBucketId);
                    mUriList = Utils.getUrisFromBucketId(VideoEditor.this,
                            mBucketId);
                    restoreMountedData();
                    if (mProgressDialog != null) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSharedPref = getSharedPreferences(VideoScene.SHARED_PREFS_FILE,
    ...
    private void restoreSavedInstance(Bundle savedInstanceState) {
        ...
        pos = savedInstanceState.getInt(VideoScene.CURRENT_POSITION);
        ...
        if (resultCode == Activity.RESULT_OK && data != null) {
            ...
            case PICK_VIDEO_REQUEST:
                ...
                if (uri != null && (!uri.equals(mUri) || mBucketId != null)) {
                    ...
                    Xlog.d(TAG, "PICK_VIDEO_REQUEST, uri=" + uri + " mUri="
                            + mUri);
                    startPlayback();
                }
                break;
