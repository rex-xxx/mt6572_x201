...
public class VLWMediaController extends MediaController {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if ((posY > bottom && startOffset < endOffset
                && !mEditorBarEnd.isPressed())
                || mEditorBarStart.isPressed()
            ) {
            ...
            if (FeatureOption.MTK_THEMEMANAGER_APP) {
                ...
                if (textColor != 0) {
                    ...
                    case PROGRESSRASPBERRY:
                        Drawable drawableRaspberry = mContext.getResources()
                                .getDrawable(R.drawable.progressraspberry);
                        mProgressBar.setProgressDrawable(drawableRaspberry);
                        break;
                    case PROGRESSMINT:
                        Drawable drawableMint = mContext.getResources()
                                .getDrawable(R.drawable.progressmint);
                        mProgressBar.setProgressDrawable(drawableMint);
                        break;
                    case PROGRESSMOCHA:
                        Drawable drawableMocha = mContext.getResources()
                                .getDrawable(R.drawable.progressmocha);
    ...
    protected int setProgress() {
        ...
        if (curPos < mNewPosition && curPos < mEndPosition
