...
public class ToneDialog extends Activity {
    ...
    private final BroadcastReceiver mSIMStateChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (TelephonyIntents.ACTION_SIM_STATE_CHANGED.equals(intent.getAction())) {
                ...
                CatLog.d(LOGTAG, "mSIMStateChangeReceiver - simId[" + simId + "]  state[" + simState + "], mSimId: " + ToneDialog.this.mSimId);
                
                if ((simId == ToneDialog.this.mSimId) && 
    ...
    protected void onDestroy() {
        ...
        if (mIsResponseSent) {
            CatLog.d(LOGTAG, "onDestroy - removeMessages");
