 ...
 *
 */
public class StkMenuActivityIII extends ListActivity {
    ...
    private final BroadcastReceiver mSIMStateChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (TelephonyIntents.ACTION_SIM_STATE_CHANGED.equals(intent.getAction())) {
                ...
                if ((simId == com.android.internal.telephony.PhoneConstants.GEMINI_SIM_3) && 
                    ...
                    {
                        StkMenuActivityIII.this.mMenuInstance.sendResponse(StkAppService.RES_ID_END_SESSION);
                    }
                    StkMenuActivityIII.this.mMenuInstance.cancelTimeOut();
                    StkMenuActivityIII.this.finish();
                }
            }
        }
    };
