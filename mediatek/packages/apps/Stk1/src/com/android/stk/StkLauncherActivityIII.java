...
public class StkLauncherActivityIII extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (service != null && service.StkQueryAvailable(PhoneConstants.GEMINI_SIM_3) != StkAppService.STK_AVAIL_AVAILABLE)
        {
        ...
        op[1] = PhoneConstants.GEMINI_SIM_3;
        args.putIntArray(StkAppService.OPCODE, op);
        args.putInt(StkAppService.CMD_SIM_ID, PhoneConstants.GEMINI_SIM_3);
