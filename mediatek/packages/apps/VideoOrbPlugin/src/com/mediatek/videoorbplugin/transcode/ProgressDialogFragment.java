...
public class ProgressDialogFragment extends DialogFragment {
    ...
    public static ProgressDialogFragment newInstance(int idPrompt) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        pdlg.setButton(DialogInterface.BUTTON_POSITIVE, getString(R.string.cancel), new ClickListener());
