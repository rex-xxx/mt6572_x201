...
public class TsMultiTouchTest extends ActivityInstrumentationTestCase2<TsMultiTouch> {
    private static final String TAG = "TsRateReport";
    ...
    public TsMultiTouchTest() {
        super(TsMultiTouch.class);
    }
    ...
    public void test02_TouchTest() {
        ...
        mSolo.assertCurrentActivity("Not TsMultiTouch Class", TsMultiTouch.class);
        
        // set point size
        mSolo.pressMenuItem(1);
        mSolo.sleep(EmOperate.TIME_SUPER_LONG);  
        
        if (!mSolo.getCurrentEditTexts().isEmpty()) {
            mSolo.enterText(0, "4");  
            mSolo.sleep(EmOperate.TIME_SUPER_LONG);  
