...
public class EmFunctionalTestRunner extends JUnitInstrumentationTestRunner {
    ...
    public TestSuite getAllTests() {
        ...
        tests.addTestSuite(SimMeLockEntryTest.class);
        ...
        tests.addTestSuite(CmmbActivityTest.class);
        ...
        tests.addTestSuite(NetworkSettingTest.class);
        ...
        tests.addTestSuite(TvOutTest.class);
        tests.addTestSuite(TvOutTestPatter.class);
