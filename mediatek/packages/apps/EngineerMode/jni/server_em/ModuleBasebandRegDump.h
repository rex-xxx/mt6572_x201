...
#if defined(MT6573)
#define REG_BASE       (0x70000000)/* physical address */
#elif defined(MT6516)
#define REG_BASE       (0x80000000)/* physical address 6516 0x80000*/
#elif defined(MT6575)
#define REG_BASE       (0xC0000000)/* physical address 6575 0xC0000*/    
#elif defined(MT6577)
#define REG_BASE       (0xC0000000)/* physical address 6577 0xC0000*/  
#else
#define REG_BASE       (0x70000000)/* physical address */
#endif
