...
#if defined(MT6589) || defined(MT6582)
#define MSDC_MAX_HOST_MUM 4
#elif defined(MT6572)
#define MSDC_MAX_HOST_MUM 1
#else
#define MSDC_MAX_HOST_MUM 3
#endif
...
XLOGD("3 after ioctl\n");
  ...
  if(opcode == 0){
  /* MT6589 or newer chip use this */
#if !defined(MT6575) && !defined(MT6577) && !defined(MT6573) && !defined(MT6516)
...
#else
    /* the chip older than MT6589 use this  */
