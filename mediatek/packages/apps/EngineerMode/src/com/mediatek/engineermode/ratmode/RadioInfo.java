...
public class RadioInfo extends Activity {
        ...
        public void handleMessage(Message msg) {
            ...
            case EVENT_QUERY_PREFERRED_TYPE_DONE:
                ...
                if (ar.exception == null) {
                    ...
                    case WCDMA_PREFERRED_VALUE:
                        mPreferredNetworkType.setSelection(
                                WCDMA_PREFERRED_INDEX, true);
                        break;
                    case GSM_ONLY_VALUE:
                        mPreferredNetworkType
                                .setSelection(GSM_ONLY_INDEX, true);
                        break;
                    case WCDMA_ONLY_VALUE:
                        mPreferredNetworkType.setSelection(WCDMA_ONLY_INDEX,
                                true);
                        break;
                    case GSM_WCDMA_AUTO_VALUE:
                        mPreferredNetworkType.setSelection(
                                GSM_WCDMA_AUTO_INDEX, true);
                            break;
                    default:
                        break;
                    }
                    ...
                    Toast
                    .makeText(RadioInfo.this, R.string.rat_query_preferred_type, Toast.LENGTH_SHORT).show();
                }
                break;
            case EVENT_SET_PREFERRED_TYPE_DONE:
                ...
                if (ar.exception != null) {
                    ...
                    mPhone
                            .getPreferredNetworkType(obtainMessage(EVENT_QUERY_PREFERRED_TYPE_DONE));
                    }
                }
                break;
            default:
    ...
    mIsTddType = BandSelect.getModemType();
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
        ...
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            mGeminiPhone.getPreferredNetworkTypeGemini(mHandler
                    .obtainMessage(EVENT_QUERY_PREFERRED_TYPE_DONE),
                    PhoneConstants.GEMINI_SIM_1);
        } else {
        ...
        if (mTelephonyExt.isRatMenuControlledBySIM()) {
            if (FeatureOption.MTK_GEMINI_SUPPORT) {
                ...
                if (-1 == mModeType) {
                    ...
                    mStatusEfRat = mGeminiPhone.getEfRatBalancing(mModeType);
