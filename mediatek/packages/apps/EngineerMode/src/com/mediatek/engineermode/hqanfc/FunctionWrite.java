...
public class FunctionWrite extends Activity {
    ...
    private RadioButton mRbTypeOther;
    ...
    private void initComponents() {
        ...
        // mRbTypeUri = (RadioButton) findViewById(R.id.hqa_write_rb_type_uri);
        // mRbTypeText = (RadioButton)
        // findViewById(R.id.hqa_write_rb_type_text);
        // mRbTypeSmart = (RadioButton)
        // findViewById(R.id.hqa_write_rb_type_smart);
        mRbTypeOther = (RadioButton) findViewById(R.id.hqa_write_rb_type_others);
        mRbTypeOther.setVisibility(View.GONE);
    ...
    protected void checkedChange(int checkedId) {
        switch (checkedId) {
            ...
            case R.id.hqa_write_rb_type_text:
                ...
                break;
            case R.id.hqa_write_rb_type_smart:
                mSpLang.setEnabled(false);
                ...
                mEtUrl.setText("");
                mEtCompany.setText("");
                mEtCompany.setSelection(mEtCompany.getText().length());
                break;
            default:
                break;
        }
