...
public class ConfigFD extends Activity {
    ...
    protected void onResume() {
        super.onResume();
        if (null != mReturnData && null != mReturnData[1] && mReturnData[1].equals("0")) {
            mRadioGroup.check(R.id.fd_off_radio);
        } else if (null != mReturnData && null != mReturnData[1] && mReturnData[1].equals("1")) {
            ...
            if (v.getId() == R.id.fd_set_button) {
                ...
                if (checkedId == R.id.fd_on_radio) {
                    if (null != mReturnData && null != mReturnData[0] && mFdValue != -1) {
                        int mToModem = mFdValue & FD_ON;
                        Elog.i(TAG, "To Modem :" + mToModem);
                        cmdStr[0] = "AT+EPCT=" + mReturnData[0] + "," + mToModem;
                        cmdStr[1] = "";
