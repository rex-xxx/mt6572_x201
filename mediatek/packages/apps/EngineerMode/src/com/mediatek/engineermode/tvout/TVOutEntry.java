...
public class TVOutEntry extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    private CheckBoxPreference mHaveTvoutCheck;
    private Preference mChineseTestPatter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHaveTvoutCheck = (CheckBoxPreference) findPreference(TVOUT_ENABLE);
        mChineseTestPatter = findPreference(CHINESE_TEST_PATT);
        mTVSystem = (ListPreference) findPreference(KEY_TV_SYSTEM);
        if (mTvOut == null) {
            mTvOut = MediatekClassFactory.createInstance(ITVOUTNative.class);
        }
        mHaveTvoutCheck.setOnPreferenceChangeListener(this);
        mChineseTestPatter.setOnPreferenceChangeListener(this);
     ...
     *            : selected preference
     * @param newValue
     *            : selected perference value
     * @return whether changed success
     */
