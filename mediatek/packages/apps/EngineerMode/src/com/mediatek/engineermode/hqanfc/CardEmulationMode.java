...
public class CardEmulationMode extends Activity {
    ...
    private CheckBox mCbSwio1;
    private CheckBox mCbSwio2;
    private CheckBox mCbSwioSe;
    private CheckBox mCbVirtualCardFunct;
    ...
    private void initComponents() {
        ...
        mCbSwio1 = (CheckBox) findViewById(R.id.hqa_cardmode_cb_swio1);
        mCbSwio2 = (CheckBox) findViewById(R.id.hqa_cardmode_cb_swio2);
        mCbSwioSe = (CheckBox) findViewById(R.id.hqa_cardmode_cb_swio_se);
    ...
    private void changeAllSelect(boolean checked) {
        ...
        mCbSwio1.setChecked(checked);
        mCbSwio2.setChecked(checked);
        mCbSwioSe.setChecked(checked);
        mCbVirtualCardFunct.setChecked(checked);
    }
    ...
    private void fillRequest(Boolean bStart, NfcEmAlsCardmReq requestCmd) {
        ...
        requestCmd.mFgVirtualCard = mCbVirtualCardFunct.isChecked() ? 1 : 0;
    }
