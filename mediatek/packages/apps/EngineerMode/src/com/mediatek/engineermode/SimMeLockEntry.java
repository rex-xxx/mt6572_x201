...
/**
 * 
 * Description: The entrance of SIMMELOCK module
 * 
 */
public class SimMeLockEntry {
    ...
    public static void startActivity(final Intent intent) {
        ...
        if (!FeatureOption.MTK_GEMINI_SUPPORT) {
            ...
            intent.setComponent(new ComponentName("com.android.simmelock",
                    "com.android.simmelock.LockList"));
        } else {
            ...
            intent.setComponent(new ComponentName("com.android.simmelock",
                    "com.android.simmelock.TabLockList"));
        }
    }
}
