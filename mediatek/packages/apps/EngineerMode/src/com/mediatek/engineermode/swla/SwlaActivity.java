        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_ASSERT:
                ...
                if (ar.exception == null) {
                    ...
                    new AlertDialog.Builder(SwlaActivity.this).setTitle("Failed").setMessage("Assert Modem Failed.")
                            .setPositiveButton("OK", null).show();
                    Toast.makeText(SwlaActivity.this, "Failed.", Toast.LENGTH_LONG).show();
                }
                break;
            case MSG_SWLA_ENABLE:
                ar = (AsyncResult) msg.obj;
                if (ar.exception == null) {
                    Toast.makeText(SwlaActivity.this, "Success", Toast.LENGTH_LONG).show();
                } else {
                    new AlertDialog.Builder(SwlaActivity.this).setTitle("Failed").setMessage("Enable Softwore LA Failed.")
                            .setPositiveButton("OK", null).show();
                    Toast.makeText(SwlaActivity.this, "Failed.", Toast.LENGTH_LONG).show();
                }
                break;
