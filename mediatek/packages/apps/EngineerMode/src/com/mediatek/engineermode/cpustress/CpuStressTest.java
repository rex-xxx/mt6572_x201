...
public class CpuStressTest extends CpuStressCommon implements 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!TYPE_LOAD_ENG.equals(Build.TYPE)) {
        ...
        mRbDefault = (RadioButton) this
                .findViewById(R.id.hqa_cpu_main_raidobutton_default);
        mRbTest = (RadioButton) this
        ...
        mRdoBtn[4] = mRbTriple;
        mRdoBtn[5] = mRbQuad;
        mListCpuTestItem = new ArrayList<String>(Arrays
                .asList(HQA_CPU_STRESS_TEST_ITEMS));
    ...
    private void updateCbThermal() {
        ...
        mCbThermal
                .setChecked(CpuStressTestService.sIsThermalDisabled);
        mCbThermal
                .setEnabled(CpuStressTestService.sIsThermalSupport);
    }
