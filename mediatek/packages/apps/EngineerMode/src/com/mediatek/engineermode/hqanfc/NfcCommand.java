...
public class NfcCommand {
    ...
    public static class BitMapValue {
        public static int getTypeValue(CheckBox[] checkBoxs) {
            ...
            result |= checkBoxs[POS_5].isChecked() ? NfcCommand.EM_ALS_READER_M_TYPE_KOVIO : 0;
            return result;
        }

        public static int getTypeAbDataRateValue(CheckBox[] checkBoxs) {
            int result = 0;
        ...
        public static int getTypeFDataRateValue(CheckBox[] checkBoxs) {
            int result = 0;
        ...
        public static int getTypeVDataRateValue(CheckBox[] checkBoxs) {
            int result = 0;
