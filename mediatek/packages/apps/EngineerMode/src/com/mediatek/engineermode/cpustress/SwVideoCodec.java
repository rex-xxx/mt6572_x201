...
public class SwVideoCodec extends CpuStressCommon implements OnClickListener {
    ...
    public static final int SWCODEC_MASK_CORE_0 = 0;
    public static final int SWCODEC_MASK_CORE_1 = 1;
    public static final int SWCODEC_MASK_CORE_2 = 2;
    public static final int SWCODEC_MASK_CORE_3 = 3;
    private static final double PERCENT = 100.0;
    private Button mBtnStart = null;
    private EditText mEtLoopCount = null;
    private EditText mEtIteration = null;
    private TextView[] mTvArray = new TextView[CpuStressTestService.CORE_NUMBER_4];
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                if (INDEX_UPDATE_RADIOBTN == msg.what
                        || INDEX_UPDATE_RADIOGROUP == msg.what) {
                    updateTestResult();
                }
            }
        };
        ...
        if (times > 0) {
            if (CpuStressTestService.CORE_NUMBER_2 == CpuStressTestService.sCoreNumber) {
                ...
                case CpuStressTest.INDEX_SINGLE:
                    mTvArray[0]
                            .setText((result & (1 << SWCODEC_MASK_CORE_0)) == 0 ? R.string.hqa_cpustress_result_fail
                ...
                case CpuStressTest.INDEX_DUAL:
                    mTvArray[0]
                            .setText((result & (1 << SWCODEC_MASK_CORE_0)) == 0 ? R.string.hqa_cpustress_result_fail
                                    : R.string.hqa_cpustress_result_pass);
                    mTvArray[1]
                            .setText((result & (1 << SWCODEC_MASK_CORE_1)) == 0 ? R.string.hqa_cpustress_result_fail
                                    : R.string.hqa_cpustress_result_pass);
                    break;
                default:
                    break;
    ...
    private void showTestResult(int indexMode, int result) {
        ...
        for (int i = 0; i <= index; i++) {
            mTvArray[i]
                    .setText(0 == (result & 1 << i) ? R.string.hqa_cpustress_result_fail
                            : R.string.hqa_cpustress_result_pass);
        }
    }
