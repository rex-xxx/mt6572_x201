...
public class Content {
    ...
    public static final int CH_DSCR_SIZE = 308;
    ...
    public static final int MEAS_REP_SIZE = 1368;
    ...
    // LXO, stupid code..
    public static final int M3G_MM_EMINFO_SIZE = 26 * 2;
    public static final int M_3G_TCMMMI_INFO_SIZE = 7 * 2;
    public static final int CSCE_SERV_CELL_STATUS_SIZE = 44 * 2;
    public static final int CSCE_MULTI_PLMN_SIZE = 37 * 2;
    public static final int UMTS_CELL_STATUS_SIZE = 503 * 2;
    ...
    public static final int XGCSCE_NEIGH_CELL_STATUS_SIZE = 456 * 2;
