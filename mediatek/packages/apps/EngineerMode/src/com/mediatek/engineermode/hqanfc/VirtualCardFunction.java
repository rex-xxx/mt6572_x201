...
public class VirtualCardFunction extends Activity {
    ...
    private final CheckBox.OnCheckedChangeListener mCheckedListener = new CheckBox.OnCheckedChangeListener() {
        public void onCheckedChanged(CompoundButton buttonView, boolean checked) {
            ...
            if (buttonView.equals(mSettingsCkBoxs[CHECKBOX_TYPEF])) {
                for (int i = CHECKBOX_TYPEF_212; i < CHECKBOX_TYPEB2; i++) {
                    mSettingsCkBoxs[i].setChecked(checked);
                }
            }
        }
    ...
    private void initComponents() {
        ...
        // mSettingsCkBoxs[CHECKBOX_TYPEA_106] = (CheckBox)
        // findViewById(R.id.hqa_virtual_cb_typea_106);
        // mSettingsCkBoxs[CHECKBOX_TYPEA_212] = (CheckBox)
        // findViewById(R.id.hqa_virtual_cb_typea_212);
        // mSettingsCkBoxs[CHECKBOX_TYPEA_424] = (CheckBox)
        // findViewById(R.id.hqa_virtual_cb_typea_424);
        // mSettingsCkBoxs[CHECKBOX_TYPEA_848] = (CheckBox)
        // findViewById(R.id.hqa_virtual_cb_typea_848);
        mSettingsCkBoxs[CHECKBOX_TYPEB] = (CheckBox) findViewById(R.id.hqa_virtual_cb_typeb);
        // mSettingsCkBoxs[CHECKBOX_TYPEB].setOnCheckedChangeListener(mCheckedListener);
        // mSettingsCkBoxs[CHECKBOX_TYPEB_106] = (CheckBox)
        // findViewById(R.id.hqa_virtual_cb_typeb_106);
        // mSettingsCkBoxs[CHECKBOX_TYPEB_212] = (CheckBox)
        // findViewById(R.id.hqa_virtual_cb_typeb_212);
        // mSettingsCkBoxs[CHECKBOX_TYPEB_424] = (CheckBox)
        // findViewById(R.id.hqa_virtual_cb_typeb_424);
        // mSettingsCkBoxs[CHECKBOX_TYPEB_848] = (CheckBox)
        // findViewById(R.id.hqa_virtual_cb_typeb_848);
    ...
    private void fillRequest(Boolean bStart, NfcEmVirtualCardReq requestCmd) {
        ...
        temp |= mSettingsCkBoxs[CHECKBOX_TYPEB2].isChecked() ? NfcCommand.EM_ALS_READER_M_TYPE_BPRIME
                : 0;
        requestCmd.mSupportType = temp;
        // CheckBox[] typeADataRate = { mSettingsCkBoxs[CHECKBOX_TYPEA_106],
        // mSettingsCkBoxs[CHECKBOX_TYPEA_212],
        // mSettingsCkBoxs[CHECKBOX_TYPEA_424],
        // mSettingsCkBoxs[CHECKBOX_TYPEA_848] };
        // requestCmd.mTypeADataRate =
        // BitMapValue.getTypeAbDataRateValue(typeADataRate);
        // CheckBox[] typeBDataRate = { mSettingsCkBoxs[CHECKBOX_TYPEB_106],
        // mSettingsCkBoxs[CHECKBOX_TYPEB_212],
        // mSettingsCkBoxs[CHECKBOX_TYPEB_424],
        // mSettingsCkBoxs[CHECKBOX_TYPEB_848] };
        // requestCmd.mTypeBDataRate =
        // BitMapValue.getTypeAbDataRateValue(typeBDataRate);
        CheckBox[] typeFDataRate = { mSettingsCkBoxs[CHECKBOX_TYPEF_212],
                mSettingsCkBoxs[CHECKBOX_TYPEF_424] };
        requestCmd.mTypeFDataRate = BitMapValue.getTypeFDataRateValue(typeFDataRate);
    }
