...
public class NoteReading extends Activity {
	...
	protected void onResume() {
		...
		int idNoteIndex = mCursor.getColumnIndex(Notes._ID);
		...
		filter = new StringBuilder("_id in ('");
		filter.append(String.valueOf(sCurrentUri.getPathSegments().get(
	...
	private void deleteCurrentNote() {
		...
		qh.startDelete(Notes.NOTEREADING_DELETE_TOKEN, mDeleting, Notes.CONTENT_URI, String.valueOf(filter),
				null);
	}
}
