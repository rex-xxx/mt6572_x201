...
public class NotePadProvider extends ContentProvider implements PipeDataWriter<Cursor> {
    ...
    static {
        ...
        sNotesProjectionMap.put(Notes.COLUMN_NAME_TITLE, Notes.COLUMN_NAME_TITLE);
        sNotesProjectionMap.put(Notes.COLUMN_NAME_NOTE, Notes.COLUMN_NAME_NOTE);
        sNotesProjectionMap.put(Notes.COLUMN_NAME_GROUP, Notes.COLUMN_NAME_GROUP);
   ...
   public String getType(Uri uri) {
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        if (!values.containsKey(Notes.COLUMN_NAME_TITLE)) {
            ...
            values.put(Notes.COLUMN_NAME_TITLE, r.getString(android.R.string.untitled));
        }
    ...
    public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
        ...
        finalWhere =
                ...
                " = " +                                          
                uri.getPathSegments().                           
                    get(Notes.NOTE_ID_PATH_POSITION);
        count = db.update(
            Notes.TABLE_NAME, 
            values,                   
            finalWhere,                                      
