...
public class TodosActivity extends Activity {
    ...
    private MenuItem mBtnSelectAll;
    private MenuItem mBtnDeselectAll;
        ...
        public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position,
            ...
            if (editType != TodosListAdapter.EDIT_NULL
                ...
                if (editType == TodosListAdapter.EDIT_TODOS) {
                    /// M: mark done if in to-do state
                    mBtnChangeState.setIcon(R.drawable.todo_mark_done);
                    mBtnChangeState.setTitle(R.string.mark_todo);
                } else if (editType == TodosListAdapter.EDIT_DONES) {
                    /// M: mark to do if in done state
                    mBtnChangeState.setIcon(R.drawable.todo_mark_todo);
                    mBtnChangeState.setTitle(R.string.mark_done);
                }
            }
            if (editType != TodosListAdapter.EDIT_NULL) {
    ...
    private void configureActionBar() {
        ...
        actionBar.setCustomView(actionBarNumberView, new LayoutParams(Gravity.RIGHT));
    ...
    class TodosActionModeCallBack implements ActionMode.Callback {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            mBtnSelectAll = menu.findItem(R.id.btn_select_all);
            mBtnDeselectAll = menu.findItem(R.id.btn_deselect_all);
    ...
    private void startTodoActionMode() {
        if (mActionMode == null) {
            mActionMode = startActionMode(new TodosActionModeCallBack());
        }
    }
}
