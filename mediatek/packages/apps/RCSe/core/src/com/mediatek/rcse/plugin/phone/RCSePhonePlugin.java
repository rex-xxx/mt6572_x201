...
public class RCSePhonePlugin extends PhonePluginDefault {
    ...
    public CallCardExtension createCallCardExtension() {
        log("createCallCardExtension()");
        return new RCSeCallCardExtension(mPluginContext, this);
    }

    public InCallTouchUiExtension createInCallTouchUiExtension() {
        log("createInCallTouchUiExtension()");
        return new RCSeInCallTouchUiExtension(mPluginContext,this);
    }

    public InCallScreenExtension createInCallScreenExtension() {
        log("createInCallScreenExtension()");
        return RCSeInCallScreenExtension.getInstance();
    }

    public RCSePhonePlugin(Context context) {
        mPluginContext = context;
        RCSeInCallScreenExtension.initialize(context, this);
    }

    /* package */void setInCallScreenActivity(Activity activity) {
        mInCallScreenActivity = activity;
    }

    /* package */Activity getInCallScreenActivity() {
        return mInCallScreenActivity;
    }

    /* package */void setCallManager(CallManager cm) {
        mCM = cm;
    }
