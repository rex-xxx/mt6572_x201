 ...
 */
public final class RcsContact {
    private static final String TAG = "RcsContact";
    public String mDisplayName;
    public String mNumber;
    public boolean mSelected;
    public String mSortKey;
    public int mSectionIndex = -1;
    public Long mPhoneId;
    public short mContactId;

    public RcsContact(String displayName, String number) {
        mDisplayName = displayName;
        mNumber = number;
    }

    public RcsContact(String displayName, String number, String sortKey, Long phoneId,
            short contactId) {
        mDisplayName = displayName;
        mNumber = number;
        mSortKey = sortKey;
    ...
    public boolean equals(Object object) {
        if (object instanceof RcsContact) {
            return this.mNumber != null && ((RcsContact) object).mNumber != null
                    && this.mNumber.equals(((RcsContact) object).mNumber);
        } else {
