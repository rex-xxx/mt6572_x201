...
public final class ChatModel {
    ...
    public interface IChat {
         ...
         */
        void handleInvitation(IChatSession chatSession, ArrayList<IChatMessage> messages);
    ...
    public interface IChatManager {
         ...
         */
        IChat addChat(List<Participant> participants, Object chatTag);
         ...
         */
        boolean handleFileTransferInvitation(String sessionId);
