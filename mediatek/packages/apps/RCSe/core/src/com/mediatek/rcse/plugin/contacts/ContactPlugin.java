...
public class ContactPlugin extends ContactPluginDefault {

    private Context mContext;

    public CallDetailExtension createCallDetailExtension() {
        return new CallDetailExtensionForRCS(mContext);
    }

    public CallListExtension createCallListExtension() {
        return new CallListExtensionForRCS(mContext);
    }

    public ContactListExtension createContactListExtension() {
        return new ContactListExtensionForRCS(mContext);
    }

    public ContactDetailExtension createContactDetailExtension() {
        return new ContactDetailExtensionForRCS(mContext);
    }
