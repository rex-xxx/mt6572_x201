...
public class RCSeCallCardExtension extends CallCardExtension implements View.OnClickListener {
    ...
    public void onFinishInflate(View callCard) {
        ...
        mPhoneNumberGeoDescription =
                (TextView) callCard.findViewById(resource.getIdentifier(
                        "phoneNumberGeoDescription", "id", packageName));
    ...
    public void updateState(CallManager cm) {
        ...
        if (RCSeUtils.canShare(cm)) {
            ...
            if (RCSeInCallScreenExtension.isTransferingFile()) {
                if (DBG) {
            ...
            } else if (RCSeInCallScreenExtension.isDisplayingFile()) {
                if (DBG) {
            ...
            if (RCSeInCallScreenExtension.isSharingVideo()
                    || (RCSeInCallScreenExtension.isDisplayingFile() && mIsCenterAreaFullScreen)) {
                hideStatusBar(true);
            } else {
                hideStatusBar(false);
            }
    ...
    public void onClick(View view) {
        ...
        if (id == resource.getIdentifier("largeAreaForSharing", "id", packageName)) {
            ...
            if (RCSeInCallScreenExtension.isSharingVideo()) {
                ...
                RCSeInCallScreenExtension.getShareVideoPlugIn().displayStoredVideoUI(
                        visibility == View.VISIBLE ? false : true);
            } else {
                if (DBG) {
            ...
            if (RCSeInCallScreenExtension.isDisplayingFile()) {
    ...
    private boolean shouldResetLayoutMargin() {
        ...
        if (RCSeInCallScreenExtension.isDisplayingFile() && mIsCenterAreaFullScreen) {
            if (DBG) {
