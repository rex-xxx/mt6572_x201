...
public class ChatListFragment extends Fragment implements OnSelectedItemListener,
                ...
                if (groupChat != null) {
                    ...
                    if (numberList instanceof List) {
                        ...
                        MenuItem deleteItem = menu.add(GROUPCHAT_MENU_GROUP, CONTEXT_MENU_DELETE,
                                0, R.string.groupchat_delete_menu);
    ...
    private class ConfirmOneOneCloseDialog extends DialogFragment {
    ...
    private class ConfirmOneOneBlockDialog extends DialogFragment {
    ...
    private class ConfirmGroupDeleteDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(mActivity)
                    .setIconAttribute(android.R.attr.alertDialogIcon)
                    .setTitle(getString(R.string.groupchat_delete_menu))
                    .setMessage(getString(R.string.groupchat_delete_message))
                    .setPositiveButton(getString(R.string.rcs_dialog_positive_button),
                            new OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
    ...
    public IGroupChatWindow addGroupChatWindow(Object tag, List<ParticipantInfo> participantList) {
        ...
        return addGroupChatWindowByInfos(tag, participants);
    }
    ...
    private class One2OneChatMap extends ChatMap implements IOne2OneChatWindow {
