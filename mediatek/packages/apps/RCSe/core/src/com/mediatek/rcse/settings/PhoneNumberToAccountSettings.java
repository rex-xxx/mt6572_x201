...
public class PhoneNumberToAccountSettings extends Activity {
    ...
    private final class SettingsDialog extends DialogFragment implements
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            mNumber = (EditText) view.findViewById(R.id.phone_number_content);
            mNumber.requestFocus();
            mAccount = (EditText) view.findViewById(R.id.vf_account_content);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            result.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mAccount.setText(member.mAccount);
                }
            });
            return result;
        }
