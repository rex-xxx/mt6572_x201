...
public class PhoneUtils {
     ...
     */
    public static final boolean sIsApnDebug = LauncherUtils.sIsDebug;
    /**
     * @}
     */
    ...
    public static String formatNumberToInternational(String number) {
        ...
        } else if (!phoneNumber.startsWith(COUNTRY_CODE_PLUS)) {
    ...
    private static String getDefaultSimCountryIso() {
        ...
        if (FeatureOption.MTK_GEMINI_SUPPORT == true) {
            ...
            iso = TelephonyManager.getDefault().getSimCountryIsoGemini(simId);
        } else {
