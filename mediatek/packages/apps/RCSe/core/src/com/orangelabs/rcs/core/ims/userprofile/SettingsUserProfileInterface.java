...
public class SettingsUserProfileInterface extends UserProfileInterface {
	...
	public UserProfile read() {
		...
		/**
		 * M:Modified to get the access information.@{T-Mobile
		 */
		String lastAccessNetworkInfo = RcsSettings.getInstance()
				.getLastAccessNetworkInfo();
		String accessNetworkInfo = RcsSettings.getInstance()
		...
		return new UserProfile(username, privateID, password, homeDomain,
				...
				lastAccessNetworkInfo, accessNetworkInfo);
		/**
		 * @}
		 */
	}
