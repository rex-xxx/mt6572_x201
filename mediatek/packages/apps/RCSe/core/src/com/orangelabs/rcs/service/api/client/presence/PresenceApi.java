...
public class PresenceApi extends ClientApi {
	 ...
	 */
	/**
	 * Polite reject the sharing invitation
	 * 
	 * @param contact
	...
	public boolean politeRejectSharingInvitation(String contact)
		...
		if (coreApi != null) {
			try {
				// Update XDM server
				return coreApi.politeRejectSharingInvitation(contact);
			} catch (Exception e) {
				throw new ClientApiException(e.getMessage());
			}
		} else {
	...
	public boolean unblockPoliteBlockedContact(String contact)
		...
		if (coreApi != null) {
			try {
				// Update XDM server
				return coreApi.unblockPoliteBlockedContact(contact);
			} catch (Exception e) {
				throw new ClientApiException(e.getMessage());
			}
		} else {
	 ...
	 * @throws ClientApiException
	 */
	public List<String> getPoliteBlockedContacts() throws ClientApiException {
		if (coreApi != null) {
			try {
				// Read XDM server
				return coreApi.getPoliteBlockedContacts();
			} catch (Exception e) {
				throw new ClientApiException(e.getMessage());
			}
		} else {
