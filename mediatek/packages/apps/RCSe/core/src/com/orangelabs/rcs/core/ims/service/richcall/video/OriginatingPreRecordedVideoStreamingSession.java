 ...
 * @author jexa7410
 */
public class OriginatingPreRecordedVideoStreamingSession extends VideoStreamingSession {
    /**
	 * Media player
	 */
	...
	/** M: Video Prerecord @{ */
    public static final String VIDEO_PRERECORD = "videoprerecord";
    /** @} */
     ...
     */
	public OriginatingPreRecordedVideoStreamingSession(ImsService parent, IMediaPlayer player, VideoContent content, String contact) {
    ...
    private SipRequest createSipInvite() {
        ...
        try {
            ...
            String videoSdp = VideoCodecManager.createCodecSdpPart(player.getMediaCodec(),
            ...
            String selector = getVideoAttribute();
            if (selector != null) {
    ...
    /** M: Get X-Type attribute @{ */
    private String getXTypeAttribute() {
        return VIDEO_PRERECORD;
    }
    /** @} */
        ...
        if (ctx.isSipResponse()) {
             ...
             */
                ...
                handleError(new ContentSharingError(ContentSharingError.SESSION_INITIATION_FAILED,
                        ctx.getStatusCode() + " " + ctx.getStatusCode() + " "
                                + ctx.getReasonPhrase()));
            }
        } else {
