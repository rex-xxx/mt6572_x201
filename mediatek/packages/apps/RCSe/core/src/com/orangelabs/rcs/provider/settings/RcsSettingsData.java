...
public class RcsSettingsData {
    ...
    public static final String PROVISION_VERSION = "ProvisionVersion";
     ...
     */
    public static final String MAX_NUMBER_OF_PRESENCE_SUBSCRIPTIONS = "MaxNumberOfPresenceSubscriptions";
