...
public class ServerApiUtils {
	...
	public static void testPermission() throws SecurityException {
        /*
        if (AndroidFactory.getApplicationContext().checkCallingOrSelfPermission(ClientApiPermission.RCS_PERMISSION)
	...
	public static void testPermissionForExtensions() throws SecurityException {
        /*
        if (AndroidFactory.getApplicationContext().checkCallingOrSelfPermission(
                ClientApiPermission.RCS_EXTENSION_PERMISSION) != PackageManager.PERMISSION_GRANTED) {
            throw new SecurityException();
        }
        */
	}
	...
	public static int getSessionState(ImsServiceSession session) {
        ...
        /**
         * M: resolve issue: cannot get TERMINATED. @{
         */
        if (dialogPath != null) {
