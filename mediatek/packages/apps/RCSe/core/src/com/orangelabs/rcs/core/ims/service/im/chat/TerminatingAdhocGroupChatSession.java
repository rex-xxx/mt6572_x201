...
public class TerminatingAdhocGroupChatSession extends GroupChatSession implements MsrpEventListener {
	...
	public void run() {
		try {
            ...
            /**
             * Modified to resolve can't establish group chat issue.@{
             */
            ...
            if (PROTOCOL_TLS.equals(protocol)) {
                sdp = "v=0" + SipUtils.CRLF + "o=- " + ntpTime + " " + ntpTime + " "
                        ...
                        + " TCP/TLS/MSRP *" + SipUtils.CRLF + "a=setup:" + localSetup
                        + SipUtils.CRLF + "a=accept-types:" + CpimMessage.MIME_TYPE + SipUtils.CRLF
                        + "a=accept-wrapped-types:" + InstantMessage.MIME_TYPE + " "
                        + IsComposingInfo.MIME_TYPE + SipUtils.CRLF + "a=fingerprint:"
                        + KeyStoreManager.getFingerPrint() + SipUtils.CRLF + "a=path:"
                        + getMsrpMgr().getLocalMsrpsPath() + SipUtils.CRLF + "a=sendrecv"
                        + SipUtils.CRLF;
            } else {
                sdp = "v=0" + SipUtils.CRLF + "o=- " + ntpTime + " " + ntpTime + " "
                        + SdpUtils.formatAddressType(ipAddress) + SipUtils.CRLF + "s=-"
                        + SipUtils.CRLF + "c=" + SdpUtils.formatAddressType(ipAddress)
                        + SipUtils.CRLF + "t=0 0" + SipUtils.CRLF + "m=message " + localMsrpPort
                        + " TCP/MSRP *" + SipUtils.CRLF + "a=setup:" + localSetup + SipUtils.CRLF
                        + "a=accept-types:" + CpimMessage.MIME_TYPE + SipUtils.CRLF
                        + "a=accept-wrapped-types:" + InstantMessage.MIME_TYPE + " "
                        + IsComposingInfo.MIME_TYPE + SipUtils.CRLF + "a=path:"
                        + getMsrpMgr().getLocalMsrpPath() + SipUtils.CRLF + "a=sendrecv"
                        + SipUtils.CRLF;
            }
            /** @} */
