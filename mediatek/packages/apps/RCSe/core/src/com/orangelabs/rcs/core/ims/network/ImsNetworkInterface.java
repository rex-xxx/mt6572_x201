...
public abstract class ImsNetworkInterface {
    ...
    public String getGsmCellLocation() {
        ...
        if (location != null && accessType != null) {
            ...
            if (accessType.equals(ImsNetworkInterface.UTRAN_FDD)) {
    ...
    public void setAccessNetworkInfo() {
        try {
            ...
            if (mCurrentAccessNetworkInfo == null) {
                mCurrentAccessNetworkInfo = EMPTY_STRING;
            }
            ...
            // if the last access network information is empty or Wifi MAC,we
