...
public class AndroidFactory {
     ...
     * M: Add to logout @{
     */
    private static Logger sLogger = Logger.getLogger(AndroidFactory.class.getName());
    /**
     * @}
     */
	...
	public static void setApplicationContext(Context context) {
        /**
         * M: Add to show which thread call setApplicationContext @{
         */
        if (sLogger.isActivated()) {
            sLogger.debug("setApplicationContext() : context = " + context);
        }
        /**
         * @}
         */
