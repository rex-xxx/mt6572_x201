...
LOCAL_SRC_FILES += \
    ...
    src/com/orangelabs/rcs/service/api/client/media/video/IVideoSurfaceViewListener.aidl \
    src/com/orangelabs/rcs/service/api/client/media/video/IVideoPlayerEventListener.aidl \
