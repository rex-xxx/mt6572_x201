...
public class NiaDecoder {
    static void decode(byte[] msg) {
        ...
        Log.i(TAG.Service, "NiaDecoder: begin");
        Log.i(TAG.Service, "version: " + version);
        Log.i(TAG.Service, "uiMode: " + uiMode);
        Log.i(TAG.Service, "initiator: " + initiator);
        Log.i(TAG.Service, "sessionId: " + sessionId);
        Log.i(TAG.Service, "serverId length: " + serverIdLength);
        Log.i(TAG.Service, "serverId: " + serverId);
        Log.i(TAG.Service, "NiaDecoder: end");
    }
}
