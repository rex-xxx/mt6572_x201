...
import com.mediatek.MediatekDM.mdm.MmiInfoMsg.InfoType;
...
public class DmMmiInfoMsg implements MmiInfoMsg {
    private final int type = DmConst.ServerMessage.TYPE_ALERT_1100;

    public DmMmiInfoMsg(MmiObserver observer) {
        DmInfoMsg.observer = observer;
    }

    public MmiResult display(MmiViewContext arg0, InfoType arg1) {

        DmInfoMsg.viewContext = arg0;
        DmInfoMsg.infoType = arg1;
...
class DmInfoMsg {
    ...
    public static InfoType infoType;
}
