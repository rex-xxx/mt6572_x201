...
public class FileLogger {
    ...
    synchronized boolean init(Context context) {
        ...
        try {
            ...
            Log.d(TAG, "File logger inited");
        } catch (Exception e) {
            Log.d(TAG, "FileLogger.init - caught exception: " + e);
            result = false;
        }
        return result;
    }
    ...
    public void logMsg(String message) {
        ...
        try {
            ...
            Log.d(TAG, "FileLogger.prefixMsg - caught exception: " + e);
            e.printStackTrace();
        }
    }
    ...
    synchronized void term() {
        try {
            mOut.close();
            Log.d(TAG, "Close file logger");
        } catch (IOException e) {
            Log.d(TAG, "FileLogger.term - caught exception: " + e);
            e.printStackTrace();
        }
    }
