...
public class DmNiaMsgHandler implements NIAMsgHandler, SessionInitiator {

    public DmNiaMsgHandler() {
    ...
    public void notify(UIMode uiMode, short dmVersion, byte[] vendorSpecificData,
        ...
        // TODO: check UI mode and other parameters to dispatch different
        // messages.

        mMsgHandler.sendMessage(mMsgHandler.obtainMessage(IDmPersistentValues.MSG_NIACONFIRMED));
        return;
    }

    public String getId() {
        return "Network Inited";
    }
