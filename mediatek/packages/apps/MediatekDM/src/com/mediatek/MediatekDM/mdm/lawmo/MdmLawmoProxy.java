...
public class MdmLawmoProxy {
    // TODO
    private MdmLawmo mLawmo;
    private LawmoHandler mHandler;

    public MdmLawmoProxy(MdmLawmo lawmo, LawmoHandler handler) {
        mLawmo = lawmo;
        mHandler = handler;
    }

    public void create(String lawmoRootURI) {
    ...
    public void triggerReportSession(int operationType, int resultCode) throws MdmException {
