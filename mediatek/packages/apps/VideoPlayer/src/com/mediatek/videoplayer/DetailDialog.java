...
public class DetailDialog extends AlertDialog implements DialogInterface.OnClickListener {
    ...
    public DetailDialog(final Context context, final ViewHolder holder) {
        ...
        mHolder = holder;
        if (LOG) {
            MtkLog.v(TAG, "LimitDialog() holder=" + holder);
        }
    }
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mDurationView.setText(mContext.getString(R.string.detail_duration, MtkUtils.stringForTime(mHolder.mDuration)));
        mTimeView.setText(mContext.getString(R.string.detail_date_taken, MtkUtils.localTime(mHolder.mDateTaken)));
