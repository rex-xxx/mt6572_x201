...
public class SimManagementSettingsWizard extends OOBEStepActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        SimManagement.initProgressBar(totalStep, stepIndex);
        ...
        transaction.replace(R.id.fragment_container, mSubSimManagementSettings);
        transaction.commit();

        initSpecialLayout(R.string.oobe_title_sim_management, R.string.oobe_summary_sim_management);
