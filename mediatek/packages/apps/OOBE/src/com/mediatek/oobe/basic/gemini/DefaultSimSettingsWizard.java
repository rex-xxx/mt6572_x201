...
public class DefaultSimSettingsWizard extends OOBEStepActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        // this methods will add title first and then remove it, so we set this attribute in AndroidManifest.xml
        // requestWindowFeature(Window.FEATURE_NO_TITLE);
        super.onCreate(icicle);
        // setContentView(R.layout.main_frame);
        FragmentManager manager = getFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        transaction.replace(R.id.fragment_container, new SubDefaultSimSettings());
        transaction.commit();
        // initLayout();
        initSpecialLayout(R.string.oobe_title_default_sim, R.string.oobe_summary_default_sim);
    ...
    // settingTitle.setText(R.string.oobe_title_default_sim);
    // settingSummary.setText(R.string.oobe_summary_default_sim);
    // }
