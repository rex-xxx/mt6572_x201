...
/**
 * ProviderPreference is used to display an image to the left of a provider name. The preference ultimately calls
 * AccountManager.addAccount() for the account type.
 */
public class ProviderPreference extends Preference {
    ...
    public ProviderPreference(Context context, String accountType, Drawable icon, CharSequence providerName) {
        ...
        mTapAdd = context.getString(R.string.tap_to_add, mProviderName);
        setSummary(mTapAdd);
    }
