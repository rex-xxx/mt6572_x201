...
/**
 * The class displaying a list of time zones that match a filter string such as "Africa", "Europe", etc. Choosing an item
...
public class ZonePicker extends ListFragment {
    ...
    public static SimpleAdapter constructTimezoneAdapter(Context context, boolean sortedByName) {
        return constructTimezoneAdapter(context, sortedByName, R.layout.zone_picker_simple_list_item_2);
    }
    ...
    /**
     * Searches {@link TimeZone} from the given {@link SimpleAdapter} object, and returns the index for the TimeZone.
     * 
     * @param adapter
     *            SimpleAdapter constructed by {@link #constructTimezoneAdapter(Context, boolean)}.
     * @param tz
     *            TimeZone to be searched.
     * @return Index for the given TimeZone. -1 when there's no corresponding list item. returned.
     */
    ...
    public void onActivityCreated(Bundle savedInstanseState) {
        ...
        Xlog.d(TAG, "ZonePicker onActivityCreated");
    ...
    private static void addItem(List<HashMap<String, Object>> myData, String id, String displayName, long date) {
