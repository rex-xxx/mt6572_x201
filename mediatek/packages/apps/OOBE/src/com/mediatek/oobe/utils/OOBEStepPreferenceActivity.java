...
public class OOBEStepPreferenceActivity extends PreferenceActivity implements Button.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initLayout();
        // set screen mode for tabet or mobile
    ...
    public void setScreenOrientation() {
        // mViewManager = (ViewManager) getSystemService(Context.WINDOW_SERVICE);
        ...
        // mViewManager.updateViewLayout(getWindow().getDecorView() , mWindowLayoutParams);
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_BACK:
            ...
            // if(mStepIndex<=1){
            // int firstRunFlag = Settings.Secure.getInt(getContentResolver(), Settings.Secure.OOBE_HAS_RUN, 0);
            // int firstRunFlag = Settings.Secure.getInt(getContentResolver(), "oobe_has_run", 0);
            int firstRunFlag = Settings.System.getInt(getContentResolver(), "oobe_has_run", 0);
            // boolean isFirstStep = (mBackBtn!=null && (mBackBtn.getVisibility()==View.INVISIBLE));
