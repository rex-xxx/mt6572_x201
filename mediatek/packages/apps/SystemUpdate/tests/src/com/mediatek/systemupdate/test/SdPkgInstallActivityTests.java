...
public class SdPkgInstallActivityTests extends
    ...
    /**
     * Available SD card is unmounted, popup a dialog, click OK button, Activity finished
     */
    ...
    /**
     * SdCard Package missing, popup a dialog, click OK button, Activity finished
     */
    ...
    /**
     * Unzip package to default storage, error happens, popup a dialog, press BACK key, Activity
     * finished
     */
    ...
    /**
     * Unzip package to default storage, popup a progress dialog, press BACK key, Activity finished
     */
    ...
    /**
     * Unmount SDcard in installing process.Activity finish, and SystemUpdate popup a Dialog
     */
    ...
    private UpdatePackageInfo getPackageInfo(int id) {
        ...
        try {
            ...
            Object reader = con.newInstance(mInst.getTargetContext(),
            ...
            List<UpdatePackageInfo> infoList = (List<UpdatePackageInfo>) m.invoke(reader,
                    (Object[]) null);
