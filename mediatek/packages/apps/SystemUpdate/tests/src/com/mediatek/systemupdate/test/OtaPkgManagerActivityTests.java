...
public class OtaPkgManagerActivityTests extends
        ActivityInstrumentationTestCase2<OtaPkgManagerActivity> {
    ...
    private static final String ANDROID_VER_TEST = "Android 4.1";
    ...
    public void testcase01_NewVersionLayout() {
        ...
        assertTrue(("Version " + LOAD_VER_TEST).equals(textLoadVer.getText()));
    ...
    public void testcase03_DownloadingPaused() {
        ...
        ProgressBar dlRatioProgressBar = (ProgressBar) mActivity
                .findViewById(R.id.downloaingProBar);
