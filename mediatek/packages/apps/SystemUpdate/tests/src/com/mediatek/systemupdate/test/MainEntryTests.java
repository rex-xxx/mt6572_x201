...
public class MainEntryTests extends ActivityInstrumentationTestCase2<MainEntry> {
     ...
     * .getSystemService(Context.CONNECTIVITY_SERVICE); if (connetManager == null) { Xlog.e(TAG,
     * "isNetWorkAvailable connetManager = null"); return ret; } NetworkInfo[] infos =
     * connetManager.getAllNetworkInfo(); if (infos == null) { return ret; }
     * 
     * for (int i = 0; i < infos.length && infos[i] != null; i++) { if (infos[i].isConnected() &&
     * infos[i].isAvailable()) { ret = true; break; } }
     * 
     * } catch (Exception e) {
     * 
     * e.printStackTrace(); } Xlog.i(TAG, "isNetWorkAvailable result is : " + ret); return ret; }
     */
    ...
    public void testcase06_RefreshUINoOTA() {
        Xlog.i(TAG, "testcase05_RefreshUI");
    ...
    public void testcase07_RefreshTimeout() {
        ...
        Assert.assertTrue("Don't need refresh UI",
                !mPreference.getBoolean(NEED_REFRESH_PACKAGE, false));
        ...
        try {
            Xlog.v(TAG, "wait for timeout 15000");
            Thread.sleep(15000);
        } catch (InterruptedException e) {
            Xlog.v(TAG, "Wait for timeout broken");
        }
    ...
    public void testcase13_Shutdown() {
        ...
        try {
            ...
            Xlog.e(TAG, "shutdown sleep broken");
        }
    ...
    public void testcase14_BootComplete() {
        ...
        try {
            ...
            Xlog.e(TAG, "boot_complete sleep broken");
        }
