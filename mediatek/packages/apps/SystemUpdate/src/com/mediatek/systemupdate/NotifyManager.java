...
class NotifyManager {
    ...
    void showNewVersionNotification() {
        ...
        configAndShowNotification(R.drawable.stat_download_detected,
                contentTitle, null, Util.Action.ACTION_SYSTEM_UPDATE_ENTRY, true, false);
    }
    ...
    void showDownloadCompletedNotification() {
        ...
        configAndShowNotification(R.drawable.stat_download_completed,
    ...
    void showDownloadingNotificaton(String version, int currentProgress, boolean isOngoing) {
        ...
        String contentTitle = mNotificationContext
                .getString(R.string.app_name);
        setNotificationProgress(R.drawable.stat_download_downloading,
                contentTitle, currentProgress, isOngoing, false);
    }
    


    private void setNotificationProgress(int iconDrawableId,
            String contentTitle, int currentProgress, boolean isOngoing, boolean isUnknown) {
        if (mNotification == null) {
            ...
            Xlog.i(TAG, "set motification with " +  isOngoing);

        }
        String percent = "" + currentProgress + "%";
		mNotification.setProgress(Util.MAX_PERCENT, currentProgress, false)
				.setContentInfo(
						isUnknown ? mNotificationContext
								.getString(R.string.unknown_per) : percent);
