        ...
        private static class Proxy implements SystemUpdateBinder {
            ...
            public boolean setRebootFlag() throws android.os.RemoteException {
                ...
                try {
                    ...
                    mRemote.transact(Stub.TRANSACTION_SET_REBOOT_FLAG, data,
                            reply, 0);
            ...
            public boolean clearUpdateResult() throws android.os.RemoteException {
                ...
                try {
                    data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_CLEAR_UPGRADE_RESULT, data,
                            reply, 0);
                    result = (0 != reply.readInt());
                } finally {
                    reply.recycle();
            ...
            public boolean readUpgradeResult()
                    throws android.os.RemoteException {
                android.os.Parcel data = android.os.Parcel.obtain();
                android.os.Parcel reply = android.os.Parcel.obtain();
                boolean result;
                try {
                    data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_READ_UPGRADE_RESULT,
                            data, reply, 0);
                    result = (0 != reply.readInt());
                } finally {
                    reply.recycle();
