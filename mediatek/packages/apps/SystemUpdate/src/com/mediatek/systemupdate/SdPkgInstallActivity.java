...
public class SdPkgInstallActivity extends PkgManagerBaseActivity implements
    ...
    private static final String UPDATE_PACKAGE_NAME = Util.PathName.PACKAGE_NAME.substring(1);
    ...
    static SdPkgInstallActivity sInstance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sInstance = this;
        if (OtaPkgManagerActivity.sInstance != null) {
            OtaPkgManagerActivity.sInstance.finish();
        }
