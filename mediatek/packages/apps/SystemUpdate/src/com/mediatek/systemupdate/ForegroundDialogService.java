...
public class ForegroundDialogService extends Service {
	...
	private void showForeGroundDlg(int id) {
		...
		case DIALOG_INSTALL_REMINDER:
			...
			View installReminderView = flater.inflate(
					R.layout.install_reminder_dlg, null);

			builder.setTitle(R.string.install_sd_title)
					.setIcon(R.drawable.alert_install)
							...
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									Intent intent = new Intent(
											Util.Action.ACTION_OTA_MANAGER);
		...
		case DIALOG_UPDATE_RESULT:
			...
			DownloadInfo downloadStatus = DownloadInfo
					.getInstance(ForegroundDialogService.this);

			builder.setTitle(R.string.app_name)
					.setMessage(
							getString(mErrorCode ? R.string.updateSuccess
									: R.string.updateFailed, downloadStatus
									.getTargetVer()))
