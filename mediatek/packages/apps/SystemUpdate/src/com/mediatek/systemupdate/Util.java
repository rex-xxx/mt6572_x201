...
public final class Util {
    ...
    static boolean isSdcardAvailable(Context context) {
        ...
        if (FeatureOption.MTK_2SDCARD_SWAP || FeatureOption.MTK_SHARED_SDCARD || FeatureOption.MTK_LCA_ROM_OPTIMIZE) {
    ...
    static void setAlarm(Context context, int alarmType, long time, String action) {
        Xlog.i(TAG, "setAlarm enter, time = " + time + ", current time = "
    ...
    static String getFormattedKernelVersion() {
