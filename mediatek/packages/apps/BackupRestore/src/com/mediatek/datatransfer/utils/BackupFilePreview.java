...
public class BackupFilePreview {
    ...
    public String getFileName() {
    	...
    	if(showNameString!=null&&showNameString.trim().length()==14){
    		try {
    ...
    private int peekBackupModules(Context context) {
        ...
        if (files != null) {
            for (File file : files) {
                String[] moduleFolders = new String[] { ModulePath.FOLDER_CALENDAR,
                ...
                int[] moduleTypes = new int[] { ModuleType.TYPE_CALENDAR, ModuleType.TYPE_CONTACT,
