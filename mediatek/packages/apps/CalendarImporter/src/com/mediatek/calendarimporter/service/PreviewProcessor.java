...
import com.mediatek.vcalendar.VCalParser.PreviewInfo;
...
public class PreviewProcessor extends BaseProcessor implements VCalStatusChangeOperator {
    ...
    public void vCalOperationFinished(int successCnt, int totalCnt, Object obj) {
        ...
        switch (previewInfo.getEventsCnt()) {
        case -1:
        case 0:
            LogUtils.w(TAG, "startParsePreview: No VEvent exsits in the file.");
            break;
        case 1:
            String title = previewInfo.getFirstEventSummary();
            String owner = previewInfo.getFirstEventOrganizer();
            String period = previewInfo.getFirstEventDuration();
        ...
        default: // more than one event.
            ...
            builder.append("Events Count:").append(previewInfo.getEventsCnt()).append("\n");
            break;
        }
