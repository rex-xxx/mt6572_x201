...
public class ShowPreviewActivity extends Activity implements ServiceConnectedOperation {
    ...
    private void showJudgeAccessActivity() {
        LogUtils.d(TAG, "showJudgeAccessActivity. uri = " + mIntent.getData().toString());
        mIntent.setClass(ShowPreviewActivity.this, JudgeAccessActivity.class);
    ...
    private void setImportErrorView() {
        ...
        mPreviewText.setText(R.string.import_vcs_failed);
