    ...
    private int getFileInfo () {
        ...
        if ( mMimeType.equals("text/x-vcard")) {
            ...
            try {
                ...
                //FileOutputStream out = mContext.openFileOutput( "Contact.vcf", Context.MODE_PRIVATE );
...
*/
    ...
    private void startDevicePicker(){
        ...
        in_toBDP.putExtra(BluetoothDevicePicker.EXTRA_FILTER_TYPE,BluetoothDevicePicker.FILTER_TYPE_PRINTER);
