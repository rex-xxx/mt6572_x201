...
public class BluetoothDunReceiver extends BroadcastReceiver 
{
    ...
    public void onReceive(Context context, Intent intent) 
    {
        ...
        if (action.equals(BluetoothDunService.ACTION_CLEAR_AUTH_NOTIFICATION)) {
            Intent accessIntent = new Intent(BluetoothDunService.ACCESS_RESPONSE_ACTION);
            accessIntent.putExtra(BluetoothDunService.EXTRA_ACCESS_RESULT, 
            ...
            if( btState == BluetoothAdapter.STATE_ON ){
                ...
                context.startService(new Intent(context, BluetoothDunService.class));
            }
        }
