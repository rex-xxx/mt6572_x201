...
public class CdsUtilityActivity extends Activity implements View.OnClickListener {
    private static final String TAG = "CdsUtilityActivity";
    ...
    private static final String[] WEBSITES = new String[] {"mtk_netstat", "mtk_route","netstat", "mtk_ifconfig", "mtk_route del default", "mtk_route add default ccmni0",
