 ...
 * and call {@link com.mediatek.imsp.NotificationManagerExt NotificationManagerExt} 
...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    private class ReceiveNotificationTask extends AsyncTask<Intent,Void,Void> {
        ...
        protected Void doInBackground(Intent... intents) {
            ...
            } else if (NmsIpMessageConsts.NmsIpMessageStatus.NMS_MESSAGE_STATUS_ACTION.equals(action)) {
                handleIpMessageStatus(intent);
            } else if (NmsIpMessageConsts.NmsDownloadAttachStatus.NMS_DOWNLOAD_ATTACH_STATUS_ACTION.equals(action)) {
            ...
            } else if (NmsIpMessageConsts.NmsUpdateSystemContactAction.NMS_UPDATE_CONTACT.equals(action)) {
        ...
        private void handleNewMessage(Intent intent) {
            ...
            NmsIpMessage msg = (NmsIpMessage)intent.getSerializableExtra(NmsIpMessageConsts.NmsNewMessageAction.NMS_IP_MESSAGE);
            boolean needNotify = intent.getBooleanExtra(NmsIpMessageConsts.NmsNewMessageAction.NMS_NEED_SHOW_NOTIFICATION, false);
            if (null == msg) {
            ...
            Xlog.d(TAG, "msg type = " + msg.type + "msg status" + msg.status + "; msg id = " + msg.id);
            if (msg.protocol != NmsIpMessageConsts.NmsMessageProtocol.IP
                ...
                ||((msg.type >= NmsIpMessageConsts.NmsIpMessageType.GROUP_CREATE_CFG 
                        ...
                        || msg.type >= NmsIpMessageConsts.NmsIpMessageType.UNKNOWN_FILE)) {
                return;
            }
        ...
        private void handleImStatus(Intent intent) {
            ...
            NmsContact contact = (NmsContact)intent.getSerializableExtra(
                    NmsIpMessageConsts.NmsImStatus.NMS_CONTACT_CURRENT_STATUS);
            if (null == contact) {
        ...
        private void handleIpMessageStatus(Intent intent) {
            ...
            int msgId = intent.getIntExtra(NmsIpMessageConsts.NmsIpMessageStatus.NMS_IP_MSG_SYS_ID, 0);
        ...
        private void handleDownloadAttachStatus(Intent intent) {
            long msgId = intent.getLongExtra(NmsIpMessageConsts.NmsDownloadAttachStatus.NMS_DOWNLOAD_MSG_ID, 0);
            int percentage = intent.getIntExtra(NmsIpMessageConsts.NmsDownloadAttachStatus.NMS_DOWNLOAD_PERCENTAGE, 0);
            int status = intent.getIntExtra(NmsIpMessageConsts.NmsDownloadAttachStatus.NMS_DOWNLOAD_ATTACH_STATUS_ACTION,
        ...
        private void handleSaveHistory(Intent intent) {
            int done = intent.getIntExtra(NmsIpMessageConsts.NmsSaveHistory.NMS_DOWNLOAD_HISTORY_DONE, 1);
            String filePath = intent.getStringExtra(NmsIpMessageConsts.NmsSaveHistory.NMS_DOWNLOAD_HISTORY_FILE);
        ...
        private void handleUpdateGroup(Intent intent) {
            int groupId = intent.getIntExtra(NmsIpMessageConsts.NmsUpdateGroupAction.NMS_GROUP_ID, -1);
