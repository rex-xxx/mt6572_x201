...
public class ServiceManagerExt extends ServiceManager {
    ...
    //private SoftReference<SNmsSimInfo> mSimInfoCache = new SoftReference<SNmsSimInfo>(null);
    private static Map<Integer, SoftReference<SNmsSimInfo>> mNmsSimInfoCacheMap = 
            new LinkedHashMap<Integer, SoftReference<SNmsSimInfo>>();
    ...
    public boolean isActivated(int simId) {
        ...
        return simInfo.status < SNmsSimInfo.NmsSimActivateStatus.NMS_SIM_STATUS_ACTIVATED ? false : true;
    }
    ...
    public boolean isEnabled(int simId) {
        ...
        return simInfo.status == SNmsSimInfo.NmsSimActivateStatus.NMS_SIM_STATUS_ACTIVATED ? true : false;
    }
    ...
    public boolean isFeatureSupported(int featureId) {
        ...
        case FeatureId.ALL_LOCATION:   /// M: list all location messages in activity.
        case FeatureId.ALL_MEDIA:      /// M: list all media messages in activity.
        case FeatureId.MEDIA_DETAIL:   /// M: displaying media detail info.
