...
public class MessageManagerExt extends MessageManager {
    ...
    public static NmsIpMessage getNmsIpMsgFromIpMsg(IpMessage ipMsg) {
        ...
        switch (ipMsg.getType()) {
            ...
            case IpMessageConsts.IpMessageType.SKETCH: {
                ...
                // for image message
                ((NmsIpImageMessage)nmsIpMsg).widthInPixel = ((IpImageMessage)ipMsg).getWidthInPixel();
                ((NmsIpImageMessage)nmsIpMsg).heightInPixel = ((IpImageMessage)ipMsg).getHeightInPixel();
            ...
            case IpMessageConsts.IpMessageType.LOCATION: {
                ...
                // for location message
                ((NmsIpLocationMessage)nmsIpMsg).longitude = ((IpLocationMessage)ipMsg).getLongitude();
                ...
                ((NmsIpLocationMessage)nmsIpMsg).thumbPath = ((IpLocationMessage)ipMsg).getThumbPath();
        ...
        nmsIpMsg.read = true;
        nmsIpMsg.status = (ipMsg.getStatus() == IpMessageConsts.IpMessageStatus.DRAFT) ?
                NmsIpMessageConsts.NmsIpMessageStatus.DRAFT : NmsIpMessageConsts.NmsIpMessageStatus.OUTBOX;
    ...
    public IpMessage getIpMessageFromIntent(Intent intent) {
        ...
        //NmsIpLocationMessage nmsIpMessage = (NmsIpLocationMessage) intent.getExtra(NmsIpMessageConsts.NMS_SHARE_LOCATION_DONE);
        String shareAddress = intent.getStringExtra(NmsIpMessageConsts.NmsShareLocationDone.NMS_LOCATION_ADDRESS);
        double latitude = intent.getDoubleExtra(NmsIpMessageConsts.NmsShareLocationDone.NMS_LOCATION_LATITUDE, -1);
        double longitude = intent.getDoubleExtra(NmsIpMessageConsts.NmsShareLocationDone.NMS_LOCATION_LONGITUDE, -1);
        String path = intent.getStringExtra(NmsIpMessageConsts.NmsShareLocationDone.NMS_LOCATION_PATH);
    ...
    public void resendMessage(long msgId) {
        NmsIpMessageApi.getInstance(mContext).nmsReSendFailedMsg(NmsConsts.SINGLE_CARD_SIM_ID, msgId);
    }
