...
public class ContactManagerExt extends ContactManager {
    ...
    public String getNumberByEngineId(short engineId) {
        ...
        NmsContact nmsContact = NmsIpMessageApi.getInstance(mContext).nmsGetContactInfoViaEngineId(engineId);
        if (nmsContact == null) {
    ...
    public String getNumberByMessageId(long messageId) {
        ...
        NmsContact nmsContact = NmsIpMessageApi.getInstance(mContext).nmsGetContactInfoViaMsgId(messageId);
        if (nmsContact == null) {
            Xlog.e(TAG, "isms interface return null");
            return null;
        }
    ...
    public String getNumberByThreadId(long threadId) {
        ...
        NmsContact nmsContact = NmsIpMessageApi.getInstance(mContext).nmsGetContactInfoViaThreadId(threadId);
        if (nmsContact == null) {
            Xlog.e(TAG, "isms interface return null");
            return null;
        }
    ...
    public short getContactIdByNumber(String number) {
        ...
        NmsContact nmsContact = NmsIpMessageApi.getInstance(mContext).nmsGetContactInfoViaNumber(number);
        if (nmsContact == null) {
            Xlog.e(TAG, "isms interface return null");
            return -1;
        }
