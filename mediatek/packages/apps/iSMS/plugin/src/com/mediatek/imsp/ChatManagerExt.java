...
public class ChatManagerExt extends ChatManager {
    ...
    public int getIpMessageCountOfTypeInThread(long threadId, int typeFlag) {
        Xlog.d(TAG, "getIpMessageCountOfTypeInThread, threadId = " + threadId + ", typeFlag=" + typeFlag);
        return NmsIpMessageApi.getInstance(mContext).nmsGetIpMsgCountOfTypeInThread(threadId, typeFlag);
    }
