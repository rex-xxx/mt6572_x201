...
public class SettingsManagerExt extends SettingsManager {
    ...
    public boolean isVideoCaptionOn() {
        return isCaptionOn() ? NmsIpMessageApi.getInstance(mContext).nmsGetVideoCaptionFlag() : false;
    }

    public boolean isAudioCaptionOn() {
        return isCaptionOn() ? NmsIpMessageApi.getInstance(mContext).nmsGetAudioCaptionFlag() : false;
    }

    public boolean isPhotoCaptionOn() {
        return isCaptionOn() ? NmsIpMessageApi.getInstance(mContext).nmsGetPhotoCaptionFlag() : false;
    }
