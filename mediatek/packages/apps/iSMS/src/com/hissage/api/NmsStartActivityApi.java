...
public class NmsStartActivityApi {
    ...
    public static void nmsStartActivitionActivity(Context context, long sim_id) {
        if (null == context
    ...
    public static void nmsStartChatDetailsActivity(Context context, long threadId, long selectId,
