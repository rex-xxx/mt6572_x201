    ...
    private void preForwardMessage() {
        if (mMessage instanceof NmsIpAttachMessage && !(mMessage instanceof NmsIpLocationMessage)
            ...
            new AlertDialog.Builder(mContext)
                    ...
                    .setMessage(R.string.STR_NMS_FORWARD_DOWNLOAD)
                    .setNegativeButton(R.string.STR_NMS_FORWARD_CONTIUE,
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (!NmsDownloadManager.getInstance().nmsIsDownloading(
                                            mMessage.ipDbId, mMessage.id)) {
                                        NmsDownloadManager.getInstance().nmsDownload(
                                                mMessage.ipDbId, 0);
                                    }
                                    dialog.dismiss();
                                }
                            }).setPositiveButton(R.string.STR_NMS_CANCEL, null).create().show();
        } else {
            forwardMessage();
        }
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (dbId == mMessage.ipDbId
                ...
                if (status == NmsIpMessageConsts.NmsDownloadAttachStatus.DONE) {
                    ...
                    Toast.makeText(mContext, R.string.STR_NMS_FORWARD_FAILED, Toast.LENGTH_SHORT)
                            .show();
