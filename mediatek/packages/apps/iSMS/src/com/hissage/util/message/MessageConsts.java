...
public class MessageConsts {
    ...
    public final static int NMS_REFRESH_AND_SCROLL_LIST = 2;
    public final static int NMS_SCROLL_LIST = 3;
    public final static int NMS_SEND_MSG_FAILED = 4;
    public final static int[] shareIconArr = { R.drawable.isms_take_a_photo,
            ...
            R.drawable.isms_share_calendar };
    ...
    public final static int[] dynamicPngIconArr = { R.drawable.emo_dynamic_01_png,
            ...
            R.drawable.emo_dynamic_22_png, R.drawable.emo_dynamic_23_png, R.drawable.emo_dynamic_24 };
