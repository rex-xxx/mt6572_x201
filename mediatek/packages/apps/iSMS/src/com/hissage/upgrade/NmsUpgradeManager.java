...
public class NmsUpgradeManager {
    ...
    private long mUpgradeIntervalTime = (7 * 24 * 60 * 60); /* default is 7 day */
    ...
    private boolean doRequestNewVersion() {
        ...
        try {
            ...
            if (mUpgradeIntervalTime <= 0) {
                NmsLog.trace(TAG, "got mUpgradeIntervalTime: " + mUpgradeIntervalTime
                        + " is not upgrade again");
                mUpgradeIntervalTime = 10 * 365 * 24 * 3600;
            }
