...
public class NmsIpImageMessage extends NmsIpAttachMessage {
    ...
    public NmsIpImageMessage(int jid, int jipDbId, int jsimId, int jtype, int jstatus,
            int jprotocol, boolean jread, int jflag, int jtime, String jto, String jfrom,
            String jpath, String jurl, int jsize, String jcaption, String jthumbPath) {
        super(jid, jipDbId, jsimId, jtype, jstatus, jprotocol, jread, jflag, jtime, jto, jfrom,
                jpath, jurl, jsize);
        caption = jcaption;
...
//    }
    ...
    public void send(String number, final String attachPath, String caption, int simId,
