...
public final class engineadapterforjni {
    ...
    public static String nmsGetReadModeString(int readMode) {
        String strRM = "";
        switch (readMode) {
    ...
    public static String nmsGetAttachShareString(String name, int readMode) {
        ...
        String readModeString = nmsGetReadModeString(readMode);
