...
public class hpnsReceiver extends BroadcastReceiver {
    ...
    public static String readRegId(Context context) {
        ...
        try {
            ...
            if (null != temp/* && temp.length() == reglen */) {
                ...
                NmsLog.trace(logTag, "regid from file error:" + temp);
            }
    ...
    public static String getPNType() {
        ...
        if (TextUtils.isEmpty(pnType)) {
            NmsLog.trace(logTag, "pnType is " + ((pnType == null) ? "NULL" : "EMPTY")
                    + " in getPNType, may be the loadPn function is not call or got error before");
            return "unknown";
        }
    ...
    private static boolean startHPNS(Context context) {
    ...
    private static void stopHPNS(Context context) {
    ...
    public static void loadPn(Context context) {
        ...
        if (TextUtils.isEmpty(pnType)) {
            NmsLog.warn(logTag, "loadPn: no sim card, pn is not start!");
            return;
        }
