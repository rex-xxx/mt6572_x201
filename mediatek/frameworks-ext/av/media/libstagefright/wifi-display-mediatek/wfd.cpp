...
struct RemoteDisplayClient : public BnRemoteDisplayClient {
    ...
    virtual void onDisplayTouchEvent(uint32_t, uint32_t, uint32_t);
...
void RemoteDisplayClient::onDisplayTouchEvent(uint32_t, uint32_t, uint32_t){
    ALOGI("onDisplayTouchEvent");
}
