...
typedef struct __VDEC_DRV_QUERY_VIDEO_FORMAT_T
{
    ...
    VAL_UINT32_T u4Width;                   ///< Frame Width
    VAL_UINT32_T u4Height;                  ///< Frame Height
    VAL_UINT32_T u4StrideAlign;             ///< Frame Stride Alignment
    VAL_UINT32_T u4SliceHeightAlign;        ///< Frame Slice Height Alignment
    VDEC_DRV_PIXEL_FORMAT_T ePixelFormat;   ///< Frame Format
} VDEC_DRV_QUERY_VIDEO_FORMAT_T;
