...
typedef struct __VDEC_HANDLE_T
{
    ...
    VCODEC_BUFFER_T         rVideoBitBuf,rVideoFrameBuf;
    ...
    VCODEC_DEC_YUV_BUFFER_PARAM_T   rVideoDecYUVBufferParameter;
    VCODEC_DEC_BITSTREAM_PARAM_T    rBitStreamParam;
    VCODEC_DEC_YUV_BUFFER_PARAM_EXTEND_T   rVideoDecYUVBufferParameterExtend;
