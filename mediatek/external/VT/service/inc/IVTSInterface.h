...
namespace VTService{
	...
	class IVTSInterface: virtual public RefBase
	{
		public: 
			...
			virtual status_t hideLocalView(const int hideMeFlag, const VTSString & hideMeImageURI)=0;
			virtual status_t replacePeerVideoSettings(const int enableFlag, const VTSString & filePath)=0;
			virtual status_t enableAlwaysAskSettings(const int enableFlag)=0;
			virtual status_t userSelectYes(const int flag)=0;
			virtual status_t enableHideYou(const int flag)=0;
			virtual status_t enableHideMe(const int flag)=0;
			virtual status_t incomingVideoDispaly(const int flag)=0;
			...
			virtual status_t turnOnMicrophone(const bool isOn)=0;
			virtual status_t isMicrophoneOn() const =0;
			virtual status_t turnOnSpeaker(const bool isOn)=0;
			virtual status_t isSpeakerOn() const=0 ;
	...
	#define DECLARE_IVTSINTERFACE	\
			...
			virtual status_t hideLocalView(const int hideMeFlag, const VTSString & hideMeImageURI);	\
			virtual status_t replacePeerVideoSettings(const int enableFlag, const VTSString & filePath); \
			virtual status_t enableAlwaysAskSettings(const int enableFlag); \
			virtual status_t userSelectYes(const int flag); \
			virtual status_t enableHideYou(const int flag); \
			virtual status_t enableHideMe(const int flag); \
			virtual status_t incomingVideoDispaly(const int flag); \
			...
			virtual status_t turnOnMicrophone(const bool isOn);	\
			virtual status_t isMicrophoneOn() const ;	\
			virtual status_t turnOnSpeaker(const bool isOn);	\
			virtual status_t isSpeakerOn() const ;	\
