 ...
 *                       If 0, the old name matching function is used that support
 *                       English-like language matching better.
 *                       If 1, A new name matching function is used that supports Chinese
 *                       Matching better.
 *
 * RETURNS:
 *  bool
