...
typedef enum
{
    ...
    UTL_FEATURE_RGB565_TO_GRAY,
    UTL_FEATURE_CAL_SAD,
    UTL_FEATURE_JPEG_DECODE,
    UTL_FEATURE_IMAGE_CLIP,
    UTL_FEATURE_EXT_MEM_SWITCH_CACHE,
    UTL_FEATURE_NV21_TO_YV12,
    UTL_FEATURE_YV12_TO_NV21,
    UTL_FEATURE_RGB888_TO_YV12,
    UTL_FEATURE_YV12_TO_RGB888,
    UTL_FEATURE_MAX
}    UTL_FEATURE_ENUM;
...
} UTL_IMAGE_INFO_STRUCT, *P_UTL_IMAGE_INFO_STRUCT;
...
typedef struct
{
    ...
    kal_uint16  ImgWidth;
    kal_uint16  ImgHeight;
} UTL_IMAGE_TRANS_INFO_STRUCT, *P_UTL_IMAGE_TRANS_INFO_STRUCT;
