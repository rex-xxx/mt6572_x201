...
#ifndef _MTK_WARP_ERRCODE_H
#define _MTK_WARP_ERRCODE_H
...
#define MODULE_MTK_WARP (0) // Temp value

#define MTKWARP_OKCODE(errid)         OKCODE(MODULE_MTK_WARP, errid)
#define MTKWARP_ERRCODE(errid)        ERRCODE(MODULE_MTK_WARP, errid)


// Detection error code
#define S_WARP_OK                  MTKWARP_OKCODE(0x0000)

#define E_WARP_NEED_OVER_WRITE     MTKWARP_ERRCODE(0x0001)
#define E_WARP_NULL_OBJECT         MTKWARP_ERRCODE(0x0002)
#define E_WARP_WRONG_STATE         MTKWARP_ERRCODE(0x0003)
#define E_WARP_WRONG_CMD_ID        MTKWARP_ERRCODE(0x0004)
#define E_WARP_WRONG_CMD_PARAM     MTKWARP_ERRCODE(0x0005)

#define E_WARP_ERR                 MTKWARP_ERRCODE(0x0100)
