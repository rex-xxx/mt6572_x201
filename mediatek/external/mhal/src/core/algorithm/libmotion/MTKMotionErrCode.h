...
#ifndef _MTK_MOTION_ERRCODE_H
#define _MTK_MOTION_ERRCODE_H
...
#define MODULE_MTK_MOTION (0) // Temp value

#define MTKMOTION_OKCODE(errid)         OKCODE(MODULE_MTK_MOTION, errid)
#define MTKMOTION_ERRCODE(errid)        ERRCODE(MODULE_MTK_MOTION, errid)


// Detection error code
#define S_MOTION_OK                  MTKMOTION_OKCODE(0x0000)

#define E_MOTION_NEED_OVER_WRITE     MTKMOTION_ERRCODE(0x0001)
#define E_MOTION_NULL_OBJECT         MTKMOTION_ERRCODE(0x0002)
#define E_MOTION_WRONG_STATE         MTKMOTION_ERRCODE(0x0003)
#define E_MOTION_WRONG_CMD_ID        MTKMOTION_ERRCODE(0x0004)
#define E_MOTION_WRONG_CMD_PARAM     MTKMOTION_ERRCODE(0x0005)

#define E_MOTION_ERR                 MTKMOTION_ERRCODE(0x0100)
