...
#ifndef _MTK_Pano_ERRCODE_H
#define _MTK_Pano_ERRCODE_H
...
#define ERRCODE(modid, errid)           \
  ((kal_int32)                              \
    ((kal_uint32)(0x80000000) |             \
     (kal_uint32)((modid & 0x7f) << 24) |   \
     (kal_uint32)(errid & 0xffff))          \
  )

#define OKCODE(modid, okid)             \
  ((kal_int32)                              \
    ((kal_uint32)(0x00000000) |             \
     (kal_uint32)((modid & 0x7f) << 24) |   \
     (kal_uint32)(okid & 0xffff))           \
  )
...
#define MODULE_MTK_Pano (0) // Temp value

#define MTKPano_OKCODE(errid)         OKCODE(MODULE_MTK_Pano, errid)
#define MTKPano_ERRCODE(errid)        ERRCODE(MODULE_MTK_Pano, errid)


// Pano error code
#define S_Pano_OK                  MTKPano_OKCODE(0x0000)     

#define E_Pano_NEED_OVER_WRITE     MTKPano_ERRCODE(0x0001)
#define E_Pano_NULL_OBJECT         MTKPano_ERRCODE(0x0002)
#define E_Pano_WRONG_STATE         MTKPano_ERRCODE(0x0003)
#define E_Pano_WRONG_CMD_ID        MTKPano_ERRCODE(0x0004)
#define E_Pano_WRONG_CMD_PARAM     MTKPano_ERRCODE(0x0005)

#define E_Pano_ERR                 MTKPano_ERRCODE(0x0100)
