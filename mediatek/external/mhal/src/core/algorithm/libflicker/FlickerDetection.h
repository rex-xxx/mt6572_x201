...
FLICKER_STATUS detectFlicker_SW(const MUINT32 w, const MUINT32 h, const MINT32 *vx, const MINT32 *vy, const MINT32 LMV_th, LMV_STATUS *lmvFlag, MINT32 *AF_stat, const MINT32 *C_list0, const MINT32 *C_list1, const MUINT32 pck, const MUINT32 fll, MINT32 vAMDF[8], const FLICKER_STATUS oldStatus, MINT32 *freq_frame, MINT32 *f000, MINT32 *f100, MINT32 *f120);

/* build final representative column vector and compute AMDF */
MVOID calcFlickerStat(const MUINT32 w, const MUINT32 h, const int *AF_stat, const int *C_list0, const int *C_list1, const MUINT32 pck, const MUINT32 fll, int vAMDF[8]);
