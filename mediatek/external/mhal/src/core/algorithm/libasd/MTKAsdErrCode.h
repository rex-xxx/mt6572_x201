...
#ifndef _MTK_ASD_ERRCODE_H
#define _MTK_ASD_ERRCODE_H
...
#define MODULE_MTK_ASD (0) // Temp value

#define MTKASD_OKCODE(errid)         OKCODE(MODULE_MTK_ASD, errid)
#define MTKASD_ERRCODE(errid)        ERRCODE(MODULE_MTK_ASD, errid)


// Detection error code
#define S_ASD_OK                  MTKASD_OKCODE(0x0000)

#define E_ASD_NEED_OVER_WRITE     MTKASD_ERRCODE(0x0001)
#define E_ASD_NULL_OBJECT         MTKASD_ERRCODE(0x0002)
#define E_ASD_WRONG_STATE         MTKASD_ERRCODE(0x0003)
#define E_ASD_WRONG_CMD_ID        MTKASD_ERRCODE(0x0004)
#define E_ASD_WRONG_CMD_PARAM     MTKASD_ERRCODE(0x0005)

#define E_ASD_ERR                 MTKASD_ERRCODE(0x0100)
