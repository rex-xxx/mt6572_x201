...
#ifndef _MTK_PANO3D_ERRCODE_H
#define _MTK_PANO3D_ERRCODE_H
...
#define MODULE_MTK_PANO3D (0) // Temp value

#define MTKPANO3D_OKCODE(errid)         OKCODE(MODULE_MTK_PANO3D, errid)
#define MTKPANO3D_ERRCODE(errid)        ERRCODE(MODULE_MTK_PANO3D, errid)


// Detection error code
#define S_PANO3D_OK                  MTKPANO3D_OKCODE(0x0000)

#define E_PANO3D_NEED_OVER_WRITE     MTKPANO3D_ERRCODE(0x0001)
#define E_PANO3D_NULL_OBJECT         MTKPANO3D_ERRCODE(0x0002)
#define E_PANO3D_WRONG_STATE         MTKPANO3D_ERRCODE(0x0003)
#define E_PANO3D_WRONG_CMD_ID        MTKPANO3D_ERRCODE(0x0004)
#define E_PANO3D_WRONG_CMD_PARAM     MTKPANO3D_ERRCODE(0x0005)

#define E_PANO3D_ERR                 MTKPANO3D_ERRCODE(0x0100)
