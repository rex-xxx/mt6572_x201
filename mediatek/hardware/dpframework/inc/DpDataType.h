...
#define DP_COLORFMT_PACK(PLANECNT , BITSPERPIXEL , FMTGROUP , UNIQUEID)             \
        ((PLANECNT << 8) | (BITSPERPIXEL << 12) | (FMTGROUP << 21) | UNIQUEID)

#define DP_COLOR_GET_PLANE_COUNT(FMT)   ((0xF00 & FMT) >> 8)
#define DP_COLOR_BITS_PER_PIXEL(FMT)    ((0x1FF000 & FMT) >> 12)
#define DP_COLOR_BYTES_PER_PIXEL(FMT)   ((((0x1FF000 & FMT) >> 12) + 4) >> 3)
...
{
    DP_COLOR_BAYER8         = DP_COLORFMT_PACK(1,   8, 2,  0),
    DP_COLOR_BAYER10        = DP_COLORFMT_PACK(1,  10, 2,  1),
    DP_COLOR_BAYER12        = DP_COLORFMT_PACK(1,  12, 2,  2),
    DP_COLOR_RGB565         = DP_COLORFMT_PACK(1,  16, 0,  3),
    DP_COLOR_BGR565         = DP_COLORFMT_PACK(1,  16, 0,  4),
    DP_COLOR_RGB888         = DP_COLORFMT_PACK(1,  24, 0,  5),
    DP_COLOR_BGR888         = DP_COLORFMT_PACK(1,  24, 0,  6),
    DP_COLOR_RGBX8888       = DP_COLORFMT_PACK(1,  32, 0,  7),
    DP_COLOR_BGRX8888       = DP_COLORFMT_PACK(1,  32, 0,  8),
    DP_COLOR_RGBA8888       = DP_COLORFMT_PACK(1,  32, 0,  9),
    DP_COLOR_BGRA8888       = DP_COLORFMT_PACK(1,  32, 0, 10),
    DP_COLOR_XRGB8888       = DP_COLORFMT_PACK(1,  32, 0, 11),
    DP_COLOR_XBGR8888       = DP_COLORFMT_PACK(1,  32, 0, 12),
    DP_COLOR_ARGB8888       = DP_COLORFMT_PACK(1,  32, 0, 13),
    DP_COLOR_ABGR8888       = DP_COLORFMT_PACK(1,  32, 0, 14),
    DP_COLOR_I420           = DP_COLORFMT_PACK(3,   8, 1, 15),
    DP_COLOR_YV12           = DP_COLORFMT_PACK(3,   8, 1, 16),
    DP_COLOR_NV12           = DP_COLORFMT_PACK(2,   8, 1, 17),
    DP_COLOR_NV21           = DP_COLORFMT_PACK(2,   8, 1, 18),
    DP_COLOR_I422           = DP_COLORFMT_PACK(3,   8, 1, 19),
    DP_COLOR_YV16           = DP_COLORFMT_PACK(3,   8, 1, 20),
    DP_COLOR_NV16           = DP_COLORFMT_PACK(2,   8, 1, 21),
    DP_COLOR_NV61           = DP_COLORFMT_PACK(2,   8, 1, 22),
    DP_COLOR_YUYV           = DP_COLORFMT_PACK(1,  16, 1, 23),
    DP_COLOR_YVYU           = DP_COLORFMT_PACK(1,  16, 1, 24),
    DP_COLOR_UYVY           = DP_COLORFMT_PACK(1,  16, 1, 25),
    DP_COLOR_VYUY           = DP_COLORFMT_PACK(1,  16, 1, 26),
    DP_COLOR_I444           = DP_COLORFMT_PACK(3,   8, 1, 27),
    DP_COLOR_IYU2           = DP_COLORFMT_PACK(1,  24, 1, 28),
    DP_COLOR_NV24           = DP_COLORFMT_PACK(2,   8, 1, 29),
    DP_COLOR_NV42           = DP_COLORFMT_PACK(2,   8, 1, 30),
    DP_COLOR_GREY           = DP_COLORFMT_PACK(1,   8, 1, 31),

// Mediatek proprietary format
    DP_COLOR_420_BLKP       = DP_COLORFMT_PACK(2, 256, 1, 32),
    DP_COLOR_420_BLKI       = DP_COLORFMT_PACK(2, 256, 1, 33),
    DP_COLOR_422_BLKP       = DP_COLORFMT_PACK(1, 512, 1, 34),
    DP_COLOR_MTKYUV         = DP_COLORFMT_PACK(1, 512, 1, 35),
    DP_COLOR_YUV444_1PLANE  = DP_COLORFMT_PACK(1, 512, 1, 36),
} DP_COLOR_ENUM;
...
#define eYUV_420_2P_YUYV        DP_COLOR_NV12
...
#define ePARGB8888              DP_COLOR_ARGB8888
#define eXARGB8888              DP_COLOR_ARGB8888
...
#define eMTKYUV                 DP_COLOR_MTKYUV
#define eYUV_444_1P             DP_COLOR_YUV444_1PLANE
