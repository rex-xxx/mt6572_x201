...
typedef struct exifAPP1Info_s {
    unsigned short  imgIndex;   // new definition: the index of continuous shot image.
    unsigned long   groupID;    // new definition: group ID for continuous shot.
    unsigned short  bestFocusH; // new definition: focus value (H) for best shot.
    unsigned short  bestFocusL; // new definition: focus value (L) for best shot.
