...
)
{
    ...
    case LIBEXIF_FILE_ERR0001:
        MEXIF_LOG("Error in %s() call, Unsupport file format, err  = %x\n", pname, err);
        break;
    
    case LIBEXIF_APP1_ERR0001:
        MEXIF_LOG("Error in %s() call, THumbnail not found, err = %x\n", pname, err);
        break;  
    case LIBEXIF_APP1_ERR0002:
        MEXIF_LOG("Error in %s() call, TIFF header error, err  =%x\n", pname, err);
        break;      
    case LIBEXIF_DQT_ERR0001:
        MEXIF_LOG("Error in %s() call, Too many DQT found, err  =%x\n", pname, err);
        break;
    #ifdef EXIF_WARNING_DEBUG
    case LIBEXIF_SOI_ERR0001:
        MEXIF_LOG("Error in %s() call, SOI not found, err =%x\n", pname, err);
        break;  
    case LIBEXIF_EOI_ERR0001:
        MEXIF_LOG("Error in %s() call, EOI not found, err = %x\n", pname, err);
        break;
    #endif
    case LIBEXIF_DQT_ERR0002:
        MEXIF_LOG("rror in %s() call, DQT not found!, err = %x\n", pname, err);
        break;  
    ...
    case LIBEXIF_DHT_ERR0006:   
        MEXIF_LOG("Error in %s() call, Unsupport DHT found, err = %x\n", pname, err);
        break;
    case LIBEXIF_SOF_ERR0001:
        MEXIF_LOG("Error in %s() call, SOF not found, err = %x\n", pname, err);
        break;  
    case LIBEXIF_SOF_ERR0002:
        MEXIF_LOG("Error in %s() call, Support SOF length, err = %x\n", pname, err);
        break;      
    case LIBEXIF_SOF_ERR0003:
        MEXIF_LOG("Error in %s() call, Unsupport data format, err = %x\n", pname, err);
        break;      
    case LIBEXIF_SOS_ERR0001:
        MEXIF_LOG("Error in %s() call, SOS not found, err = %x\n", pname, err);;
        break;  
    case LIBEXIF_SOS_ERR0002:
        MEXIF_LOG("Error in %s() call, Support SOS length, err = %x\n", pname, err);
        break;  
    case LIBEXIF_MISC_ERR0001:
        MEXIF_LOG("Error in %s() call, Unknow Maker!, err = %x\n", pname, err);
        break;  
    case LIBEXIF_MISC_ERR0002:
        MEXIF_LOG("Error in %s() call, file size overflow!, err = %x\n", pname, err);
        break;
    case LIBEXIF_IFD_ERR0001:
        MEXIF_LOG(" Error in %s() call, not support IFD list!, err = %x\n", pname, err);
        break;
    case LIBEXIF_IFD_ERR0002:
        MEXIF_LOG("Error in %s() call, Unsupport tag!, err = %x\n", pname, err);
        break;
    case LIBEXIF_IFD_ERR0005:   
        break;
    default:
        MEXIF_LOG("Error in %s() call, Unknow err code!, err = %x\n", pname, err);
