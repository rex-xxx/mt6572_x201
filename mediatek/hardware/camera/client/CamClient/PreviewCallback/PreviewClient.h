...
#ifndef _MTK_CAMERA_CLIENT_CAMCLIENT_PREVIEWCALLBACK_PREVIEWCLIENT_H_
#define _MTK_CAMERA_CLIENT_CAMCLIENT_PREVIEWCALLBACK_PREVIEWCLIENT_H_
//
#include <CamUtils.h>
using namespace android;
using namespace MtkCamUtils;
#include <IParamsManager.h>
#include <IPreviewClient.h>
...
#endif  //_MTK_CAMERA_CLIENT_CAMCLIENT_PREVIEWCALLBACK_PREVIEWCLIENT_H_
