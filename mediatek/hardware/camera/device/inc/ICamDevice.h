...
#ifndef _MTK_CAMERA_DEVICE_INC_ICAMDEVICE_H_
#define _MTK_CAMERA_DEVICE_INC_ICAMDEVICE_H_
//
...
*******************************************************************************/
class ICamDevice : private camera_device_t, public RefBase
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Data Members.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:    ////                Data Members.
    ...
    camera_device_ops_t         mDevOps;        //  which is pointed to by mBase.ops.
    //
    Mutex                       mMtxLock;       //  device lock.
    ...
    static inline ICamDevice*   getIDev(camera_device*const device)
                                {
                                    return (NULL == device)
                                                ? NULL
                                                : reinterpret_cast<ICamDevice*>(device->priv);
                                }

    //
    inline  hw_device_t const*  get_hw_device() const   { return &this->common; }
    inline  hw_device_t*        get_hw_device()         { return &this->common; }
...
public:     ////
    ...
    /**
     * Initialize the device resources owned by this object.
     * This call will invoke onInit() instead.
     */
    bool                        init();
     ...
     * Uninitialize the device resources owned by this object. Note that this is
     * *not* done in the destructor.
     * This call will invoke onUninit() instead.
     */
    bool                        uninit();
...
#endif  //_MTK_CAMERA_DEVICE_INC_ICAMDEVICE_H_
