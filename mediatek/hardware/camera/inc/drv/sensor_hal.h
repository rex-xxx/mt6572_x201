...
typedef enum halSensorCmd_s {
    ...
    SENSOR_CMD_GET_SENSOR_VIEWANGLE,  
    SENSOR_CMD_GET_TEST_PATTERN_CHECKSUM_VALUE,
    SENSOR_CMD_GET_SENSOR_CURRENT_TEMPERATURE,  
    ...
    SENSOR_CMD_SET_YUV_AUTOTEST, 
    SENSOR_CMD_SET_YUV_3A_CMD,  
    ...
    SENSOR_CMD_GET_YUV_STROBE_INFO,
    SENSOR_CMD_GET_YUV_TRIGGER_FLASHLIGHT_INFO,
