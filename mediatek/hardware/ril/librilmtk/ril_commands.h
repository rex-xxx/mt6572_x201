...
*/
    ...
    {RIL_REQUEST_GET_SIM_STATUS,dispatchVoid, responseSimStatus, RIL_CMD_PROXY_4},
    ...
    {RIL_REQUEST_SET_FACILITY_LOCK, dispatchStrings, responseInts, RIL_CMD_PROXY_2},
    ...
    {RIL_REQUEST_SET_NETWORK_SELECTION_AUTOMATIC, dispatchVoid, responseVoid, RIL_CMD_PROXY_1},
