...
error:
	at_response_free(p_response);
    // [ALPS00560383] [mtk02772]
    // modem may not support ES3G, return sim 1 as defualt 3g sim
    // do error handling here instead of wrapped Gemini feature option and request RAT to know if modem is not support 3G
