...
unsigned int bq24158_config_interface_liao (unsigned char RegNum, unsigned char val)
{
    ...
    //printk("[liao bq24158_config_interface] Reg[%x]=0x%x\n", RegNum, val);
    
    //bq24158_write_byte(RegNum, val);
    ret=bq24158_config_interface(RegNum,val,0xFF,0x0);
    printf("[liao bq24158_config_interface] write Reg[%x]=0x%x\n", RegNum, val);

    // Check
    //bq24158_read_byte(RegNum, &bq24158_reg);
    ret=bq24158_read_interface(RegNum,&ret_val,0xFF,0x0);
    printf("[liao bq24158_config_interface] Check Reg[%x]=0x%x\n", RegNum, ret_val);
...
void bq24158_turn_on_charging(void)
{
    ...
    bq24158_config_interface_liao(0x00,0x80);
