...
******************************************************************************/
// #define PMIC_WRAP_BASE          (0x1000F000) // defined in mt6572.h
// #define TOP_CLKCTRL_BASE        (0x10000000) // defined in mtk_pll.h
...
#define TOP_CKCON1_CLR          (PMIC_REG_BASE + 0x12A)
#define AUXADC_ADC12            (PMIC_REG_BASE + 0x72C)
#define AUXADC_ADC13            (PMIC_REG_BASE + 0x72E)
#define AUXADC_ADC14            (PMIC_REG_BASE + 0x730)
#define AUXADC_CON21            (PMIC_REG_BASE + 0x76C)
