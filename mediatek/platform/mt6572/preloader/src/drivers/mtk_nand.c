...
#define DRV_CFG_NFIA           ((volatile u32 *)(IO_CFG_LEFT_BASE+0x0080)) // NFI_A driving
#define DRV_CFG_NFIB           ((volatile u32 *)(IO_CFG_BOTTOM_BASE+0x0060)) // NFI_B driving


void mtk_nand_gpio_init(void)
{
	u32 reg_value;
  *GPIO_MODE4_NFI = ((0x04)<<28) |
                    ((0x04)<<24) |
                    ((0x04)<<20) |
                    ((0x04)<<16) |
                    ((0x04)<<12) |
  ...
  *GPIO_MODE5_NFI = ((0x04)<<28) |
                    ...
                    ((0x04)<<4) |
                    ((0x04)<<0) ;
  reg_value = *GPIO_MODE6_NFI;
  reg_value &= 0xF0000000;
  *GPIO_MODE6_NFI = reg_value |
                    ((0x04)<<24) |
                    ((0x04)<<20) |
                    ((0x04)<<16) |
                    ((0x04)<<12) |
                    ...
                    ((0x04)<<4) |
                    ((0x04)<<0) ;
  // set default NFI driving to 8mA
  // 00: 2mA
  //  01: 4mA
  //  10: 6mA
  //  11: 8mA
  reg_value = *DRV_CFG_NFIA;
  reg_value &= ~(0x03<<12);
  *DRV_CFG_NFIA |= (0x03<<12);
  //000: 2mA
  //  001: 4mA
  //  010: 6mA
  //  011: 8mA
