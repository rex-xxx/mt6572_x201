...
int AudioFtm::Audio_FM_I2S_Play(char bEnable)
{
    ...
    if (bEnable == true) {
        ...
        mAudioDigitalInstance->Set2ndI2SInConfig(32000,true);
...
int AudioFtm::Audio_MATV_I2S_Play(char bEnable)
{
    ...
    if (bEnable == true) {
        ...
        MatvI2SOut.mLR_SWAP = AudioDigtalI2S::NO_SWAP;
        MatvI2SOut.mI2S_SLAVE = AudioDigtalI2S::MASTER_MODE; //Audio Sys In Master Mode
        MatvI2SOut.mINV_LRCK = AudioDigtalI2S::NO_INVERSE;
        MatvI2SOut.mI2S_FMT = AudioDigtalI2S::I2S;
        MatvI2SOut.mI2S_WLEN = AudioDigtalI2S::WLEN_16BITS;
        MatvI2SOut.mI2S_SAMPLERATE = 32000;
        MatvI2SOut.mI2S_IN_PAD_SEL = AudioDigtalI2S::I2S_IN_FROM_IO_MUX;
        mAudioDigitalInstance->Set2ndI2SIn(&MatvI2SOut);
        mAudioDigitalInstance->Set2ndI2SInEnable(true);
        mAudioDigitalInstance->SetI2SASRCConfig(true,44100);// Covert to 44100
        mAudioDigitalInstance->SetI2SASRCEnable(true);
