    ...
    switch (mpsz8RawSaveMode[0])
    {
        ...
        case '4': // 4: "Video Preview Mode"
            if  ( (u4RawImgSize > 0) && (puRawImgBuf != 0) && (ms8RawFilePath != ""))
            {
                ...
                sprintf(mpszSuffix, "__%dx%d_%d_%d", engParam.u4SensorWidth, engParam.u4SensorHeight, engParam.u4Bitdepth, engParam.u4RawPixelID); /* info from EngShot::onCmd_capture */
