...
#define LOG_TAG "MtkATV/CaptureCmdTh"
//
...
*
*******************************************************************************/
#define MY_LOGV(fmt, arg...)        CAM_LOGV("[CaptureCmdQueThread::%s] "fmt,  __FUNCTION__, ##arg)
#define MY_LOGD(fmt, arg...)        CAM_LOGD("[CaptureCmdQueThread::%s] "fmt,  __FUNCTION__, ##arg)
#define MY_LOGI(fmt, arg...)        CAM_LOGI("[CaptureCmdQueThread::%s] "fmt,  __FUNCTION__, ##arg)
#define MY_LOGW(fmt, arg...)        CAM_LOGW("[CaptureCmdQueThread::%s] "fmt,  __FUNCTION__, ##arg)
#define MY_LOGE(fmt, arg...)        CAM_LOGE("[CaptureCmdQueThread::%s] "fmt,  __FUNCTION__, ##arg)
#define MY_LOGA(fmt, arg...)        CAM_LOGA("[CaptureCmdQueThread::%s] "fmt,  __FUNCTION__, ##arg)
#define MY_LOGF(fmt, arg...)        CAM_LOGF("[CaptureCmdQueThread::%s] "fmt,  __FUNCTION__, ##arg)
//
...
readyToRun()
{
    ::prctl(PR_SET_NAME,(unsigned long)"Capture@CmdQue", 0, 0, 0);
    //
    mi4Tid = ::gettid();
