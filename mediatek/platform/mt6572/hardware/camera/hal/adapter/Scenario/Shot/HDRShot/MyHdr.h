...
#define HDR_SWITCH_CAPTURE_SEQUENCE             (1)		// switch HDR capture sequence from  low Ev, normal, high  to normal, low, high(only apply on 3 pics)
...
#include "Hdr.h"
//#include <isp_hal.h>
//#include <aaa_hal_base.h> //kidd:?
//#include <mhal_interface.h>     // For Mdp_BitbltSlice() (for HDR Rotate).

#include <camshot/_callbacks.h> //workaround for ISImager.h
#include "ISImager.h"
#include <fcntl.h>
