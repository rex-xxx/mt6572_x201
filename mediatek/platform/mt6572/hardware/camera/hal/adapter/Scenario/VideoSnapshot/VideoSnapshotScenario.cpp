...
//
#include <common/camexif/IBaseCamExif.h>
#include <common/camexif/CamExif.h>
...
#include <vssimgtrans/vss_img_trans.h>
//
...
readyToRun()
{
    ::prctl(PR_SET_NAME,(unsigned long)"VSS@Snapshot", 0, 0, 0);
    //
    mThreadId = ::gettid();
