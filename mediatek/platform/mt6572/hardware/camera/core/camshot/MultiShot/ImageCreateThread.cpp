...
readyToRun() 
{
    ...
    ::prctl(PR_SET_NAME,(unsigned long)"MShot@CreateImage", 0, 0, 0);
    //
    mi4Tid = ::gettid();
...
readyToRun()
{
    ...
    ::prctl(PR_SET_NAME,(unsigned long)"MShot@CreateYuv", 0, 0, 0);
    //
    mi4Tid = ::gettid();
...
readyToRun()
{
    ...
    ::prctl(PR_SET_NAME,(unsigned long)"MShot@CreateThumbnail", 0, 0, 0);
    //
    mi4Tid = ::gettid();
...
readyToRun()
{
    ...
    ::prctl(PR_SET_NAME,(unsigned long)"MShot@CreateJpeg", 0, 0, 0);
    //
    mi4Tid = ::gettid();
