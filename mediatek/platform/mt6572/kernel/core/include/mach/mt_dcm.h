...
#define INFRABUS_DCMCTL0    	(TOPCKGEN_BASE + 0x0028)
#define INFRABUS_DCMCTL1    	(TOPCKGEN_BASE + 0x002C)
#define SET_INFRABUS_DCMCTL0	(TOPCKGEN_BASE + 0x0058)
#define SET_INFRABUS_DCMCTL1    (TOPCKGEN_BASE + 0x005C)
#define CLR_INFRABUS_DCMCTL0    (TOPCKGEN_BASE + 0x0088)
#define CLR_INFRABUS_DCMCTL1    (TOPCKGEN_BASE + 0x008C)
...
#define	RG_BUSDCM_APB_SEL_MASK		0x1
...
#define RG_GOOD_DUR_CRITERIA_MASK		0xFFFF
