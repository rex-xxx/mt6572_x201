...
{
   /* PeriSys */	 
   { .master = MST_ID_PERI_0, .domain = 0x0, .id_mask = 0b11111111, .id_val = 0b00100000, .name = "PERISYS:APDMA/APMCU" },
   { .master = MST_ID_PERI_1, .domain = 0x0, .id_mask = 0b11111111, .id_val = 0b00000101, .name = "PERISYS:NFI/USB/MSDC0/APMCU" },
   { .master = MST_ID_PERI_2, .domain = 0x0, .id_mask = 0b11111111, .id_val = 0b00000010, .name = "PERISYS:SPI/MSDC1/Audio/SPM" },

    /* apmcu */
    { .master = MST_ID_APMCU_0, .domain = 0x0, .id_mask = 0b11000000, .id_val = 0b00000000, .name = "APMCU: " },
    
   /* Modem HW (2G/3G) */
   { .master = MST_ID_MDHW_0, .domain = 0x1, .id_mask = 0b11000111, .id_val = 0b00000000, .name = "MDHW:MD DMA/ MDMCU:CR4" },
   { .master = MST_ID_MDHW_1, .domain = 0x1, .id_mask = 0b11000111, .id_val = 0b00000100, .name = "MDHW:ABM/ MDMCU:CR4" },
   { .master = MST_ID_MDHW_2, .domain = 0x1, .id_mask = 0b11111111, .id_val = 0b00000001, .name = "MDHW:2G/ MDMCU:PFB" },
   { .master = MST_ID_MDHW_3, .domain = 0x1, .id_mask = 0b11111111, .id_val = 0b00001001, .name = "MDHW:BYC_ACC/ MDMCU:PFB" },
   { .master = MST_ID_MDHW_4, .domain = 0x1, .id_mask = 0b11111111, .id_val = 0b00001101, .name = "MDHW:3G/ MDMCU:PFB" },
   { .master = MST_ID_MDHW_5, .domain = 0x1, .id_mask = 0b11111111, .id_val = 0b00011101, .name = "MDHW:3G/ MDMCU:PFB" },
   { .master = MST_ID_MDHW_6, .domain = 0x1, .id_mask = 0b11111111, .id_val = 0b00011110, .name = "MDHW:TDSYS/ MDMCU:ALC" }, 
...
#if 0   // CM [20130207] 
    list_for_each(p, &(emi_mpu_notifier_list[__id2mst(domain_ID,master_ID)])) {
