...
#define DDP_REG_BASE_DBI	       0xf4012000 
...
#define DISPSYS_RDMA0_BASE      DDP_REG_BASE_DISP_RDMA			
...
#define LCD_BASE        DDP_REG_BASE_DBI				
...
#define DISP_REG_CONFIG_WROT_MBISR_RESET            (DISPSYS_CONFIG_BASE + 0x850)
#define DISP_REG_CONFIG_WROT_MBISR_FAIL            (DISPSYS_CONFIG_BASE + 0x854)
#define DISP_REG_CONFIG_WROT_MBISR_OK            (DISPSYS_CONFIG_BASE + 0x858)
