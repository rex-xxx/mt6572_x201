...
int OVLLayerConfig(unsigned int layer,
    ...
    switch(layer) {
        case 0:
            ...
            if(0 == strncmp(MTK_LCM_PHYSICAL_ROTATION, "180", 3))
            {
                DISP_REG_SET(DISP_REG_OVL_L0_ADDR, addr+src_w*src_h*bpp-1-src_x*bpp-src_y*src_pitch);
            }
            else
#endif
            {
        ...
        case 1:
            ...
            if(0 == strncmp(MTK_LCM_PHYSICAL_ROTATION, "180", 3))
            {
                DISP_REG_SET(DISP_REG_OVL_L1_ADDR, addr+src_w*src_h*bpp-1-src_x*bpp-src_y*src_pitch);
            }
            else
#endif
            {
        ...
        case 2:
            ...
            if(0 == strncmp(MTK_LCM_PHYSICAL_ROTATION, "180", 3))
            {
                DISP_REG_SET(DISP_REG_OVL_L2_ADDR, addr+src_w*src_h*bpp-1-src_x*bpp-src_y*src_pitch);
            }
            else
#endif
            {
        ...
        case 3:
            ...
            if(0 == strncmp(MTK_LCM_PHYSICAL_ROTATION, "180", 3))
            {
                DISP_REG_SET(DISP_REG_OVL_L3_ADDR, addr+src_w*src_h*bpp-1-src_x*bpp-src_y*src_pitch);
            }
            else
#endif
            {
