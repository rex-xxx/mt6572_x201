 ...
 ******************************************************************************/
uint32 sec_secro_md_len (uchar *md_info)
{
    uint32 index = 0;
 ...
 ******************************************************************************/
uint32 sec_secro_md_get_data (uchar *md_info, uchar* buf, uint32 offset, uint32 len)
{
    uint32 ret = SEC_OK;
    ...
    else 
    {
        ...
        else
        {
            ...
            if(TRUE == sec_secro_ac())
            {
              sp_hacc_dec((uchar*)&secroimg_v5.m_md_info_v5a, cipher_len, TRUE,HACC_USER1,TRUE);
            }
