...
extern unsigned int sec_secro_v5_check (void);
extern bool sec_secro_en (void);
extern bool sec_secro_ac (void);
extern unsigned int sec_secro_md_len (uchar *md_info);
extern unsigned int sec_secro_md_get_data (uchar *md_info, unsigned char* buf, unsigned int offset, unsigned int len);
