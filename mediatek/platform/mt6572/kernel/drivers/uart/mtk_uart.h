...
/*---------------------------------------------------------------------------*/
/* For MT6572, both RX and TX will not use port to send or receive data */
/* IER */
...
#define UART_MCR_DCM_EN             (1 << 5)    /* MT6572 no this bit */
