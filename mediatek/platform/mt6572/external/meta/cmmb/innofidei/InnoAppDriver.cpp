...
#define ADR_LOGE(fmt, args...) ALOGE( "appdriver - %s(): " fmt "\n", __FUNCTION__, ##args)
#define ADR_LOGW(fmt, args...) ALOGW( "appdriver - %s(): " fmt "\n", __FUNCTION__, ##args)
#define ADR_LOGI(fmt, args...) ALOGI( "appdriver - %s(): " fmt "\n", __FUNCTION__, ##args)
#define ADR_LOGD(fmt, args...) ALOGD( "appdriver - %s(): " fmt "\n", __FUNCTION__, ##args)
#else
