...
{
    ALOGD("%s() GetInstance! mSpeechDriverFactory: 0x%x", __FUNCTION__, mSpeechDriverFactory);
    ...
    ALOGD("%s() GetInstance done! mSpeechDriverFactory: 0x%x", __FUNCTION__, mSpeechDriverFactory);
...
SpeechDriverInterface *SpeechDriverFactory::GetSpeechDriver()
{
    ...
    ALOGD("%s() mActiveModemIndex:%d, pSpeechDriver:0x%x", __FUNCTION__,mActiveModemIndex,pSpeechDriver);
