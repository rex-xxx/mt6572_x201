...
class AudioDigitalControlInterface
{
    public:
        ...
        * @return status_t
        */
        virtual status_t SetFmChip(bool enable) = 0;
        ...
        * @return bool
        */
        virtual bool GetI2SConnectStatus(void) = 0;
        ...
        * @return status_t
        */
        virtual status_t SetFmDigitalStatus(bool bEnable) = 0;
        ...
        * @return bool
        */
        virtual bool GetFmDigitalStatus(void) = 0;
		/**
