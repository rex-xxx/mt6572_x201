...
class SpeechMessengerCCCI
{
    public:
        ...
        /**
         * MD side modem function real status
         */
        virtual uint32_t    GetAllModemSideRealModemStatus();
        virtual void        SetModemSideRealModemStatus(const modem_status_mask_t modem_status_mask);
        virtual bool        GetModemSideRealModemStatus(const modem_status_mask_t modem_status_mask) const;
    ...
    protected:
        ...
        /**
         * set/reset MD side modem function real status
         */

        virtual void        ResetModemSideRealModemStatus(const modem_status_mask_t modem_status_mask);
        virtual void        ResetModemSideRealModemStatusAfterMDReset();
        ...
        uint32_t mModemSideRealModemStatus;
