                                                       ...
                                                       uint32_t delayMs)
{
    ...
    for (size_t i = 0; i < NUM_STRATEGIES; i++) {
        ...
        bool bFM2MusicStarTempMute = ( (outputDesc->strategyRefCount((routing_strategy)STRATEGY_PROPRIETARY_ANLG)||
                                        outputDesc->strategyRefCount((routing_strategy)STRATEGY_PROPRIETARY_ANLG_V2)||
                                        outputDesc->strategyRefCount((routing_strategy)STRATEGY_PROPRIETARY_DGTL)||
                                        outputDesc->strategyRefCount((routing_strategy)STRATEGY_PROPRIETARY_DGTL_V2))
                                     &&outputDesc->mRefCount[AudioSystem::MUSIC]&&(i==STRATEGY_MEDIA));
#endif
...
||bFM2MusicStarTempMute
                        ...
                        if((STRATEGY_PROPRIETARY_ANLG == i||STRATEGY_PROPRIETARY_ANLG_V2 == i)||(STRATEGY_MEDIA == i && bFM2MusicStarTempMute))//[ALPS00414767] Add STRATEGY_MEDIA case
                        {
                            ...
                            setStrategyMute((routing_strategy)i, false, curOutput,desc->latency() * 6, device);
                        }
                        else if ((STRATEGY_PROPRIETARY_DGTL == i)||(STRATEGY_PROPRIETARY_DGTL_V2 == i))
                        {
                            setStrategyMute((routing_strategy)i, false, curOutput,desc->latency() * 6, device);
                        }
                        else
