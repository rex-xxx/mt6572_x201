...
public abstract class VoiceCommandListener {
    ...
    public static final int ACTION_VOICE_COMMON_PROCSTATE = ACTION_COMMON + 1;
    ...
    public VoiceCommandListener(String pkgName) {
        mPkgName = pkgName;
    }
    ...
    /*
     * Override by apps and keyguard for receiving the message from voice
     * command service
     *
     * @param mainAction
     *            check the column of 'Main Action' in the protocol table
     * @param subAction
     *            check the column of 'Sub Action' in the protocol table
     * @param extraData
     *            check the column of 'Extra Data Key & Value' in the protocol
     *            table
     */
    public abstract void onVoiceCommandNotified(int mainAction, int subAction, Bundle extraData);
