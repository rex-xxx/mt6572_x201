...
public class J3mPresentationEngine implements PresentationEngine {
    ...
    private Set<AnimationController> mAnimationControllers =
    ...
    public void initialize(int width, int height, Resources resources,
                           String cacheDir, boolean enableNDB, String libDir) {
    ...
    public void initialize(int width, int height, Resources resources, String cacheDir, boolean enableNDB) {
        initialize(width, height, resources, cacheDir, enableNDB, null);
    }
     ...
     */
    public RenderLayer createRenderLayer(Presentation presentation) {
        return new LayerPresentation(this, mRenderer, presentation);
    }
    ...
    public void addRenderLayer(RenderLayer layer) {
        assert layer instanceof LayerPresentation;
        LayerPresentation layerPresentation =
                (LayerPresentation) layer;
        mRenderBlockGroup.addBlock(layerPresentation.getRenderBlock());
        layerPresentation.getRootNode().setParent(mTrueRootNode);
    }
}
