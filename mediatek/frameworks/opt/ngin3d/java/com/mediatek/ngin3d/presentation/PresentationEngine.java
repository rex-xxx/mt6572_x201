...
public interface PresentationEngine {
     ...
     */
    void initialize(int width, int height, Resources resources, String cacheDir, boolean debug, String libDir);
     ...
     */
    RenderLayer createRenderLayer(Presentation presentation);
