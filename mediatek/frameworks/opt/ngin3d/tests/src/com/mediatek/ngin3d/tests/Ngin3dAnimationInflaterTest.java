...
public class Ngin3dAnimationInflaterTest extends Ngin3dInstrumentationTestCase {
    ...
    public void testAnimationMultiSpriteAnimation() {
        ...
        Image image = (Image)Ngin3dLayoutInflater.inflateLayout(mActivity, R.xml.test_single_actor_multi_sprite_animation_target, mStage);
        assertNotNull(image);

        /* TC 1: test multi SpriteAnimation with full info in xml */
        SpriteAnimation multiSpriteAni = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_multi_sprite_animation_with_full_info, mStage);
        ...
        SpriteAnimation multiSpriteAni2 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_multi_sprite_animation_with_partial_info, mStage);
        ...
        SpriteAnimation multiSpriteAni3 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_multi_sprite_animation_without_target_info, mStage);
        assertNull(multiSpriteAni3.getTarget());

        /* TC 12: test multi SpriteAnimation without duration info in xml */
        try {
            SpriteAnimation multiSpriteAni4 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_multi_sprite_animation_without_duration_info, mStage);
            fail("Should throw exception.");
        } catch (IllegalArgumentException e) {
            //expected
        }
        ...
        try {
            SpriteAnimation multiSpriteAni5 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_multi_sprite_animation_without_type_info, mStage);
            fail("Should throw exception.");
        } catch (IllegalArgumentException e) {
            //expected
        }
    ...
    public void testAnimationSingleSpriteAnimation() {
        ...
        Image image2 = (Image)Ngin3dLayoutInflater.inflateLayout(mActivity, R.xml.test_single_actor_single_sprite_animation_target, mStage);
        assertNotNull(image2);

        SpriteAnimation singleSpriteAni = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_single_sprite_animation_with_full_info, mStage);
        ...
        SpriteAnimation singleSpriteAni2 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_single_sprite_animation_with_partial_info, mStage);
        ...
        SpriteAnimation singleSpriteAni3 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_single_sprite_animation_without_target_info, mStage);
        assertNull(singleSpriteAni3.getTarget());

        /* TC 12: test single SpriteAnimation without type info in xml */
        try {
            SpriteAnimation singleSpriteAni4 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_single_sprite_animation_without_type_info, mStage);
            fail("Should throw exception.");
        } catch (IllegalArgumentException e) {
            //expected
        }
        ...
        try {
            SpriteAnimation singleSpriteAni5 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_single_sprite_animation_without_duration_info, mStage);
            fail("Should throw exception.");
        } catch (IllegalArgumentException e) {
            //expected
        }
        ...
        try {
            SpriteAnimation singleSpriteAni6 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_single_sprite_animation_without_width_height_info, mStage);
            fail("Should throw exception.");
        } catch (IllegalArgumentException e) {
            //expected
        }
        ...
        try {
            SpriteAnimation singleSpriteAni7 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_single_sprite_animation_without_image_src_info, mStage);
            fail("Should throw exception.");
        } catch (IllegalArgumentException e) {
            //expected
        }
    ...
    public void testAnimationSheetSpriteAnimation() {
        ...
        Image image3 = (Image)Ngin3dLayoutInflater.inflateLayout(mActivity, R.xml.test_single_actor_sheet_sprite_animation_target, mStage);
        assertNotNull(image3);

        SpriteAnimation sheetSpriteAni = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_sheet_sprite_animation_with_full_info, mStage);
        ...
        SpriteAnimation sheetSpriteAni2 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_sheet_sprite_animation_with_partial_info, mStage);
        ...
        SpriteAnimation sheetSpriteAni3 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_sheet_sprite_animation_without_target_info, mStage);
        assertNull(sheetSpriteAni3.getTarget());

        /* TC 10: test sheet SpriteAnimation without type info in xml */
        try {
            SpriteAnimation sheetSpriteAni4 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_sheet_sprite_animation_without_type_info, mStage);
            fail("Should throw exception.");
        } catch (IllegalArgumentException e) {
            //expected
        }
        ...
        try {
            SpriteAnimation sheetSpriteAni5 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_sheet_sprite_animation_without_duration_info, mStage);
            fail("Should throw exception.");
        } catch (IllegalArgumentException e) {
            //expected
        }
        ...
        try {
            SpriteAnimation sheetSpriteAni6 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_sheet_sprite_animation_without_image_src_info, mStage);
            fail("Should throw exception.");
        } catch (IllegalArgumentException e) {
            //expected
        }
        ...
        try {
            SpriteAnimation sheetSpriteAni7 = (SpriteAnimation)Ngin3dAnimationInflater.inflateAnimation(mActivity, R.xml.test_sheet_sprite_animation_without_image_description_info, mStage);
            fail("Should throw exception.");
        } catch (IllegalArgumentException e) {
            //expected
        }
