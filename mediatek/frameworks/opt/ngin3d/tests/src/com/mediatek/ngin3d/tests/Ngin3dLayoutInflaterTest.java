...
public class Ngin3dLayoutInflaterTest extends ActivityInstrumentationTestCase2<PresentationStubActivity> {
    ...
    public void testActorSphere() {
       ...
       /* failed case, wait for ngin3d's support.
        ...
        /* TC 5: test image with anchorPoint info in xml */
        Point anchorPoint = new Point(0.1f, 0.1f, 0.1f);
        assertEquals(anchorPoint , sphere.getAnchorPoint());
       ...
       /* failed case, wait for ngin3d's support
        ...
        /* TC 5: test sphere with anchorPoint info in xml */
        Point anchorPoint2 = new Point(0f, 0f, 0f);
        assertEquals(anchorPoint2, sphere2.getAnchorPoint());
    ...
    public void testActorContainer() {
        ...
        /* TC 6: test Container with anchorPoint info in xml */
        Point anchorPoint = new Point(0.1f, 0.1f, 0.1f);
        assertEquals(anchorPoint , container.getAnchorPoint());
        ...
        /* TC 11: test Container with anchorPoint info in xml */
        /* Default container anchorPoint has moved from Point (0.5, 0.5, 0)
                  to Point (0,0,0) */
        Point anchorPoint2 = new Point(0, 0, 0);
        assertEquals(anchorPoint2 , container2.getAnchorPoint());
        ...
        assertEquals("ngin3d Test", ((Text)(container4.findChildByTag(R.id.text7, Group.BREADTH_FIRST_SEARCH))).getText());
    }
