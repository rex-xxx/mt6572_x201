...
SDK API package provides API libraries, documents and Android add-on components.
The toolset package offers MediaTek customized tools that can help debugging.
