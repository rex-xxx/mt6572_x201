...
static JNINativeMethod gNotify[] = {
    ...
    { "enableCEC", 	        "(Z)Z",       (void*)enableCEC},
    { "enableHDCP", 	    "(Z)Z",       (void*)enableHDCP},
//    { "GetDeviceStatus","(ZZ)Z", 	(void*)GetDeviceStatus},
    { "setVideoConfig",     "(I)Z",       (void*)setVideoConfig},
    { "setAudioConfig",     "(I)Z",       (void*)setAudioConfig},
    { "setDeepColor",       "(II)Z",      (void*)setDeepColor},
    { "setHDCPKey",         "([B)Z",      (void*)setHDCPKey},
    { "setCECAddr",         "(B[BCC)Z",   (void*)setCECAddr},
    { "setCECCmd",          "(BBC[BIB)Z", (void*)setCECCmd},
    { "getEDID",            "()[I",       (void*)getEDID},
    { "getCECAddr",         "()[C",       (void*)getCECAddr},
    { "getCECCmd",          "()[I",       (void*)getCECCmd},
