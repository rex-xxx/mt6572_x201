...
package com.mediatek.common.widget.tests.layout.table;

import com.mediatek.common.widget.tests.layout.table.FixedWidth;
...
public class FixedWidthTest extends ActivityInstrumentationTestCase<FixedWidth> {
    ...
    public FixedWidthTest() {
        super("com.mediatek.common.widget.tests", FixedWidth.class);
    }
