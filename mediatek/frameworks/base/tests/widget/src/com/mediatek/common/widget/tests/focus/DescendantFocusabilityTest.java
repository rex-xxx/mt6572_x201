...
package com.mediatek.common.widget.tests.focus;

import com.mediatek.common.widget.tests.focus.DescendantFocusability;
...
public class DescendantFocusabilityTest extends ActivityInstrumentationTestCase<DescendantFocusability> {
    ...
    public DescendantFocusabilityTest() {
        super("com.mediatek.common.widget.tests", DescendantFocusability.class);
    }
