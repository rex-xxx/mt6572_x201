...
public class PackageManagerTest extends AndroidTestCase {
    ...
    private static final String CONTENT_PKG_NAME = "com.mediatek.cts.pms";
    private static final String ACTIVITY_ACTION_NAME = "mediatek.intent.action.PMTEST";
    private static final String MAIN_ACTION_NAME = "android.intent.action.MAIN";
    private static final String SERVICE_ACTION_NAME = "mediatek.content.pm.cts.activity.PMTEST_SERVICE";
    ...
    private static final String SERVICE_NAME = "mediatek.content.pm.cts.TestPmService";
    private static final String RECEIVER_NAME = "mediatek.content.pm.cts.PmTestReceiver";
    private static final String INSTRUMENT_NAME = "mediatek.content.pm.cts.TestPmInstrumentation";
    private static final String PROVIDER_NAME = "mediatek.content.cts.MockContentProvider";
    ...
    */
    ...
    public void test_enforceDexOpt() {
        IPackageManager ipm = AppGlobals.getPackageManager();
        try {
            ipm.enforceDexOpt(PACKAGE_NAME);
    ...
    public void testQuery() throws NameNotFoundException {
        ...
        String cmpActivityName = "mediatek.content.pm.cts.TestPmCompare";
        ...
        String receiverActionName = "mediatek.content.pm.cts.PackageManagerTest.PMTEST_RECEIVER";
    ...
    public void testGetInfo() throws NameNotFoundException {
        ...
        String appLabel = "Mediatek PMS TestCase";
        ...
        // mediatek.content.pm.cts.TestPmCompare is set to match the condition
    ...
    public void testOpPermission() {
        ...
        String permissionName = "com.mediatek.cts.pms.stub.permission.TEST_DYNAMIC.ADD";
        permissionInfo.name = permissionName;
        permissionInfo.labelRes = R.string.permlab_testDynamic;
        permissionInfo.nonLocalizedLabel = "Mediatek Test Tree";
    ...
    public void testResolveMethods() {
        ...
        String providerAuthorities = "mediatekpmsctstest";
    ...
    public void testGetResources() throws NameNotFoundException {
        ...
        String xmlName = "com.mediatek.cts.pms.stub:xml/pm_test";
        ApplicationInfo appInfo = mPackageManager.getApplicationInfo(PACKAGE_NAME, 0);
