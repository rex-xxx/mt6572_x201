...
/*Create a mutual */
unsigned int OSAL_MutexCreate(pthread_mutex_t*	pMutex);


/*Delete a previously created Mutex*/
unsigned int OSAL_MutexDelete(pthread_mutex_t*	pMutex);


/*Mutex GET operation*/
unsigned int OSAL_MutexGet(pthread_mutex_t* pMutex);


/*Mutex PUT operation*/
unsigned int OSAL_MutexPut(pthread_mutex_t*pMutex);
