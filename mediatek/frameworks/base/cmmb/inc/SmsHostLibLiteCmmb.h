...
*/
void SMSHOSTLIB_API SmsLiteCmmbSetCaControlWords_Req( UINT32 SvcHdl, UINT32 SfIdx,const SMSHOSTLIB_CA_CW_PAIR_ST *pControlWords);
...
void SMSHOSTLIB_API SmsLiteCmmbSetCaSaltKeys_Req( UINT32 SvcHdl, 
												 UINT32 SfIdx, 
												 const UINT8  pVidSalt[SMSHOSTLIB_CMMB_CA_SALT_SIZE], 
												 const UINT8  pAudSalt[SMSHOSTLIB_CMMB_CA_SALT_SIZE],
												 const UINT8  pDataSalt[SMSHOSTLIB_CMMB_CA_SALT_SIZE] );
...
The content of these messages are set by the MBBMS library.
This function is meant to be used only as a porting layer for the
MBBMS stack. It should not be used for any other application
use.
