...
#ifndef __INNO_UAM_API_H__
#define __INNO_UAM_API_H__
...
#define INNOFIDEI_UAM_MAX_ATR_LEN		(64)
#define INNOFIDEI_CMMB_CA_SALT_SIZE	(8)
#define CARD_RESPONSE_BUFFER_SIZE (256)
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_OpenSession_Innofidei(sp<ICmmbSp> spt);
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_CloseSession_Innofidei(MBBMS_TEL_INT32 sessionId);
 ...
 * \note
 */
MBBMS_TEL_ENV_E MBBMS_TEL_Get_Env_Innofidei(MBBMS_TEL_INT32 sessionId,sp<ICmmbSp> spt);
 ...
 * \note
 */
MBBMS_TEL_RESULT_E MBBMS_TEL_Get_IMSI_Innofidei(MBBMS_TEL_INT32 sessionId, char imsi[MBBMS_TEL_IMSI_LEN],sp<ICmmbSp> spt);
 ...
 * \note
 */
MBBMS_TEL_RESULT_E MBBMS_TEL_Get_IMEI_Innofidei(MBBMS_TEL_INT32 sessionId, char imei[MBBMS_TEL_IMEI_LEN],sp<ICmmbSp> spt);
 ...
 * \param char* - cid
 */
MBBMS_TEL_RESULT_E MBBMS_TEL_Get_LACCID_Innofidei(MBBMS_TEL_INT32 sessionId, char lac[MBBMS_TEL_LAC_LEN], char cid[MBBMS_TEL_CID_LEN],sp<ICmmbSp> spt);
 ...
 * \note
 */
MBBMS_TEL_STATUS_E MBBMS_TEL_IsEnabled_Innofidei(MBBMS_TEL_INT32 sessionId,sp<ICmmbSp> spt);
 ...
 * \note
 */
MBBMS_TEL_BOOLEAN MBBMS_TEL_IsGBANeeded_Innofidei(MBBMS_TEL_INT32 sessionId,sp<ICmmbSp> spt);        
 ...
 * \note
 */
MBBMS_TEL_BOOLEAN MBBMS_TEL_IsMSKValid_Innofidei(MBBMS_TEL_INT32 sessionId,         
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_StartGBA_Innofidei(MBBMS_TEL_INT32 sessionId,
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_GSM_Authenticate_Innofidei(MBBMS_TEL_INT32 sessionId,
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_GSM_User_Authenticate_Innofidei(MBBMS_TEL_INT32 sessionId, MBBMS_TEL_GSM_USER_AUTH_REQ_S *req, MBBMS_TEL_GSM_USER_AUTH_RSP_S *rsp,sp<ICmmbSp> spt);  
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_3G_Authenticate_Innofidei(MBBMS_TEL_INT32 sessionId,
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_3G_User_Authenticate_Innofidei(MBBMS_TEL_INT32 sessionId, MBBMS_TEL_3G_USER_AUTH_REQ_S *req, MBBMS_TEL_3G_USER_AUTH_RSP_S *rsp,sp<ICmmbSp> spt);  
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_UpdateBTID_Innofidei(MBBMS_TEL_INT32 sessionId,                 
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_GetMRK_Innofidei(MBBMS_TEL_INT32 sessionId,                       
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_UpdateMSK_Innofidei(MBBMS_TEL_INT32 sessionId,                     
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_GetMTK_Innofidei(MBBMS_TEL_INT32 sessionId,                             
 ...
 * \note
 */
MBBMS_TEL_INT32 MBBMS_TEL_SeekTimeStamp_Innofidei(MBBMS_TEL_INT32 sessionId,
 ...
 * \note
 */
MBBMS_TEL_RESULT_E MBBMS_TEL_Get_BTID_Innofidei(MBBMS_TEL_INT32 sessionId, char btid[MBBMS_TEL_BTID_LEN],sp<ICmmbSp> spt);    
 ...
 * \note
 */
MBBMS_TEL_RESULT_E MBBMS_TEL_GetCMMBSN_Innofidei(MBBMS_TEL_INT32 sessionId, char cmmbsn[MBBMS_TEL_CMMBSN_RSP_LEN],sp<ICmmbSp> spt);   
 ...
 * \note
 */
MBBMS_TEL_RESULT_E MBBMS_TEL_User_Auth_GetVersion_Innofidei(MBBMS_TEL_INT32 sessionId, char version[MBBMS_TEL_USER_AUTH_VERSION_LEN],sp<ICmmbSp> spt);     

BOOL SetSimType_Innofidei(UAM_SIM_TYPE_ENUM sim_type);
}          //android namespace
#endif           // __MBBMS_UAM_SUPPORT__
#endif            //__INNO_UAM_API_H__
