...
#define S5K8AAYX_TEST_PATTERN_CHECKSUM (0x5a947db7)
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    SENSORDB("S5K8AAYX_MIPIFeatureControl:FeatureId %d\n", FeatureId);
	...
	switch (FeatureId)
	{
        ...
        case SENSOR_FEATURE_AUTOTEST_CMD:
			...
			S5K8AAYX_MIPIAutoTestCmd((*pFeatureData32),*(pFeatureData32+1));
            break;
        case SENSOR_FEATURE_SET_TEST_PATTERN://for factory mode auto testing    
            SENSORDB("SENSOR_FEATURE_SET_TEST_PATTERN\n");
