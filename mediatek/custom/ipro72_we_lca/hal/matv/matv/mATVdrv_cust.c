 ...
 *-----------------------------------------------------------------------------
 * $File: mATVdrv_cust.cpp $
 * $Revision: #1 $
 * $DateTime: 2010/12/1 22:29:53 $
 * $Change:  $
 * $Id: mATVdrv_cust.cpp#11 $
 * $Author: ky.lin $
 *---------------------------------------------------------------------------*/
/**
 *   @file mATVdrv_cust.c
...
void  matv_module_power_on(void)
{
    ...
    DrvSetChipDep(MTK_PAD_DRIVING,0x0f);// F:12ma
    DrvSetChipDep(MTK_PAD_DRIVING,0xAf);// F:12ma
#else
	DrvSetChipDep(MTK_TVD_CamIFMode,0);
//    DrvSetChipDep(MTK_PAD_DRIVING,0x09);// 9:9ma
//    DrvSetChipDep(MTK_PAD_DRIVING,0xA9);// 9:9ma
#endif
