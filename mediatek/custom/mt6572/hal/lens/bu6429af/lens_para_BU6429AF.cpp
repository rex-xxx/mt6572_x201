...
const NVRAM_LENS_PARA_STRUCT BU6429AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 BU6429AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &BU6429AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pBU6429AF_getDefaultData = BU6429AF_getDefaultData;
