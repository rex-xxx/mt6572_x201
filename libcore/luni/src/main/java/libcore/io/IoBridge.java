...
public final class IoBridge {
    ...
    public static void closeSocket(FileDescriptor fd) throws IOException {
        ...
        try{
            ...
            //ingore excpetion just this is a log information
        }        
        /// @}
    ...
    private static Object getSocketOptionErrno(FileDescriptor fd, int option) throws ErrnoException, SocketException {
        ...
        /// M: support snd timeout socket option @{
        case SocketOptions.SO_SND_TIMEOUT:
            return (int) Libcore.os.getsockoptTimeval(fd, SOL_SOCKET, SO_SNDTIMEO).toMillis();
        case SocketOptions.TCP_MAX_RTO: // The socket option is 119
            return (int) Libcore.os.getsockoptInt(fd, IPPROTO_TCP, 119);
        ///@}
        default:
    ...
    private static void setSocketOptionErrno(FileDescriptor fd, int option, Object value) throws ErrnoException, SocketException {
        ...
        case SocketOptions.SO_LINGER:
			...
			System.out.printf("[CDS]IoBridge->SO_LINGER: l_onoff: %d ; l_linger: %d\n", linger.l_onoff, linger.l_linger);
        ...
        case SocketOptions.SO_SND_TIMEOUT:
            ...
            return;
        case SocketOptions.TCP_MAX_RTO:
            int rto = (Integer) value;
            Libcore.os.setsockoptInt(fd, IPPROTO_TCP, 119, rto);
            return;
        ///@}
        default:
            throw new SocketException("Unknown socket option: " + option);
    ...
    /// M: utility function - check the socket is blocked or not
