...
public abstract class URLConnection {
    ...
    /**
     * Specifies whether to support active mode & passive mode in FTP client
     * @hide
     */
    private static boolean doPassiveMode = false;
    ...
    /// M: support passive mode in FtpURLConnection
    /**
     * Sets the flag indicating whether this {@code FtpURLConnection} to run passive mode. 
     * It cannot be set after the connection is established.
     *
     * @param newValue
     *            the new value for the flag to be set.
     ...
     * @hide
     */
    public void setPassiveMode(boolean newValue) {
        checkNotConnected();
        this.doPassiveMode = newValue;
    }

    /**
     * Returns the value of the option {@code doPassiveMode} which specifies whether this
     * ftp connection run in passive mode.
     *
     * @return {@code true} if this connection runs in passive mode, {@code false}
     *         otherwise.
     * @see #doPassiveMode
     * @hide
     */
