...
public interface SocketOptions {
    ...
    /**
     * Integer timeout in milliseconds for blocking write/send operations). 
     ...
     * @hide     
     */
    public static final int SO_SND_TIMEOUT = 4101;


    /**
      * Number of seconds for maximum value Retransmission Timeout in TCP
      * @hide
      *
      */
     
    public static final int TCP_MAX_RTO = 119;
    ///@}
