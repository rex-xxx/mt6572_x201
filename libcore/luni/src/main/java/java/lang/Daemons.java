...
public final class Daemons {
    ...
    //wschen 2013-05-09 increase timeout to 40s
    private static final long MAX_FINALIZE_NANOS = 40L * NANOS_PER_SECOND;
    private static final long HALF_FINALIZE_NANOS = MAX_FINALIZE_NANOS / 2;
    ...
    private static class FinalizerWatchdogDaemon extends Daemon {
        ...
        private boolean waitForFinalization(Object object) {
            FinalizerDaemon.INSTANCE.finalizingStartedNanos = System.nanoTime();

            sleepFor(FinalizerDaemon.INSTANCE.finalizingStartedNanos, HALF_FINALIZE_NANOS);

            if (object == FinalizerDaemon.INSTANCE.finalizingObject) {
                String message = object.getClass().getName() + ".finalize() 1st timed out after " + (HALF_FINALIZE_NANOS / NANOS_PER_SECOND) + " seconds (" + FinalizerDaemon.INSTANCE.finalizingStartedNanos + " to " + System.nanoTime() + ")";
                ...
                try {
                    ...
                    System.logE("Exception: 1st FinalizerTimedOut", e);
                }
        ...
        private static void finalizerTimedOut(Object object) {
            try {
                ...
                System.logE("Exception: 2nd FinalizerTimedOut", e);
            }

            // The current object has exceeded the finalization deadline; abort!
            String message = object.getClass().getName() + ".finalize() timed out after "
                    + (MAX_FINALIZE_NANOS / NANOS_PER_SECOND) + " seconds (" + FinalizerDaemon.INSTANCE.finalizingStartedNanos + " to " + System.nanoTime() + ")";
            Exception syntheticException = new TimeoutException(message);
