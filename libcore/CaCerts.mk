...
$(patsubst ./%,%, \
  $(shell cd $(LOCAL_PATH) ; \
          find $(1) -type d -name ".svn" -prune -o -type f -print) \
 )
endef
...
ifneq ($(findstring OP09, $(OPTR_SPEC_SEG_DEF)), OP09)
	cacerts := $(filter-out luni/src/main/files/cacerts/dcae32f7.0, $(cacerts))
endif
