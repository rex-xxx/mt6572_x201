...
#ifndef __BT_SIMAP_PORTING_H__
#define __BT_SIMAP_PORTING_H__

#define SIMAP_MBT_LOG
#define SIMAP_MBT_LOG1
#define SIMAP_MBT_LOG2
#define SIMAP_MBT_LOG3
