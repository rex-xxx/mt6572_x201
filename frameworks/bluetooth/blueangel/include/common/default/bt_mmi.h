...
#define BT_SOCK_NAME_EXT_ADP_HDP BT_SOCK_NAME_EXT_ADP
...
#define BTMTK_ASSERT(exp) (((exp) != 0) ? (void)0 : kal_assert_fail(#exp, __FILE__, __LINE__, KAL_FALSE, 0, 0, 0, NULL))
#else
