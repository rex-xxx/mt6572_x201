...
//MTK80721 default mParams has not been used in StagefrightRecorder.cpp, and MTK used for HDRecord
    String8 mParams;
...
#ifndef ANDROID_DEFAULT_CODE
    //MTK80721 2011-01-21
    status_t startPCMRecording();
    //MTK80721 2011-08-08
    status_t startOGGRecording();
#ifdef HAVE_ADPCMENCODE_FEATURE
		status_t startADPCMRecording();
#endif
