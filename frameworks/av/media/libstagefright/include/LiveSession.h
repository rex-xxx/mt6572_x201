...
struct LiveSession : public AHandler {
    ...
    enum {
        kWhatTellmeIfBandwidthInvalid = 'bw--',
    };
#endif
...
private:
    ...
    bool alternateBandwidth(const status_t error, size_t *index);
    ...
    static void complainBandwidth(Vector<BandwidthItem>* bandwidthItems, unsigned long bandwidth);
#endif
