...
#ifndef ANDROID_DEFAULT_CODE
    if (req_time > mSampleTimeEntries[right-1].mCompositionTime) {
	ALOGW("Warning:seek time%d > max TS:%d, numSampleSize:%d", req_time, mSampleTimeEntries[right-1].mCompositionTime, right);
