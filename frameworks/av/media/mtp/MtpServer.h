...
private:
    ...
    //Mutex for add/remove storage event
    Mutex               mMutex_storage;
    bool                mStorageEventKeep;
    uint16_t            mBackupEvent;
    uint32_t            mBackupStorageId;
    bool                mFileTransfer;
    //Added Modification for ALPS00276320
