...
#ifdef MTK_AUDIO
#define MTK_SRC_SAMPLERATE_LOWER_BOUND (24000)
...
void AudioMixer::setParameter(int name, int target, int param, void *value)
{
    ...
    MTK_ALOG_V("AudioMixer::setParameter name %d, target 0x%x,param 0x%x",name,target,param);
    switch (target) {
...
{
    MTK_ALOG_V("AudioMixer::track_t::setResampler sampleRate %d,value %d,devSampleRate = %d,resampler=%p,this %p",sampleRate,value,devSampleRate,resampler,this);
