...
#define PROFILE_ENABLE_NIGHT_MODE_QUALITY

#define MTK_VIDEO_PROFILE
...
enum camcorder_quality {
    ...
    CAMCORDER_QUALITY_MTK_LOW              = 8,
    CAMCORDER_QUALITY_MTK_MEDIUM           = 9,
    CAMCORDER_QUALITY_MTK_HIGH             = 10,
    CAMCORDER_QUALITY_MTK_FINE             = 11,
    CAMCORDER_QUALITY_MTK_NIGHT_LOW        = 12,
    CAMCORDER_QUALITY_MTK_NIGHT_MEDIUM     = 13,
    CAMCORDER_QUALITY_MTK_NIGHT_HIGH       = 14,
    CAMCORDER_QUALITY_MTK_NIGHT_FINE       = 15,
    CAMCORDER_QUALITY_MTK_LIVE_EFFECT      = 16,
    CAMCORDER_QUALITY_MTK_H264_HIGH        = 17,
    CAMCORDER_QUALITY_MTK_MPEG4_1080P      = 18,
    CAMCORDER_QUALITY_LIST_END             = 18,        //this value should be equal to the last one enum definition
#else
...
#if defined(MTK_VIDEO_PROFILE) || !defined(ANDROID_DEFAULT_CODE)
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_LOW              = 1008,
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_MEDIUM           = 1009,
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_HIGH             = 1010,
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_FINE             = 1011,
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_NIGHT_LOW        = 1012,
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_NIGHT_MEDIUM     = 1013,
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_NIGHT_HIGH       = 1014,
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_NIGHT_FINE       = 1015,
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_LIVE_EFFECT      = 1016,
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_H264_HIGH        = 1017,
    CAMCORDER_QUALITY_MTK_TIME_LAPSE_MPEG4_1080P      = 1018,
    CAMCORDER_QUALITY_TIME_LAPSE_LIST_END             = 1018,
#else
...
enum videoeditor_capability {
    VIDEOEDITOR_DEFAULT_MAX_INPUT_FRAME_WIDTH = 1280,
    VIDEOEDITOR_DEFUALT_MAX_INPUT_FRAME_HEIGHT = 720,
