...
#if defined(MTK_AAL_SUPPORT)
static void nativeSetAALMode(JNIEnv* env, jobject obj, jint mode) {
    AALClient::getInstance().setMode(mode);    
}

static void nativeSetLightSensorValue(JNIEnv* env, jobject obj, jint value) {
    AALClient::getInstance().setLightSensorValue(value);
}

static void nativeSetScreenBrightness(JNIEnv* env, jobject obj, jint brightness) {
    AALClient::getInstance().setScreenBrightness(brightness);
}

static void nativeSetScreenState(JNIEnv* env, jobject obj, jint state, jint brightness) {
    AALClient::getInstance().setScreenState(state, brightness);
}

static JNINativeMethod gDisplayPowerControllerMethods[] = {
    { "nativeSetAALMode", "(I)V",
            (void*) nativeSetAALMode },
    { "nativeSetLightSensorValue", "(I)V",
            (void*) nativeSetLightSensorValue },
    { "nativeSetScreenBrightness", "(I)V",
            (void*) nativeSetScreenBrightness }, 
    { "nativeSetScreenState", "(II)V",
            (void*) nativeSetScreenState },           
};

int register_android_server_DisplayPowerController(JNIEnv *env)
{
    return jniRegisterNativeMethods(env, "com/android/server/power/DisplayPowerController",
