...
static jboolean android_location_GpsLocationProvider_gps_test_start(JNIEnv* env, jobject obj, jint test_num , jint prn_num, jint time_delay)
{
    ALOGD("android_location_GpsLocationProvider_gps_test_start\n");
    if(!sGpsInterface)
        return -1;
    return (0 == sGpsInterface->test_start(test_num, prn_num, time_delay));
}

static jboolean android_location_GpsLocationProvider_gps_test_stop(JNIEnv* env, jobject obj)
{
    ALOGD("android_location_GpsLocationProvider_gps_test_stop\n");
    if(!sGpsInterface)
        return -1;
    return (0 == sGpsInterface->test_stop());
}

static jboolean android_location_GpsLocationProvider_gps_test_inprogress (JNIEnv* env, jobject obj)
{
    ALOGD("android_location_GpsLocationProvider_gps_test_stop\n");
    if(!sGpsInterface)
        return -1;
    return (0 == sGpsInterface ->test_inprogress());
}
...
{	  
	  ALOGD("android_location_GpsLocationProvider_epo_file_time\n");
...
{
	  ALOGD("android_location_GpsLocationProvider_epo_file_update\n");
          if(!sGpsInterface)
              return -1;
...
static JNINativeMethod sMethods[] = {
    ...
    {"native_gps_test_start", "(III)Z", (void*)android_location_GpsLocationProvider_gps_test_start},
    {"native_gps_test_stop", "()Z", (void*)android_location_GpsLocationProvider_gps_test_stop},
    {"native_gps_test_inprogress", "()Z", (void*)android_location_GpsLocationProvider_gps_test_inprogress},
