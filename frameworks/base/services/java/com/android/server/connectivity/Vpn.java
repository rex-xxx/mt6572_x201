    ...
    private void showNotification(VpnConfig config, String label, Bitmap icon) {
        ...
        if (nm != null) {
            ...
            Notification notification = new Notification.Builder(mContext)
                    ...
                    .setOngoing(true)
                    .build();
            nm.notifyAsUser(null, R.drawable.vpn_connected, notification, UserHandle.CURRENT);
        }
    }

    private void hideNotification() {
        
        ///M: ALPS00449171 The VPN notification should be hiden when the always on VPN is enabled
        //if (!mEnableNotif) return;
        mStatusIntent = null;
        ...
        if (nm != null) {
            ...
            ///M: ALPS00449171: Add try catch to protect
            try{
