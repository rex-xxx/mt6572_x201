...
final class LogicalDisplay {
    ...
    /// M: for case with hwrotation
    private static final String HW_ROTATION = "ro.sf.hwrotation";
    ...
    public void updateLocked(List<DisplayDevice> devices) {
        ...
        /// M: for case with hwrotation
        String hworientation = SystemProperties.get(HW_ROTATION);
        if (!Objects.equal(mPrimaryDisplayDeviceInfo, deviceInfo)) {
            ...
            if ("270".equals(hworientation)) {
                ...
                mBaseDisplayInfo.rotation = Surface.ROTATION_270;
            } else if ("180".equals(hworientation)) {      
                mBaseDisplayInfo.rotation = Surface.ROTATION_180;
            } else if ("90".equals(hworientation)) {
                mBaseDisplayInfo.appWidth = deviceInfo.height;
                mBaseDisplayInfo.appHeight = deviceInfo.width;
                mBaseDisplayInfo.logicalWidth = deviceInfo.height;
                mBaseDisplayInfo.logicalHeight = deviceInfo.width;
                mBaseDisplayInfo.rotation = Surface.ROTATION_90;
            }
            /// @}
