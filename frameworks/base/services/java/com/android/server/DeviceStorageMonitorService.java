...
public class DeviceStorageMonitorService extends Binder {
    ...
    private static final String IPO_POWER_ON = "android.intent.action.ACTION_BOOT_IPO"; // /M:For
                                                                                        // IPO
                                                                                        // feature
            ...
            if (msg.what == DEVICE_MEMORY_CRITICAL_LOW) {
                if (mDialog == null || mIPOBootup || mConfigChanged) {
                    ...
                    mDialog = new AlertDialog.Builder(mContext)
                            ...
                            .setTitle(
                                    mContext
                                            .getText(com.mediatek.internal.R.string.criticallowmessage))
                            .setItems(mStrings, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    if (which == 0) {
                                        Intent mIntent = new Intent();
                                        mIntent
                                                .setAction("android.intent.action.MANAGE_PACKAGE_STORAGE");
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_LOCALE_CHANGED) || 
                action.equals(Intent.ACTION_SKIN_CHANGED)) {
                mConfigChanged = true;
                if (null != mDialog) {
                    mDialog.cancel();
                }
