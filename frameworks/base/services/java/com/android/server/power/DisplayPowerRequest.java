...
final class DisplayPowerRequest {
    ...
    /// MTK: Auto backlight @{
    // If true, enables eco brightness control.
    public boolean useEcoBrightness;
    ///@}
    ...
    public void copyFrom(DisplayPowerRequest other) {
        ...
        /// MTK: Auto backlight @{        
        useEcoBrightness = other.useEcoBrightness; 
        ///@}       
    ...
    public String toString() {
        return "screenState=" + screenState
                ...
                + ", useEcoBrightness=" + useEcoBrightness
