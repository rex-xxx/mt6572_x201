...
final class Notifier {
    ...
    private static final String TAG_P = "PowerManager_performance_N";
    ...
    private void sendNextBroadcast() {
        ...
        Slog.d(TAG, "sendNextBroadcast, mBroadcastedPowerState=" + mBroadcastedPowerState + ", mActualPowerState=" + mActualPowerState);
        synchronized (mLock) {
    ...
    private void sendWakeUpBroadcast() {
        ...
        if (DEBUG) {    //DEBUG_SPEW
            Slog.d(TAG, "Sending wake up broadcast 1.");
        }
    ...
    private final WindowManagerPolicy.ScreenOnListener mScreenOnListener =
        ...
        public void onScreenOn() {
            if (DEBUG) {
                Slog.d(TAG_P, "mScreenOnListener.");
            }
            synchronized (mLock) {
    ...
    private final BroadcastReceiver mWakeUpBroadcastDone = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (DEBUG_SPEW) {
                Slog.d(TAG, "mWakeUpBroadcastDone.");
            }
    ...
    private void sendGoToSleepBroadcast(int reason) {
        ...
        if (DEBUG) {  //DEBUG_SPEW
            Slog.d(TAG, "Sending go to sleep broadcast 1.");
        }
    ...
    private final BroadcastReceiver mGoToSleepBroadcastDone = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (DEBUG_SPEW) {
                Slog.d(TAG, "mGoToSleepBroadcastDone.");
            }
