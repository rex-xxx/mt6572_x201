...
public final class PowerManagerService extends IPowerManager.Stub
    ...
    private static final String TAG_P = "PowerManager_performance";
    ...
    private boolean mIPOFlag = false;
     ...
     ///M: add for hdmi and tvout feature @{
	...
	///M: add for tvout and hdmi feature@{
        try {
            if (mHDMI==null)
    ...
    public void userActivity(long eventTime, int event, int flags) {
        ...
        if (mContext.checkCallingOrSelfPermission(android.Manifest.permission.DEVICE_POWER)
            ...
            if (DEBUG_SPEW) {
                Slog.d(TAG, "userActivity: permission");
            }
    ...
    private boolean wakeUpNoUpdateLocked(long eventTime) {
        ...
        if (DEBUG_SPEW) {
            Slog.d(TAG_P, "wakeUpNoUpdateLocked: eventTime=" + eventTime);
        }
