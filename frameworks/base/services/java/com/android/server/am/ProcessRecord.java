...
class ProcessRecord {
    ...
    boolean killedLTK;          /// M: LTK victim. Don't remove it from history.
    long pauseAppMemUsage;      /// M: LTK mem usage when the app is paused.
    long pause3DUsage;          /// M: LTK 3D usage when the app is paused.
    long bindAppMemUsage;       /// M: LCA, the process memory usage (bytes) after binding for accurate service restart
    ...
    ProcessRecord(BatteryStatsImpl.Uid.Proc _batteryStats, IApplicationThread _thread,
        ...
        persistent = false;
        removed = false;
        killedLTK = false;  /// M: LTK
        pauseAppMemUsage = 0; /// M: LTK
        pause3DUsage = 0; /// M: LTK
    }
