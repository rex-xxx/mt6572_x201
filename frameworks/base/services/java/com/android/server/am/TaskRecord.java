...
class TaskRecord extends ThumbnailHolder {
    ...
    /**
        * M:
        * Indicates the task should be hide from recent applications lists.
        * Use ActivityManager.RECENT_WITH_EXCLUDED can still get this task.
        */
    boolean ignoreFromRecent;    

    TaskRecord(int _taskId, ActivityInfo info, Intent _intent) {
        taskId = _taskId;
        affinity = info.taskAffinity;
        setIntent(_intent, info);
        ignoreFromRecent = false; /// M: Initial value is false
    }
    ...
    void dump(PrintWriter pw, String prefix) {
        ...
        pw.print(prefix); pw.print("ignoreFromRecent="); pw.println(ignoreFromRecent); /// M: debug purpose
    }
