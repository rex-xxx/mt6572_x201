    ...
    public boolean keyDispatchingTimedOut() {
        ...
        synchronized(service) {
            ...
            if (r != null && r.app != null) {
                ...
                if (service.isDidDexOpt( SystemClock.uptimeMillis() - service.KEY_DISPATCHING_TIMEOUT)) { 
        ...
        if (anrApp != null) {
            /// M:Avoid cause SWT due to NBT dumping. (This modification doesn't need to patch to BSP package.) @{
            //service.appNotResponding(anrApp, r, this, false, "keyDispatchingTimedOut");
            service.mANRManager.notifyKeyANR(anrApp, r, this, "keyDispatchingTimedOut");
            /// @}
        }
