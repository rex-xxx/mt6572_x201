...
class ContentProviderRecord {
    ...
    public boolean canRunHere(ProcessRecord app) {
        boolean bCanRunHere = (info.multiprocess ||info.processName.equals(app.processName))
                && uid == app.info.uid;

        Slog.w("ContentProviderRecord", "canRunHere: bCanRunHere=" + bCanRunHere
                            + "info.multiprocess="+ info.multiprocess
                            + "info.processName=" + info.processName
                            + "app.processName=" + app.processName
                            + "uid=" + uid
                            + "app.info.uid" + app.info.uid
        );
        return bCanRunHere;
    }
