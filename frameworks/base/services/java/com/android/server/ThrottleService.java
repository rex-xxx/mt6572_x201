...
public class ThrottleService extends IThrottleManager.Stub {
    ...
    ///M:Add by MTK03594 ==> Disable the function of ThrottleService
    private static final boolean THROTTLE_DISABLED_FLAG = true;
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            ///M:Add by MTK03594 -- Disable THROTTTLE function to avoid unnecessary procedures
            if(THROTTLE_DISABLED_FLAG){
                return;
            }
