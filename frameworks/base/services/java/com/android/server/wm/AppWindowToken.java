...
class AppWindowToken extends WindowToken {
     ...
     * WMS tells the client what's the visibility. Then, the client should do
     * the relayout with the visibility parameter. Here, reportedAppVisibility
     * presents the call flow
     *
     * Example of REPORTED_APP_VISIBLE
     * WMS calls dispatchAppVisibility(true) to the client. The bit is set.
     * Then, the client calls relayout with VISIBLE. The bit is clear.
     *
     *
     * Example of REPORTED_APP_INVISIBLE
     * WMS calls dispatchAppVisibility(false) to the client. The bit is set.
     * Then, the client calls relayout with VISIBLE. The bit is clear.
     * @{
     */
    static final int REPORTED_APP_NONE = 0x00;
    static final int REPORTED_APP_VISIBLE = 0x01;
    static final int REPORTED_APP_INVISIBLE = 0x02;
    int reportedAppVisibility = REPORTED_APP_NONE;
    /** @} */
    ...
    void sendAppVisibilityToClients() {
        ...
        for (int i=0; i<N; i++) {
            ...
            try {
                ...
                /**
                 * M: ALPS00483827 (Flash Issue)
                 * Set value of reportedAppVisibility by clientHidden
                 * @{
                 */
                reportedAppVisibility |= (clientHidden)?REPORTED_APP_INVISIBLE:REPORTED_APP_VISIBLE;
                /** @}*/
