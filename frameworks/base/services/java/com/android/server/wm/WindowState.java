...
final class WindowState implements WindowManagerPolicy.WindowState {
    ...
    /** M: Stereo3D */
    String mWallpaperCmd;  // for wallpaper, what was last command
    ...
    public boolean getNeedsMenuLw(WindowManagerPolicy.WindowState bottom) {
        int index = -1;
        WindowState ws = this;
        /// M: [ALPS00318857]remove the menu icon when keyguard window get focus @{
        if (this.mAttrs.type == WindowManager.LayoutParams.TYPE_KEYGUARD) {
            return false;
        }
        /// @}
    ...
    public boolean isGoneForLayoutLw() {
        ...
        return mViewVisibility == View.GONE
                ...
                /// M: [ALPS00279337]To solve the side effect caused by 4.0.4 migration, we
                ///    go back to 4.0.3 conditions.
    ...
    void dump(PrintWriter pw, String prefix, boolean dumpAll) {
        ...
        if (mIsImWindow || mIsWallpaper || mIsFloatingLayer) {
            pw.print(prefix); pw.print("mIsImWindow="); pw.print(mIsImWindow);
                    ...
                    pw.print(" mWallpaperCmd="); pw.println(mWallpaperCmd);
        }
        if (dumpAll) {
