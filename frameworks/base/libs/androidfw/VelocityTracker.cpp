...
#endif
			//fix bug
						//ALOGD("xvelocity before =%f",outEstimator->xCoeff[1]);
						//ALOGD("yvelocity before =%f",outEstimator->yCoeff[1]);
						
						if((x[m-1]-x[0])>0)
						{
						  //Xvolocity  < 0 from right to left
						 // ALOGD("1 x[m-1]=%f",x[m-1]);
						  //ALOGD("1 x[0]=%f",x[0]);
						  //ALOGD("1 x[m-1]-x[0]=%f",(x[m-1]-x[0]));
						  if(outEstimator->xCoeff[1] > 0)
						  {
							outEstimator->xCoeff[1] = -outEstimator->xCoeff[1];
						  }
							
						}
						if((x[m-1]-x[0])<0) 
						{
						  //Xvolocity > 0 from left to right
						 // ALOGD("2 x[m-1]=%f",x[m-1]);
						  //ALOGD("2 x[0]=%f",x[0]);
						  //ALOGD("2 x[m-1]-x[0]=%f",(x[m-1]-x[0]));
						...
						if((y[m-1]-y[0])>0)
						{
						  //Yvolocity  < 0 from top to bottom
						  //ALOGD("1 y[m-1]=%f",y[m-1]);
						  //ALOGD("1 y[0]=%f",y[0]);
						  //ALOGD("1 y[m-1]-y[0]=%f",(y[m-1]-y[0]));
						  
						  if(outEstimator->yCoeff[1] > 0)
						  {
							 outEstimator->yCoeff[1] =	-outEstimator->yCoeff[1];
						  }
						}
						if((y[m-1]-y[0])<0)
						{
						  //Xvolocity > 0 form bottom to top
						 // ALOGD("2 y[m-1]=%f",y[m-1]);
						  //ALOGD("2 y[0]=%f",y[0]);
						  //ALOGD("2 y[m-1]-y[0]=%f",(y[m-1]-y[0]));
						...
						//ALOGD("xvelocity=%f",outEstimator->xCoeff[1]);
						//ALOGD("yvelocity=%f",outEstimator->yCoeff[1]);
			//end
