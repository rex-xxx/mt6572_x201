...
enum DebugLevel {
    ...
    kDebugDisplayLists = 4,
    kDebugAll = kDebugDisplayLists | kDebugMoreCaches
};
...
#define DEFAULT_TEXTURE_CACHE_EXPANSION_THRESHOLD 10.0f
#define DEFAULT_TEXTURE_CACHE_EXPANSION_SIZE (2 * DEFAULT_TEXTURE_CACHE_SIZE)
