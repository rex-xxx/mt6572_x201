...
public class CameraWidgetFrame extends KeyguardWidgetFrame implements View.OnClickListener {
    ...
    /// M: remove final mofider, we want to set it null when view detached
    ...
    private void render() {
        ...
        /// M: here, we use getWidth instead of getRootView().getWidth to avoid the bug, launch lockscreen 
        ///from setting which is landscape, the camera can't show completely.
    ...
    protected void onDetachedFromWindow() {
        ...
        /// M: Relase mCallbacks to avoid memory
        mCallbacks = null;
    }
    ...
    public void onActive(boolean isActive) {
        ...
        if (mActive) {
            ...
            /// M: user canceled camera launching, restore the sliding handler alpa @{
            if (mCallbacks != null) {
                mCallbacks.onCameraLaunchedUnsuccessfully();
            }
            /// @}
    ...
    public void onScreenTurnedOff() {
        ...
        /// M: user may turned off the screen to pause the Camera launching, restore the sliding handler alpa @{
        if (mCallbacks != null) {
            mCallbacks.onCameraLaunchedUnsuccessfully();
        }
        /// @ }
