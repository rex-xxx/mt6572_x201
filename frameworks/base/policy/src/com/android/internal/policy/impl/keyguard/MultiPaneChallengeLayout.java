...
public class MultiPaneChallengeLayout extends ViewGroup implements ChallengeLayout {
    ...
    /// M: Video Orb Plugin(destroy IKeyguardLayer)
    @Override
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (mKeyguardLayerForegroundLayout != null) {
                /// M: Make mKeyguardLAyerForegroundLayout bottom align to mChallengeView
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        /// M: Video Orb Plugin(add type for IKeyguardLayers)
    ...
    /// M: Video Orb Plugin(Add for Plugin feature)
	...
	private void updateKeyguardLayerView(boolean show) {
        KeyguardUtils.xlogD(TAG, "updateDataUsageView show=" + show);
