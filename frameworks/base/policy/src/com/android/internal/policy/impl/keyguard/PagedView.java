        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (finishedScrolling) {
                    ...
                    /// M: do not abort animation to avoid animation stoped at rotating steps.
                    //mScroller.abortAnimation();
                } else {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_MOVE:
            if (mTouchState == TOUCH_STATE_SCROLLING) {
                ...
                /// M: Before using Activie pointer id, check if this point still exists @{
    ...
    protected boolean zoomIn(final Runnable onCompleteRunnable) {
        ...
        if (getScaleX() < 1f || getScaleY() < 1f) {
            ...
            mZoomInOutAnim.addListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationStart(Animator animation) {
                    /// M: [ALPS00583468] Disable the hover state to drag view.
