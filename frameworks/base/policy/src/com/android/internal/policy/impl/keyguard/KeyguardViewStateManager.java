...
public class KeyguardViewStateManager implements
    ...
    public void onPageBeginMoving() {
        ...
        if (mHideHintsRunnable != null) {
            ...
            ///M this is android issue, if set mHideHintsRunnable to null, the next time showUsabilityHints will has problem
    ...
    private Runnable mHideHintsRunnable = new Runnable() {
        @Override
        public void run() {
            KeyguardUtils.xlogD(TAG, "mHideHintsRunnable mKeyguardWidgetPager=" + mKeyguardWidgetPager);
