...
public class ExifInterface {
    ...
    private void loadAttributes() throws IOException {
        ...
        synchronized (sLock) {
            if (mFilename != null) {
                ...
                //Xlog.v("getAttributesNative", "attrStr = "+attrStr);
            } else {
                byte[] buf = new byte[1024];
                attrStr = getAttributesFromStreamNative(mInputStream,buf);
                //Xlog.v("getAttributesFromStreamNative", "attrStr = "+attrStr);
            }
        }
    ...
    public boolean getLatLong(float output[]) {
        ...
        if (latValue != null && latRef != null && lngValue != null && lngRef != null) {
            try {
                ...
                Xlog.e(TAG, "getLatLong: IllegalArgumentException!", e);
            }
        }
    ...
    public long getDateTime() {
        ...
        try {
            ...
            Xlog.e(TAG, "getDateTime: IllegalArgumentException!", ex);
            return -1;
        }
    }
    ...
    public long getGpsDateTime() {
        ...
        try {
            ...
            Xlog.e(TAG, "getGpsDateTime: IllegalArgumentException!", ex);
            return -1;
        }
    }
