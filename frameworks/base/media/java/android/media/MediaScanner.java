...
public class MediaScanner
{
    ...
    private void setDefaultRingtoneFileNames() {
        ...
        Xlog.v(TAG, "setDefaultRingtoneFileNames: ringtone=" + mDefaultRingtoneFilename
    ...
    private class MyMediaScannerClient implements MediaScannerClient {
        ...
        public FileEntry beginFile(String path, String mimeType, long lastModified,
            ...
            if (!isDirectory) {
                ...
                if (MediaFile.isImageFileType(mFileType)) {
                    ...
                    if (lastDot > 0 && path.substring(lastDot + 1).toUpperCase().equals("DCF")) {
                        Xlog.v(TAG, "detect a *.DCF file with input mime type:"+mimeType);
            ...
            mDrmMethod = -1;
            /// @}
            mStereoType = Images.Media.STEREO_TYPE_2D;
                ...
                if (entry != null && (entry.mLastModifiedChanged || scanAlways)) {
                    if (noMedia) {
                        ...
                        if (isimage) {
                            ...
                            if (FeatureOption.MTK_DRM_APP && lowpath.endsWith(".dcf")) {
...
//            Log.v(TAG, "scanFile: " + path + " took " + (t2-t1));
        ...
        public void handleStringTag(String name, String value) {
            // Xlog.v(TAG, "handleStringTag: name=" + name + ",value=" + value);
            ...
            ///M: add for mediatek drm and stereo3D
        ...
        public String getGenreName(String genreTagValue) {
            ...
            if (genreTagValue == null) {
                Xlog.e(TAG, "getGenreName: Null genreTag!");
                return null;
            }
                    ...
                    try {
                        ...
                        if (genreIndex >= 0) {
                            if (genreIndex < ID3_GENRES.length) {
                                ...
                                Xlog.e(TAG, "getGenreName: genreIndex = 0xFF!");
                                return null;
                        ...
                        Xlog.e(TAG, "getGenreName: invalidNum=" + number.toString(), e);
                    }
                }
            }
        ...
        private void processImageFile(String path) {
            try {
                ...
                Xlog.e(TAG, "processImageFile: path=" + path, th);
            }
        }

        /// M: Decodes OMA DRM 1.0 FL image's width and height. ALPS00335107 @{
        private IDcfDecoder mDcfDecoder;
        private void processDcfImageFile(String path) {
            try {
                mBitmapOptions.outWidth = 0;
                mBitmapOptions.outHeight = 0;
                if (mDcfDecoder == null) {
                    mDcfDecoder = MediatekClassFactory.createInstance(IDcfDecoder.class);
                }
                mDcfDecoder.decodeFile(path, mBitmapOptions, false);
                mWidth = mBitmapOptions.outWidth;
                mHeight = mBitmapOptions.outHeight;
                Xlog.v(TAG, "processDcfImageFile: path=" + path + ",width=" + mWidth + ",height=" + mHeight);
            } catch (Throwable th) {
                Xlog.e(TAG, "processDcfImageFile: Error! path=" + path, th);
            }
        }
        /// M: @}
        ...
        private Uri endFile(FileEntry entry, boolean ringtones, boolean notifications,
            ...
            if (MediaFile.isAudioFileType(mFileType) && (rowId == 0 || mMtpObjectHandle != 0)) {
                ...
                try {
                    ...
                    // exif is null
                    Xlog.e(TAG, "endFile: Null ExifInterface!", ex);
                }
                if (exif != null) {
                ...
                if (mFileType == MediaFile.FILE_TYPE_MPO) {
                    IMpoDecoder mpoDecoder = MediatekClassFactory.createInstance(
                            IMpoDecoder.class, IMpoDecoder.DECODE_FILE, entry.mPath);
                    if (mpoDecoder != null) {
                        int mpoType = mpoDecoder.suggestMtkMpoType();
                        values.put(Images.Media.MPO_TYPE, mpoType);
                        mpoDecoder.close();
                    if (mpoType == IMpoDecoder.MTK_TYPE_Stereo ||
                        mpoType == IMpoDecoder.MTK_TYPE_3DPan) {
                            //we perceive mpo file as sequencial stereo type
                            values.put(Images.Media.STEREO_TYPE, 
                                  Images.Media.STEREO_TYPE_FRAME_SEQUENCE);
                        }
                    } else {
                        Xlog.e(TAG, "endFile: Null MpoDecoder!");
                    }
                }
                if (mFileType == MediaFile.FILE_TYPE_JPS) {
                    IJpsParser parser = MediatekClassFactory.createInstance(
                            IJpsParser.class, IJpsParser.PARSE, new File(entry.mPath));
                    if (parser != null) {
                        int layout = parser.getLayout();
                        if (IJpsParser.S3D_LAYOUT_SIDE_BY_SIDE == layout) {
                            values.put(Images.Media.STEREO_TYPE, 
                                  Images.Media.STEREO_TYPE_SIDE_BY_SIDE);
                        } else if (IJpsParser.S3D_LAYOUT_TOP_AND_BOTTOM == layout) {
                            values.put(Images.Media.STEREO_TYPE, 
                                    Images.Media.STEREO_TYPE_TOP_BOTTOM);
                        } else {
                            Xlog.e(TAG, "endFile: unexpected jps layout:" + layout);
                            values.put(Images.Media.STEREO_TYPE, Images.Media.STEREO_TYPE_SIDE_BY_SIDE);
                        }
                    } else {
                        Xlog.e(TAG, "endFile:parser==null set jps default layout side by side.");
                        values.put(Images.Media.STEREO_TYPE, Images.Media.STEREO_TYPE_SIDE_BY_SIDE);
                    }
                }
            }
            ...
            if (rowId == 0) {
                ...
                if (notifications &&((mWasEmptyPriorToScan && !mDefaultNotificationSet) ||
                    ...
                    if (TextUtils.isEmpty(mDefaultNotificationFilename) ||
                        ...
                        /// M: Adds log to debug setting ringtones.
                        Xlog.v(TAG, "endFile: needToSetNotification=true.");
                    }
                    ...
                    if (TextUtils.isEmpty(mDefaultAlarmAlertFilename) ||
                        ...
                        needToSetSettings = true;
                        /// M: Adds log to debug setting ringtones.
                        Xlog.v(TAG, "endFile: needToSetAlarm=true.");
                    }
                }
                /// @}
            ...
            if(needToSetSettings) {
                if (notifications && doesSettingEmpty(NOTIFICATION_SET)) {
                    ...
                    Xlog.v(TAG, "endFile: set notification. uri=" + tableUri + ", rowId=" + rowId);
        ...
        private void setSettingFlag(String settingName) {
            ...
            Xlog.d(TAG,"setSettingFlag set:" + settingName);
        ...
        private void setSettingIfNotSet(String settingName, Uri uri, long rowId) {
            ...
            if (TextUtils.isEmpty(existingSettingValue)) {
                ...
                /// M: Adds log to debug setting ringtones.
                Xlog.v(TAG, "setSettingIfNotSet: name=" + settingName + ",value=" + rowId);
            } else {
                /// M: Adds log to debug setting ringtones.
                Xlog.e(TAG, "setSettingIfNotSet: name=" + settingName + " with value=" + existingSettingValue);
            }
        }
    ...
    private void prescan(String filePath, boolean prescanFiles) throws RemoteException {
        ...
        Xlog.v(TAG, "prescan>>>filePath=" + filePath + ",prescanFiles=" + prescanFiles);
        Cursor c = null;
        String where = null;
                    ...
                    while (c.moveToNext()) {
                        ...
                        if (path != null && path.startsWith("/")) {
                            ...
                            try {
                                ...
                                /// M: Adds log for debug.
                                Xlog.e(TAG, "prescan: ErrnoException! path=" + path);
                            }
        ...
        try {
            ...
            c = mMediaProvider.query(mVideoUri, ID_PROJECTION, null, null, null, null);
            if (c != null) {
        ...
        /// M: Adds log to debug setting ringtones.
        Xlog.v(TAG, "prescan<<<imageCount=" + mOriginalCount + ",videoCount="
                + mOriginalVideoCount+ ",isEmpty=" + mWasEmptyPriorToScan);
    }
        ...
        try {
            ...
            for (String fileToDelete : existingFiles) {
                ...
                try {
                    ...
                    /// M: Adds log for debug.
                    Xlog.e(TAG, "pruneDeadThumbnailFiles: path=" + fileToDelete, ex);
                }
            }
            Log.v(TAG, "/pruneDeadThumbnailFiles... " + c);
        } catch (RemoteException e) {
            ...
            /// M: Adds log for debug.
            Xlog.e(TAG, "pruneDeadThumbnailFiles: RemoteException!", e);
        /// M: Make sure cursor to be closed. @{
        } finally {
            if (null != c) {
                c.close();
    ...
    public Uri scanSingleFile(String path, String volumeName, String mimeType) {
        try {
            ...
            if (!file.exists()) {
                Xlog.e(TAG, "scanSingleFile: Not exist path=" + path);
                return null;
            }
    ...
    FileEntry makeEntryFor(String path) {
        ...
        try {
            ...
            /// M: Adds log for debug.
            Xlog.e(TAG, "makeEntryFor: RemoteException! path=" + path, e);
        } finally {
            if (c != null) {
                c.close();
            }
    ...
    private void processPlayLists() throws RemoteException {
        ...
        try {
            ...
            /// M: Adds log for debug.
            Xlog.e(TAG, "processPlayLists: RemoteException!", e1);
        } finally {
            if (fileList != null) {
                fileList.close();
            }
    ...
    private boolean isValueslessMimeType(String mimetype) {
        ...
        if (MIME_APPLICATION_OCTET_STREAM.equalsIgnoreCase(mimetype)) {
            valueless = true;
            Xlog.v(TAG, "isValueslessMimeType: mimetype=" + mimetype);
        }
        return valueless;
    }
    /// M: @}
