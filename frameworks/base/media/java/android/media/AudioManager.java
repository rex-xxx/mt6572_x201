...
public class AudioManager {
	...
	/** M: MTK added for MATV 
	*@hide The audio stream for MATV */
    public static final int STREAM_MATV = AudioSystem.STREAM_MATV;
    ...
    */
    ...
    /**
     * In call audio mode for modem 1. A telephony call is established.
     */
    ...
    /**
     * In call 2 audio mode for modem 2. A telephony call is established.
     */
    ...
    /**
     * Add to enableHdmiAudio.
     * 
     * @param enabled Whether hdmi is enabled.
     * @return If success or not.
     * @hide
     * @internal
     */
     public boolean enableHdmiAudio(boolean enabled){
         Log.e(TAG, "enableHDMIAudio("+enabled+")");
         IAudioService service = getService();
         try {
             return service.enableHdmiAudio(enabled, mICallBack);
         } catch (RemoteException e) {
             Log.e(TAG, "Dead object in enableHDMIAudio("+enabled+") "+e);
             return false;
         }
     }
