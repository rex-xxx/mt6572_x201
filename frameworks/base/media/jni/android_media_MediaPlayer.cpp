...
static void
android_media_MediaPlayer_native_capture(JNIEnv *env, jobject thiz, jstring path){
    ...
    process_media_player_call( env, thiz, mp->capture(String8(str)), NULL, NULL );
...
static JNINativeMethod gMethods[] = {
    ...
    {"native_capture",      "(Ljava/lang/String;)V",            (void *)android_media_MediaPlayer_native_capture},
};
