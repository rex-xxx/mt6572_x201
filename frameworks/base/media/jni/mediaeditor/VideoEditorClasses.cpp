                ...
                M4xVSS_BGMSettings**                ppSettings)
{
    ...
    if (M4OSA_NULL != (*ppSettings))
    {
        ...
        if ((*ppSettings)->pFile != M4OSA_NULL)
...
#ifndef ANDROID_DEFAULT_CODE
        if ((*ppSettings)->pOutputFile != M4OSA_NULL)
...
#ifndef ANDROID_DEFAULT_CODE
        // Demon java will pass RGB888 as RGB565, no dither here ...
        {
            M4OSA_UInt32 rgb888 = (M4OSA_UInt32)pEnv->GetIntField(object, fieldIds.rgb16InputColor);
            pSettings->xVSS.uiRgb16InputColor = (((rgb888 + 0x40000) & 0xf80000) >> 8) 
                | (((rgb888 + 0x200) & 0xfc00) >> 5) | (((rgb888 + 0x4) & 0xf8) >> 3);
        }
#else
