...
public final class Pm {
    ...
    private void runUninstall() {
        ...
        /// M: [Vendor] Vendor Package SHOULD NOT have PackageManager.DELETE_ALL_USERS flag.
        try {
            ApplicationInfo ai = mPm.getApplicationInfo(pkg, 0, UserHandle.myUserId());
            if ((ai != null) && (ai.flags & ApplicationInfo.FLAG_UNINSTALL_APP) != 0) {
