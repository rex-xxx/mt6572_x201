...
public class CommandQueue extends IStatusBar.Stub {
    ...
    private static final int MSG_SHOW_SIM_INDICATOR = 17 << MSG_SHIFT;
    private static final int MSG_HIDE_SIM_INDICATOR = 18 << MSG_SHIFT;
    /// @}
    /// M: [SystemUI]Show application guide for App. @{
    private static final int MSG_SHOW_APPLICATION_GUIDE = 19 << MSG_SHIFT;
    /// @}
    ...
    public void showApplicationGuide(String appName) {
        synchronized (mList) {
            mHandler.obtainMessage(MSG_SHOW_APPLICATION_GUIDE, 0, 0, appName).sendToTarget();
        }
    }
    /// @}
    ...
    private final class H extends Handler {
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                /// @}
                /// M: [SystemUI]Show application guide for App. @{
                case MSG_SHOW_APPLICATION_GUIDE:
                    mCallbacks.showApplicationGuide((String)msg.obj);
                    break;
                /// @}
            }
        }
