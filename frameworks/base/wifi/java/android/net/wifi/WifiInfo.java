...
public class WifiInfo implements Parcelable {
    ...
    public WifiInfo(WifiInfo source) {
        if (source != null) {
            ...
            if (FeatureOption.MTK_DHCPV6C_WIFI) {
                mIpV6Address = source.mIpV6Address;
            }
        }
    }
     ...
     * @hide
     */
    void setInet6Address(InetAddress address) {
        mIpV6Address = address;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        if (FeatureOption.MTK_DHCPV6C_WIFI) {
            if (mIpV6Address != null) {
                dest.writeByte((byte)1);
                dest.writeByteArray(mIpV6Address.getAddress());
            } else {
                dest.writeByte((byte)0);
            }
        }
        ...
        new Creator<WifiInfo>() {
            public WifiInfo createFromParcel(Parcel in) {
                ...
                if (FeatureOption.MTK_DHCPV6C_WIFI) {
                    if (in.readByte() == 1) {
                        try {
                            info.setInet6Address(InetAddress.getByAddress(in.createByteArray()));
                        } catch (UnknownHostException e) {}
                    }
                }
                if (in.readInt() == 1) {
