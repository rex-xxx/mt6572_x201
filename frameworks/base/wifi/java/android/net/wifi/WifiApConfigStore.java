...
class WifiApConfigStore extends StateMachine {
    ...
    private void setDefaultApConfiguration() {
        ...
        if (FeatureOption.MTK_BSP_PACKAGE) {
            IWifiFwkExt wifiExt = MediatekClassFactory.createInstance(IWifiFwkExt.class, mContext);
            config.SSID = wifiExt.getApDefaultSsid();
        } else {
            config.SSID = com.mediatek.custom.CustomProperties.getString(com.mediatek.custom.CustomProperties.MODULE_WLAN, 
