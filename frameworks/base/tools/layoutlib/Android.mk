...
built_secondary_framework_dep := $(call java-lib-deps, secondary-framework)
built_secondary_framework_classes := $(call java-lib-files, secondary-framework)
...
$(LOCAL_BUILT_MODULE): $(built_core_dep) \
	...
	$(hide) java -jar $(built_layoutlib_create_jar) \
	             ...
	             $(built_secondary_framework_classes) 
	$(hide) ls -l $(built_framework_classes)
