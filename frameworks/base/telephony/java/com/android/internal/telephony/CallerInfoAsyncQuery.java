...
public class CallerInfoAsyncQuery {
	...
	/// M: Add sim id for getting correct voice mail on Gemini Architecture. 
	public int simId;
    }
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            if (mCallerInfo == null) {
                ...
                if (cw.event == EVENT_EMERGENCY_NUMBER) {
                    ...
                    /// M: Mark voice mail according to sim id. @{              
		    if (FeatureOption.MTK_GEMINI_SUPPORT)
		    {
			      mCallerInfo = new CallerInfo().markAsVoiceMailGemini(cw.simId);
		    }
		    else
		    {
		    ...
		    /// @}
                    ...
                    if (ENABLE_UNKNOWN_NUMBER_GEO_DESCRIPTION) {
                        ...
                        if (TextUtils.isEmpty(mCallerInfo.name) || 
                            (FeatureOption.MTK_PHONE_NUMBER_GEODESCRIPTION == true)) {
                    ...
                    if (!TextUtils.isEmpty(cw.number)) {
                        ...
                        /// M: Check the object of detector and the return value of detectCountry() before using it. @{
                        String countryIso = "";	
		   	...
		   	{
		   	    Log.e(LOG_TAG, "(detector == null) or (detector.detectCountry() == null)");
		   	}
    ...
    public static CallerInfoAsyncQuery startQuery(int token, Context context, String number,
        ...
        int simId = SystemProperties.getInt(
                ...
                GEMINI_SIM_1);
        return startQueryGemini(token, context, number, listener, cookie, simId);
