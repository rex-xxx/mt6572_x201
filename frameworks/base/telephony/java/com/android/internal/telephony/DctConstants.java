...
public class DctConstants {
    ...
    public static final int EVENT_SCRI_RESULT = BASE + 34;      
    public static final int EVENT_SCRI_RETRY_TIMER = BASE + 35;
    public static final int EVENT_SCRI_CMD_RESULT = BASE + 36;
    public static final int EVENT_NW_RAT_CHANGED = BASE + 37;
    public static final int EVENT_PS_RAT_CHANGED = BASE + 38;
    public static final int EVENT_GET_AVAILABLE_NETWORK_DONE = BASE +39;
    //[New R8 modem FD]
    public static final int EVENT_FD_MODE_SET = BASE + 40;
    public static final int EVENT_VOICE_CALL_ENDED_PEER = BASE +41;
    public static final int EVENT_VOICE_CALL_STARTED_PEER = BASE +42;
