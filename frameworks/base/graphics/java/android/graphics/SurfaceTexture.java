...
public class SurfaceTexture {
     ...
     *
     * @param texName the OpenGL texture object name (e.g. generated via glGenTextures)
     * @param assign looper to handle onFrameAvailable event
     * 
     * @hide
     */
    public SurfaceTexture(int texName, Looper looper) {
        this(texName, looper, false);
    }
     ...
     * @hide
     */
    public SurfaceTexture(int texName, Looper looper, boolean allowSynchronousMode) {
        Looper eventLooper;
        if (looper != null) {
        	mEventHandler = new EventHandler(looper);
        } else if ((eventLooper = Looper.myLooper()) != null) {
            mEventHandler = new EventHandler(eventLooper);
        } else if ((eventLooper = Looper.getMainLooper()) != null) {
            mEventHandler = new EventHandler(eventLooper);
        } else {
            mEventHandler = null;
        }
