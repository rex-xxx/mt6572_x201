...
public class Credentials {
    ...
    /** Key prefix for WAPI AS certificate. */
    public static final String WAPI_AS_CERTIFICATE = "WAPIASCERT_";
    /**
     * Intent extra: name for the WAPI as user's certificate.
     */
    public static final String EXTRA_WAPI_AS_CERTIFICATE_NAME = "wapi_as_user_certificate_name";

    /**
     * Intent extra: data for the WAPI as user's certificate .
     */
    public static final String EXTRA_WAPI_AS_CERTIFICATE_DATA = "wapi_as_user_certificate_data";
