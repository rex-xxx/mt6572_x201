...
public class LockPatternUtils {
    ...
    public final static String VOICE_UNLOCK = "voice_unlock";//fallback for value
    public final static String FACE_UNLOCK = "face_unlock";//fallback for value
    ...
    */
    ...
    public void saveLockPattern(List<LockPatternView.Cell> pattern) {
        this.saveLockPattern(pattern, false, null);
    }

    /**
     * M: Specify fallback parameters to save a lock pattern
     *
     * @hide
     * @internal
     * @param pattern The new pattern to save.
     * @param isFallback Specifies if this is a fallback to biometric weak or voice weak
     * @param isFallbackFor Specifies if this is a fallback for which, biometric weak or voice weak
     */
    public void saveLockPattern(List<LockPatternView.Cell> pattern, boolean isFallback, String isFallbackFor) {
        // Compute the hash
        ...
        try {
            ...
            if (pattern != null) {
                ...
                if (!isFallback) {
                    ...
                    if (isFallbackFor.equals(FACE_UNLOCK)) {   //face unlock
                     ...
                     } else if (isFallbackFor.equals(VOICE_UNLOCK)){  //M : voice unlock
    ...
    public void saveLockPassword(String password, int quality) {
        this.saveLockPassword(password, quality, false, null, getCurrentOrCallingUserId());
    }
     ...
     * pattern.
     *
     * M: Version of {@link #saveLockPassword(String, int)} that allow you
     *      to specify fallback parameters to save.
     *
     * @param password The password to save
     * @param quality {@see DevicePolicyManager#getPasswordQuality(android.content.ComponentName)}
     * @param isFallback Specifies if this is a fallback to biometric weak or voice weak
     ...
     * @internal
     */
    public void saveLockPassword(String password, int quality, boolean isFallback, String isFallbackFor) {
        saveLockPassword(password, quality, isFallback, isFallbackFor, getCurrentOrCallingUserId());
    }
     ...
     * pattern.
     *
     * M: Version of {@link #saveLockPassword(String, int, boolean, String)} that allow you
     *      to specify the user the given password will be saved for.
     *
     * @param password The password to save
     * @param quality {@see DevicePolicyManager#getPasswordQuality(android.content.ComponentName)}
     * @param isFallback Specifies if this is a fallback to biometric weak or voice weak
     ...
     * @internal
     */
    public void saveLockPassword(String password, int quality, boolean isFallback, String isFallbackFor, int userHandle) {
        // Compute the hash
    ...
    public int getKeyguardStoredPasswordQuality() {
        ...
        ///M :add voice unlock
        if (quality == DevicePolicyManager.PASSWORD_QUALITY_BIOMETRIC_WEAK || quality == DevicePolicyManager.PASSWORD_QUALITY_VOICE_WEAK) {
            quality =
    ...
    /**
     * M: add for voice unlock
     * @return true if the lockscreen method is set to voice weak
     */
    ...
    public boolean isLockPasswordEnabled() {
        ...
        return savedPasswordExists() && (passwordEnabled ||
                ((usingBiometricWeak() || usingVoiceWeak()) && backupEnabled));  ///M: add voice unlock
    }
    ...
    /**
     * M:
     * When voice unlock setup is done, 
     * save voice unlock fallback has been set, and show
     * setup done activity.
     */
    private void finishVoiceWeak() {
    ...
    /**
     * M:
     * Set voice unlock fallback has been set or not.
     * @param set True if has been set.
     */
    public void setVoiceUnlockFallbackSet(boolean set) {
        setBoolean(VOICE_WEAK_FALLBACK_SET_KEY, set);
    }

    /**
     * M:
     * Clear voice unlock settings.
     */
    public void clearVoiceUnlock() {
        setVoiceUnlockFallbackSet(false);
        Settings.System.putStringForUser(mContentResolver, Settings.System.VOICE_UNLOCK_SCREEN, null, getCurrentOrCallingUserId());
        Settings.System.putStringForUser(mContentResolver, Settings.System.VOICE_UNLOCK_AND_LAUNCH1, null, getCurrentOrCallingUserId());
        Settings.System.putStringForUser(mContentResolver, Settings.System.VOICE_UNLOCK_AND_LAUNCH2, null, getCurrentOrCallingUserId());
        Settings.System.putStringForUser(mContentResolver, Settings.System.VOICE_UNLOCK_AND_LAUNCH3, null, getCurrentOrCallingUserId());
    }
    ...
    public boolean getVoiceUnlockFallbackSet() {
        return getBoolean(VOICE_WEAK_FALLBACK_SET_KEY, false);
    }
}
