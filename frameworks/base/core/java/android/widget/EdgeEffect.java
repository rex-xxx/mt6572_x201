...
public class EdgeEffect {
    ...
    public EdgeEffect(Context context) {
        ...
        /**
         * M: [ALPS00502075] because we use a smaller pic to replace the original one, 
         * multiply a factor to ensure the effect size @{
         */
        //mGlowHeight = mGlow.getIntrinsicHeight();
        //mGlowWidth = mGlow.getIntrinsicWidth(); 
        
        final int factor = 6;
        mGlowHeight = mGlow.getIntrinsicHeight() * factor;
        mGlowWidth = mGlow.getIntrinsicWidth() * factor;        
        /** @} */        
