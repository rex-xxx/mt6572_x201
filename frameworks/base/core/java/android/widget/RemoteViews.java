...
public class RemoteViews implements Parcelable, Filter {
    ...
    private Context prepareContext(Context context) {
        ...
        if (packageName != null) {
            try {
            	/// M: add for using customer view
                c = AppWidgetContext.newWidgetContextAsUser(context, packageName,
                    mHasUsedCustomerView, mUser);         
    ...
    /// M: add for using customer view
    /// @param usedCustomerView
    /// a config item for 3D widget
    /// @{
    /**
     * @hide 
     */
    public void setHasUsedCustomerView(boolean usedCustomerView) {
        mHasUsedCustomerView = usedCustomerView;
    }
    /// @}
}
