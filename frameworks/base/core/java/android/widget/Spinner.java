...
public class Spinner extends AbsSpinner implements OnClickListener {
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        /// M: [ALPS00783330] avoid to add GlobalLayoutListener many times
        private boolean mGlobalLayoutListenerIsSet = false;
        ...
        public void show() {
            ...
            if (vto != null && !mGlobalLayoutListenerIsSet) { /// M: [ALPS00783330] don't add if mGlobalLayoutListenerIsSet
                final OnGlobalLayoutListener layoutListener = new OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        if (!Spinner.this.isVisibleToUser()) {
                            ...
                            /// M: [ALPS00650490] call popup show() again to recompute window size and position
                            /// when global layout changed, e.g rotation
                            show();
                        }
                    }
                };
                vto.addOnGlobalLayoutListener(layoutListener);
                mGlobalLayoutListenerIsSet = true;
                setOnDismissListener(new OnDismissListener() {
                    @Override public void onDismiss() {
                        final ViewTreeObserver vto = getViewTreeObserver();
                        if (vto != null) {
                            vto.removeOnGlobalLayoutListener(layoutListener);
                            mGlobalLayoutListenerIsSet = false;
                        }
                    }
                });
            }
