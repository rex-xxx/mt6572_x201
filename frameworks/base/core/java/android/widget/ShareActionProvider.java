...
public class ShareActionProvider extends ActionProvider {
     ...
     * M: We modify its return value so that application can decide whether ignore
     * this action
     */
    private class ShareAcitivityChooserModelPolicy implements OnChooseActivityListener {
        ...
        public boolean onChooseActivity(ActivityChooserModel host, Intent intent) {
            ...
            if (intent != null) {
                return intent.getBooleanExtra(SHARE_TARGET_SELECTION_IGNORE_ACTION, false);
            } else {
                return false;
            }
        }
    ...
    /**
     * Boolean extra data key for {@link OnShareTargetSelectedListener} intent, if app wants this intent
     * to be ignored, true means to ignore.
     * @hide
     */
