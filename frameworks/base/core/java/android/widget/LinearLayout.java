    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            if (heightMode == MeasureSpec.EXACTLY && lp.height == 0 && lp.weight > 0) {
                ...
                // M: This child is skipped in this round, so need to reset previously measured height ALPS00442434 @{
                child.resetMeasuredHeightDimension();
                /// @}
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            if (widthMode == MeasureSpec.EXACTLY && lp.width == 0 && lp.weight > 0) {
                ...
                /// M: This child is skipped in this round, so need to reset previously measured width ALPS00442434 @{
                child.resetMeasuredWidthDimension();
                /// @}
