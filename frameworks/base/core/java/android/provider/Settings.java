...
public final class Settings {
    ...
    private static final String TAG = "Provider/Settings";
    ...
    private static class NameValueCache {
        ...
        public String getStringForUser(ContentResolver cr, String name, final int userHandle) {
            ...
            if (mCallGetCommand != null) {
                try {
                    ...
                    if (b != null) {
                        ...
                        Xlog.v(TAG,"from db cache, name = " + name +" , value = " + value);
                    ...
                    Xlog.e(TAG, "NameValueCache RemoteException");
            ...
            try {
                ...
                Xlog.v(TAG,"from db ,name = " + name+" , value = "+ value);
                return value;
            } catch (RemoteException e) {
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            /// M: originally in system but migrated to secure in the past {@ 
            // now move to Global
            ...
            MOVED_TO_SECURE_THEN_GLOBAL.add(Settings.Global.PREFERRED_NETWORK_MODE_2);           
            /// @}
        ...
        /**
         * MATV volume. This is used internally, changing this value will not
         * change the volume. See AudioManager.
         * 
         * @hide
         */
       ...
       /**
        ...
        /**
         * Boot up select mode for GEMINI power on<br/>
         * <b>Values:</b><br/>
         * 0 - Static, boot up according to dual SIM mode setting.<br/>
         * 1 - Dynamic, choosen boot up mode by user.<br/>
         * 
         * @hide
         */
        ...
        /**
         * SIM mode setting default value for single SIM project
         * 
         * @hide
         */
         ...
         * false - not in roaming service or some other apps has popup roaming
         * indication.<br/>
         * 
         * @hide
         */
        ...
        /**
         * voice call reject mode<br/>
         * <b>Values: mode id</b><br/>
         * 
         * @hide
         */
      ...
      //MTK add start
      //[ALPS00565692]add "Auto" item for SMS SIM setting
        /**
      ...
      //MTK add end
        ...
        /**
         * The type of how each AP accessing its priority values: automatically
         * generated by device
         * 
         * @hide
         */
        ...
        /**
         * The type of how each AP accessing its priority values: manually set
         * by user
         * 
         * @hide
         */
         ...
         * recommended you give {@link #DEFAULT_VIDEO_CALL_URI} to the media
         * player. It will resolve to the set default voice call ringtone at the
         * time of playing.
         * 
         * @see #DEFAULT_VIDEO_CALL_URI
         */
        public static final String VIDEO_CALL = "video_call";

        /**
         * A {@link Uri} that will point to the current default video call
         * ringtone at any given time.
         * <p>
         * If the current default ringtone is in the DRM provider and the caller
         * does not have permission, the exception will be a
         * FileNotFoundException.
        ...
        /**
         * Value to specify if the user prefers the date, time and time zone to
         * be automatically fetched from the GPS. 1=yes, 0=no
         * 
         * @hide
         */
        ...
        /**
         * Whether show Quick Start Gide in Home screen's main screen? true =
         * yes false = no
         * 
         * @hide
         */
    ...
    public static final class Secure extends NameValueTable {
        ...
        //add for Orange http proxy begin
        /**
         ...
         * @hide
         */
        public static final int MOBILE_DATA_DEFAULT = (FeatureOption.MTK_DEFAULT_DATA_OFF || FeatureOption.MTK_GEMINI_SUPPORT) ? 0 : 1;        
         ...
         * 
         */
        public static final String LAST_PDP_TX_DATA_STATISTIC = 
                "last_pdp_tx_data_statistic";
        
        /**
         * @hide
         * 
         */
        public static final String LAST_PDP_RX_DATA_STATISTIC = 
                "last_pdp_rx_data_statistic";
        ...
        /**
         * whether EPO service is allowed to automatically download satellite position data(1) or not(0)
         * @hide
         */
        public static final String EPO_AUTO_DOWNLOAD_ON = "epo_auto_download_on";
        
        /**
         * whether EPO service is allowed to download satellite position data(1) or not(0) when roaming
         * @hide
         */
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
        ...
        /// M: {@
        /**
         * Whether or not data roaming is enabled of sim2(dual sim). (0 = false, 1 = true)
         * @hide
         */
        ...
        /// M: {@
        /**
         * Whether or not data roaming is enabled of sim3(dual sim). (0 = false, 1 = true)
         * @hide
         */
        ...
        /// M: {@
        /**
         * Whether or not data roaming is enabled of sim4(dual sim). (0 = false, 1 = true)
         * @hide
         */
         ...
         * @hide
         */
        // from system to global, pay attention
        public static final String PREFERRED_NETWORK_MODE_2 =
                "preferred_network_mode_2";
