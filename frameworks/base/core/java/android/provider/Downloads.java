...
public final class Downloads {
    ...
    public static final class Impl implements BaseColumns {
        ...
        /*
         * Lists the column which is used to support OMA Download.
         */
        /**
         * The column is used to define OMA Download. If this column is set to
         * "1", it means this download action is OMA download (include download
         * .dd file or media object). If this column is 0 or other value, it
         * isn't OMA DL.
         * <P>
         * Type: INTEGER
         * </P>
         ...
         * download, user need to input username.
         * <P>
         * Type: TEXT
         * </P>
         * <P>
