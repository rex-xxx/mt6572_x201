...
public final class ContactsContract {
    ...
    public static final class CommonDataKinds {
        ...
        public static final class Phone implements DataColumnsWithJoins, CommonColumns {
            ...
            /**
             * M: 
             * The additional number's aas index.
             * <P>Type: TEXT</P>
             * M:AAS
             * @hide
             */
            public static final String AAS_INDEX = DATA5;
    ...
    public static final class Intents {
         ...
         * @hide
         */
        public static final String UPDATE_FILTER_CONTACT = 
            "android.widget.mmswidget.UPDATE_FILTER_CONTACT";
         ...
         * @hide
         */
        public static final String EXTRA_BROADCAST_RESULT = 
            "broadcast_result";
         ...
         * @hide
         */
        public static final String EXTRA_FILTER_SIM_CONTACT = 
            "filter_sim_contact";
