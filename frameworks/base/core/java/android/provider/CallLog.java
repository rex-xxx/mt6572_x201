...
public class CallLog {
    ...
    public static class Calls implements BaseColumns {
         ...
         *
         * @return the URL of the newly added call.
         *
         * {@hide}
         * {@internal}
         */
        ...
        /**
         * Adds a VT call to the call log for dual sim, called by other addCall() functions.
         *
         * @param ci the CallerInfo object to get the target contact from.  Can be null
         * if the contact is unknown.
         * @param context the context used to get the ContentResolver
         ...
         * @param duration call duration in seconds
         * @param simId the sim card id
         * @param vtCall indicate if it is video call or not, video call 1, else 0
         *
         * @return the URL of the newly added call.
         *
         * {@hide}
