...
class FindActionModeCallback implements ActionMode.Callback, TextWatcher,
    ...
    /**
     * M: Update match count.
     * When find text is null, mMatches should be View.GONE.
     * 
     * @param matchIndex
     * @param matchCount
     * @param isEmptyFind
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        ...
        mode.getMenuInflater().inflate(com.android.internal.R.menu.webview_find,
                menu);
        /// M: Add title to MenuItem for email. @{
        MenuItem itemPrev = menu.findItem(com.android.internal.R.id.find_prev);
        MenuItem itemNext = menu.findItem(com.android.internal.R.id.find_next);
        itemPrev.setTitle(com.mediatek.internal.R.string.find_previous);
        itemNext.setTitle(com.mediatek.internal.R.string.find_next);
        /// @}
        mActionMode = mode;
