...
public class MimeTypeMap {
     ...
     * M: modify MIME type mapping for WML support
     */
    /* package */ String remapGenericMimeType(String mimeType, String url,
        ...
        if ("text/plain".equals(mimeType) ||
            ...
            /** M: for WML feature support */
            if (!FeatureOption.MTK_WML_SUPPORT) {
                mimeType = "text/plain";
            }
        } else {
            ...
            /** M: for WML feature support */
            if (FeatureOption.MTK_WML_SUPPORT) {
                if (mimeType.equals("application/vnd.wap.xhtml+xml") || mimeType.equals("application/xhtml+xml")) {
                    mimeType = "text/html";
                }
            } else {
