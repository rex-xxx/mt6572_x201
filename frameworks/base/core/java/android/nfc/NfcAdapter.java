...
public final class NfcAdapter {
    ...
    /// M: @ {
    /**         
        *MTK handover use case , Beam Plus P2P case      
        *@hide 
        */
    public static final String MTK_P2P_CASE = "mediatek.nfc.handover.beamplus.P2P";
    /**         
        *MTK handover use case , Beam Plus Wifi Display case      
        *@hide 
        */
    public static final String MTK_WFD_CASE = "mediatek.nfc.handover.beamplus.WFD";
    /**         
        *MTK handover use case , Beam Plus Wifi Legacy case      
        *@hide 
        */
    public static final String MTK_WL_REQ_CASE  = "mediatek.nfc.handover.beamplus.WifiLegacy.Requester";

    /**         
        *MTK handover use case , Beam Plus Wifi Legacy case      
        *@hide 
        */
    public static final String MTK_WL_SEL_CASE  = "mediatek.nfc.handover.beamplus.WifiLegacy.Selector";
    /// }
    ...
    /// M: @ {
    /**
        *	Requester use this function to set mHandoverUseCase and uris on NfcActiviyManager
        *		
	...
	public void setMtkBeamPlusPushUris(Uri[] uris, Activity activity) {
    	Log.i(TAG, "setMtkBeamPlusPushUris");
		if (activity == null) {
			throw new NullPointerException("activity cannot be null");
		}
		if (uris != null) {
		...
		mNfcActivityManager.setMtkNdefPushContentUri(activity, uris, MTK_P2P_CASE);
	}
    ...
    public void setMtkBeamPushUrisCallback(CreateBeamUrisCallback callback, Activity activity) {
        ...
        Log.i(TAG, "setMtkBeamPushUrisCallback activity:"+activity);	
        if (activity == null) {
            throw new NullPointerException("activity cannot be null");
        }
        mNfcActivityManager.setMtkNdefPushContentUriCallback(activity, callback, MTK_P2P_CASE);
    }


    /**
        *	Requester parse the Handover Select Message on Beam Plus Wifi Display scenario
        *	<p>
        * 	It suppose to receive WFD HsM. 
        *	<p>
        * 	2.WFD  HsM    	HS(+AC)  + Wifi CCR (with Aux)
        *	<p>
        *  	 Legacy message should not enter this funciton
        *	<p>
        *		
        * @param  uris  the URIs of beamPlus files
        * @param  activity  the activity which use it
        ...
        * @hide 
        */
	public void setMtkWFDPushUris(Uri[] uris, Activity activity) {
    	Log.i(TAG, "setMtkWFDPushUris");		
		if (activity == null) {
			throw new NullPointerException("activity cannot be null");
		}
		if (uris != null) {
		...
		mNfcActivityManager.setMtkNdefPushContentUri(activity, uris, MTK_WFD_CASE);
	}
    ...
    /**
        ...
        * @hide 
        */
	public void setMtkLegacyPushUris(Uri[] uris, Activity activity,boolean isRequester) {
    	Log.i(TAG, "setMtkLegacyPushUris  isRequester:"+isRequester);		
        ...
        if(isRequester == true)
		    mNfcActivityManager.setMtkNdefPushContentUri(activity, uris, MTK_WL_REQ_CASE);
        else
    		mNfcActivityManager.setMtkNdefPushContentUri(activity, uris, MTK_WL_SEL_CASE);
	}
    /// }
