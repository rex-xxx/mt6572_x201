...
public interface IMountService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMountService {
        ...
        /// M: Add  some APIs for new feature or bug fix @{
        static final int TRANSACTION_shareCDRom = IBinder.FIRST_CALL_TRANSACTION + 34;

        static final int TRANSACTION_unmountVolumeNotSwap = IBinder.FIRST_CALL_TRANSACTION + 35;

        static final int TRANSACTION_mountVolumeNotSwap = IBinder.FIRST_CALL_TRANSACTION + 36;
        /// @}
