...
interface INetworkManagementService
{
    ...
    /** M: add for features @{ */
    boolean getStartRequest();

    void setStartRequest(in boolean start);

    void restartAccessPoint(in WifiConfiguration wifiConfig, String wlanIface, String softapIface);

    /**
     * @hide
     */
    void enableMultiRouter(String internalInterface, String externalInterface);

    /**
     * @hide
     */
    void disableMultiRouter(String internalInterface, String externalInterface);

    /**
     * @hide
     */
    String[] getSoftApPreferredChannel();
    ...
    /**
     *
     * Register an observer to receive IPv6 events
     * @hide
     */
     void registerIpv6Observer(INetworkManagementIpv6EventObserver observer);

    /**
     * Unregister an observer from receiving IPv6 events.
     * @hide
     */
    void unregisterIpv6Observer(INetworkManagementIpv6EventObserver obs);

    /**
    * WiFi Hotspot manager - USB Internet
     * @param address  IP of Usb interface
     * @hide
     */
     void cfgUsbInternetAddress(String address);
    ...
    /**
     * Support UDP packets forwarding from device to tethering terminal
     * @hide
     */
     ...
     * @hide
     */
    int getBandwidthRxKbps();

    /**
     * Hotspot manager
     * @hide
     */
    int getBandwidthTxKbps();
