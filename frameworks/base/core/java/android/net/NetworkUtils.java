...
public class NetworkUtils {
	 ...
	 */
    public native static boolean runDhcpv6(String interfaceName, DhcpInfoInternal ipInfo);
    public native static boolean runDhcpv6Renew(String interfaceName, DhcpInfoInternal ipInfo);
    ...
    /// M: utility function - set the MTU size for network interface
    /**
     * Set the MTU size for network interface
     * @param interfaceName the name of the interface
     * @param mtu the MTU size of the interface
     * @return {@code true} for success, {@code false} for failure
     * @hide
     * @internal
     */
    public native static boolean setMtuByInterface(String interfaceName, int mtu);
