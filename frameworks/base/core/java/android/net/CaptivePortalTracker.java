...
public class CaptivePortalTracker extends StateMachine {
    ...
    ///M: DisableCaptiviePortal for mobile data connection
    private boolean mIsCaptiveOverMobile = false;
    ...
    private CaptivePortalTracker(Context context, IConnectivityManager cs) {
        ...
        ///M: DisableCaptiviePortal for mobile data connection
        mIsCaptiveOverMobile = context.getResources().getBoolean(com.mediatek.internal.R.bool.is_captive_over_mobile);
    ...
    private boolean isActiveNetwork(NetworkInfo info) {
        try {
            ...
            if (active != null && active.getType() == info.getType()) {
                ...
                ///M: DisableCaptiviePortal for mobile data connection
                if(!mIsCaptiveOverMobile && info.getType() == ConnectivityManager.TYPE_MOBILE){
                    return false;
                }
                return true;
            }
