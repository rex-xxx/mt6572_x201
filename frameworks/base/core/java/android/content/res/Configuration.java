...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    /**
     * M: Theme feature, Default skin.
     * @hide
     */
    public static final String SKIN_UNDEFINED = "/system/framework/framework-res.apk";
     ...
     * @internal
     */
    public String skin; // current UI style
    ...
    /**
     * M: Theme feature, Get current skin of system.
     * @hide 
     */
    public static String getSkin() {
        String str = SystemProperties.get("persist.sys.skin", SKIN_UNDEFINED);
        return str;
    }
    ...
    public int updateFrom(Configuration delta) {
        ...
        /// M: Theme feature @{
        if (delta.skin != null && (skin == null || !skin.equals(delta.skin))) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(skin); /// M: Theme feature
    }
    ...
    public void readFromParcel(Parcel source) {
        ...
        skin = source.readString(); /// M: Theme feature
    }
    ...
    public int compareTo(Configuration that) {
        ...
        if (n != 0) return n;
        if (this.skin == null) {
            if (that.skin != null) return 1;
        } else if (that.skin == null) {
            return -1;
        } else {
            n = this.skin.compareTo(that.skin);
        }
        /// @}
        //if (n != 0) return n;
        return n;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (skin != null ? skin.hashCode() : 0);    // M: Theme feature
        return result;
    }
