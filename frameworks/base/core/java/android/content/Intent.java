...
public class Intent implements Parcelable, Cloneable {
    ...
    /*  @} */
    /**
     *  M: add ROTATE_MAIN intent
     *  Activity Action: Able to start as a main entry point after handset is rotated in launcher.
     *  For portrait handsets, this means it will trigger when handset is rotated to landscape mode.
     *  For landscape handsets, it will trigger when handset is rotated to portrait.
     ...
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_ROTATED_MAIN = "android.intent.action.ROTATED_MAIN";
    /**
    ...
    /**
     * M: Theme feature
     * Broadcast Action: The current device's skin has changed.
     *
     * <p class="note">This is a protected intent that can only be sent
     * by the system.
     * @hide
   ...
   /**
    ...
    //M: start
    /**
     * <p>Broadcast Action: The user has switched the dual SIM mode of phone. One or
     * more radios have been turned off or on. The intent will have the following extra value:</p>
     * <ul>
     *   <li><em>state</em> - A boolean value indicating whether Airplane Mode is on. If true,
     *   then cell radio and possibly other radios such as bluetooth or WiFi may have also been
    ...
    /**
     * A int associated with a {@link #ACTION_DUAL_SIM_MODE_CHANGED} activity
    ...
    /**
     * <p>Broadcast Action: The user has switched the default SIM option for voice call. The 
    ...
    /**
     * <p>Broadcast Action: The user has modified the roaming reminder mode. The 
     * intent will have the following extra value:</p>
     * <ul>
     *   <li><em>mode</em> - An int value indicating the new mode</li>
     * </ul>
     * 
     * <p class="note">This is a protected intent that can only be sent
     * by the system.
