...
public class StatusBarManager {
    ...
    /**
      * M: showApplicationGuide: shows application guide which will guide end-user to do some operation
      *
      * @param appName the package name which shows the application guide
      * @hide
      * @internal
      */
