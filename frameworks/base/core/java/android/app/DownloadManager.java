...
public class DownloadManager {
    ...
    public static class Request {
        ...
        /**
         *  Set user agent of http request. Default is null and DownloadProvider 
         *  will set it to "AndroidDownloadManager" in program. If it not null, 
         *  it will be set to http request header in DownloadProvider
