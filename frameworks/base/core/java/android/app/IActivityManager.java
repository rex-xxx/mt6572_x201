...
public interface IActivityManager extends IInterface {
    ...
    public void applicationBinded(int pid) throws RemoteException;     /// M: LCA, notify AMS application binded
    ...
    /// M: dump message history and future messages for app transition timeout or app freeze timeout cases
    int NOTIFY_WINDOW_TIMEOUT = IBinder.FIRST_CALL_TRANSACTION + 161;

    /// M: ALPS00431397. When running window animation, halt the activity
    /// launchigng. Otherwise, restore the activity state @{
    int HALT_ACTIVITY_RESUMING = IBinder.FIRST_CALL_TRANSACTION + 162;
    int RESTORE_ACTIVITY_RESUMING = IBinder.FIRST_CALL_TRANSACTION + 163;
    /// @}

    /// M: ALPS00404470. LCA check-in
    int GET_PROCESS_PSWAP_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+164;
    /// @}

    int APPLICATION_BINDED = IBinder.FIRST_CALL_TRANSACTION + 165;    /// M: LCA, notify AMS application binded
