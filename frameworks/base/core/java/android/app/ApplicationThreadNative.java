...
public abstract class ApplicationThreadNative extends Binder
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
        ...
        case DUMP_MESSAGE_HISTORY_TRANSACTION:
        {
            ...
            String tmpString = dumpMessageHistory();
            reply.writeString(tmpString);
...
class ApplicationThreadProxy implements IApplicationThread {
    ...
    /// M: ALPS00497111 [Volunteer free] LCA Memory Optimized @{
    public final void setTrimMemoryFlagEx() throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        mRemote.transact(SET_TRIM_MEMORY_FLAG_EX, data, null,
                IBinder.FLAG_ONEWAY);
        data.recycle();
    }
    
     public final void ResetSL() throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        mRemote.transact(RESET_SL_TRANSACTION, data, null,
                IBinder.FLAG_ONEWAY);
        data.recycle();
    }
    /// @}
    ...
    /// M: ALPS00270724 message history mechanism
    /// M: Add message history/queue to _exp_main.txt
    public String dumpMessageHistory() throws RemoteException 
    {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        String messageHistory = "";
        data.writeInterfaceToken(IApplicationThread.descriptor);
        mRemote.transact(DUMP_MESSAGE_HISTORY_TRANSACTION, data, reply, 0);
        messageHistory = reply.readString();
        data.recycle();        
        reply.recycle();
