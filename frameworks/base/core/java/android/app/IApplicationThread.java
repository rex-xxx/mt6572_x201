...
public interface IApplicationThread extends IInterface {
    ...
    void setTrimMemoryFlagEx() throws RemoteException;
    void ResetSL() throws RemoteException;
    /// @}
    ...
    String dumpMessageHistory() throws RemoteException;   /// M: ALPS00270724 message history mechanism 
    ...
    int DUMP_MESSAGE_HISTORY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 47;     /// M: ALPS00270724 message history mechanism 
    int ENABLE_LOOPER_LOG = IBinder.FIRST_CALL_TRANSACTION + 48;                    /// M: ActivityThread looper log enhancement
    int SET_TRIM_MEMORY_FLAG_EX = IBinder.FIRST_CALL_TRANSACTION+49;      /// M: ALPS00497111 [Volunteer free] LCA Memory Optimized
    int RESET_SL_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+50;                   /// M: ALPS00497111 [Volunteer free] LCA Memory Optimized
}
