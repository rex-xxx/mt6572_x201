...
public class VolumePanel extends Handler implements OnSeekBarChangeListener, View.OnClickListener
{
    ...
    private enum StreamResources {
        ...
        FMStream(AudioManager.STREAM_FM,
                com.mediatek.R.string.volume_fm,
                R.drawable.ic_volume_small,
                R.drawable.ic_volume_off_small,
                false),
        MATVStream(AudioManager.STREAM_MATV,
                com.mediatek.R.string.volume_matv,
                R.drawable.ic_volume_small,
                R.drawable.ic_volume_off_small,
                false),
        ...
        mContext.registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (AudioManager.RINGER_MODE_CHANGED_ACTION.equals(action)) {
                  ...
                  /// M: When screen off, we need to dismiss dialog
...
//                setRingerIcon();
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        if (tag instanceof StreamControl) {
            ...
            /// M: For in-call voice call volume, there is no inaudible volume.
            if((sc.streamType == AudioManager.STREAM_VOICE_CALL || 
                    sc.streamType == AudioManager.STREAM_BLUETOOTH_SCO) && 
