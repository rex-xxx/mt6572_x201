...
public class SurfaceView extends View {
    ...
    /**
     * Set Stereo3D layout flag, it tells WindowManger enabling 3D and its layout type.
     *
     * @param flag values are {@link WindowManager#LAYOUT3D_DISABLED}, 
     *        {@link WindowManager#LAYOUT3D_SIDE_BY_SIDE}, 
     *        {@link WindowManager#LAYOUT3D_TOP_AND_BOTTOM}, 
     *        {@link WindowManager#LAYOUT3D_LS_SWAPPED}. If not set, the default value 
     *        will be LAYOUT3D_DISABLED
     *
     * @hide
     * @internal
     */
    public void set3DLayout(int flag) {
    ...
    private void updateWindow(boolean force, boolean redrawNeeded) {
        ...
        if (force || creating || formatChanged || sizeChanged || visibleChanged
            ...
            try {
                ...
                /** M: set 3D layout @{ */
                if (FeatureOption.MTK_S3D_SUPPORT) {
                    mLayout.layout3D = m3DLayoutFlag;
                }
                /** @} */
