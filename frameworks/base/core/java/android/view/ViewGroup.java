...
public abstract class ViewGroup extends View implements ViewParent, ViewManager {
    ...
    private TouchTarget addTouchTarget(View child, int pointerIdBits) {
        ...
        if (DBG_MOTION) {
            Xlog.d(TAG, "addTouchTarget:child = " + child + ",pointerIdBits = " + pointerIdBits
    ...
    protected boolean isTransformedTouchPointInView(float x, float y, View child,
        ...
        if (DBG_MOTION) {
            Xlog.d(TAG, "(ViewGroup)isTransformedTouchPointInView x = " + x + ",y = " + y
                    + ",localX = " + localX + ",localY = " + localY + ",mScrollX = " + mScrollX
                    + ",mScrollY = " + mScrollY + ",child.mLeft = " + child.mLeft
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if ((flags & FLAG_USE_CHILD_DRAWING_ORDER) == 0) {
            for (int i = 0; i < count; i++) {
                final View child = children[i];
                /// M: when child is null, dump the view hierarchy for more information.
                if (child == null) {
                    Xlog.d(TAG, "dispatchDraw: i = " + i + ",count = " + count + ", this = " + this);
                    this.debug();
                }
