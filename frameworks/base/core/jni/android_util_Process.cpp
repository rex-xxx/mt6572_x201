...
static jlong android_os_Process_getLruAnonMemory(JNIEnv* env, jobject clazz)
{
    ...
    static const int sumsLen[] = { strlen("Active(anon):"), strlen("Inactive(anon):"), 0 };
    return getFreeMemoryImpl(sums, sumsLen, 2);
}
...
/// M: LTK @{
static jlong android_os_Process_getRswapRssPid(JNIEnv *env, jobject clazz, jint pid)
{
    char line[1024];
    jlong rswap_rss = 0;
    unsigned temp;
...
static const JNINativeMethod methods[] = {
    ...
    { "getRswapRssSum", "(I)J", (void*)android_os_Process_getRswapRssPid },  /// M: LTK
};
