...
public:
    ...
    static float getCharsFontMetrics(SkPaint::FontMetrics *metricsObj, const SkPaint* paint,
            const uint16_t* chars, int start, int end) {
...
static JNINativeMethod methods[] = {
    ...
    {"getStringFontMetrics", "(Landroid/graphics/Paint$FontMetrics;Ljava/lang/String;)F", (void*)SkPaintGlue::getStringFontMetrics},
    {"getFontMetricsInt", "(Landroid/graphics/Paint$FontMetricsInt;)I", (void*)SkPaintGlue::getFontMetricsInt},
    {"getStringFontMetricsInt", "(Landroid/graphics/Paint$FontMetricsInt;Ljava/lang/String;)I", (void*)SkPaintGlue::getStringFontMetricsInt},
