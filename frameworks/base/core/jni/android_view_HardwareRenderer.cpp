...
static void android_view_HardwareRenderer_setHWUIDebugLog(JNIEnv* env, jobject clazz,
        jboolean enable) {
#ifdef USE_OPENGL_RENDERER
    uirenderer::OpenGLRenderer::setHWUIDebugLog(enable);
#endif
}
...
#ifndef MTK_BSP_PACKAGE
    { "nSetHWUIDebugLog",       "(Z)V",  (void*) android_view_HardwareRenderer_setHWUIDebugLog },
#endif
};
