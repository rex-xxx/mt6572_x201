 ...
 * 
 * @see "ETSI TS 101 220 subsection 7.1.1" {@hide}
 */
class ComprehensionTlv {
    ...
    /**
     * Constructor. Private on purpose. Use {@link #decodeMany(byte[], int)
     * decodeMany} or {@link #decode(byte[], int) decode} method.
     * 
    ...
    public static ComprehensionTlv decode(byte[] data, int startIndex)
        ...
        try {
            ...
            switch (temp) {
                ...
                case 0xff:
                case 0x80:
                    Log.d("CAT     ", "decode: unexpected first tag byte="
