...
abstract class SipPhoneBase extends PhoneBase {
    ...
    public void voiceAccept() throws CallStateException {
        Log.e(LOG_TAG, "voiceAccept: not possible in Sip");
    }

    public void getVtCallForwardingOption(int commandInterfaceCFReason, Message onComplete) {
        Log.e(LOG_TAG, "getVtCallForwardingOption: not possible in Sip");
    }
