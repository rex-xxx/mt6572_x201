    ...
    private class DcDefaultState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                // M: for checking current state is ACTIVE or not
                case DataConnectionAc.REQ_IS_ACTIVE: {
                    boolean val = getCurrentState() == mActiveState;
                    if (VDBG) log("REQ_IS_ACTIVE isActive=" + val);
                    mAc.replyToMessage(msg, DataConnectionAc.RSP_IS_ACTIVE, val? 1: 0);
                    break;
                }
