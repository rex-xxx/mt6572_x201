...
public class UiccCardApplication {
    ...
    private static final int EVENT_RADIO_OFF_OR_UNAVAILABLE = 103;
    ...
    private void onChangeFdnDone(AsyncResult ar) {
        synchronized (mLock) {
            if (ar.exception == null) {
                ...
                getIccRecords().setPhbReady(false);
        ...
        public void handleMessage(Message msg){
            ...
            switch (msg.what) {
                ...
                case EVENT_QUERY_NETWORK_LOCK_DONE:
                    ...
                    if (ar.exception != null) {
                        Log.e(LOG_TAG, "Error query network lock with exception "
                            + ar.exception );
                    } else {
                ...
                case EVENT_CHANGE_NETWORK_LOCK_DONE:
                    ...
                    ar = (AsyncResult)msg.obj;
                    if (ar.exception != null) {
                        Log.e(LOG_TAG, "Error change network lock with exception "
                            + ar.exception );
                    }
                ...
                case EVENT_RADIO_OFF_OR_UNAVAILABLE:
                    if (DBG) log("handleMessage (EVENT_RADIO_OFF_OR_UNAVAILABLE)");
    ...
    public String getIccCardType() {
         if (mIccType == null || mIccType.equals("")) {
            mIccType = SystemProperties.get(UICCCARDAPPLICATION_PROPERTY_RIL_UICC_TYPE[getMySimId()]);
         }
    ...
    public void QueryIccNetworkLock (int category,
        ...
        switch(category){
            ...
            case CommandsInterface.CAT_SIM:
                ...
                break;
            default:
                Log.e(LOG_TAG, "QueryIccNetworkLock unknown category = " + category);
                break;
        }
    }
    ...
    public void setIccNetworkLockEnabled (int category,
        ...
        switch(lockop) {
            ...
            case CommandsInterface.OP_UNLOCK:
                ...
                break;
            default:
                Log.e(LOG_TAG, "SetIccNetworkEnabled unknown operation" + lockop);
                break;    
        }
    }
}
