...
public abstract class Connection {
    ...
    public enum DisconnectCause {
        ...
        /// M: [mtk04070][111125][ALPS00093395]Add more call failed causes. @{
        ...
        NO_CIRCUIT_AVAIL,               /* no circuit/channel available */
        SWITCHING_CONGESTION,           /* switching equipment congestion */
        RESOURCE_UNAVAILABLE,           /* resource unavailable, unspecified */
        BEARER_NOT_AUTHORIZED,          /* bearer capability not authorized */
        BEARER_NOT_AVAIL,               /* bearer capability not presently available */
        SERVICE_NOT_AVAILABLE,          /* service or option not available, unspecified */
        BEARER_NOT_IMPLEMENT,           /* bearer service not implemented */
        FACILITY_NOT_IMPLEMENT,         /* Requested facility not implemented */
        RESTRICTED_BEARER_AVAILABLE,    /* only restricted digital information bearer capability is available */
        OPTION_NOT_AVAILABLE,           /* service or option not implemented, unspecified */
        INCOMPATIBLE_DESTINATION,       /* incompatible destination */
        CM_MM_RR_CONNECTION_RELEASE,    /* RR connection release */
        /// @}
    ...
    /// M: [mtk04070][111121][ALPS00093395]Add VT check method. @{
    /**
