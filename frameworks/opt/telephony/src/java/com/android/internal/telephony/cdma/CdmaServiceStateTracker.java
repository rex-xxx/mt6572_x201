...
public class CdmaServiceStateTracker extends ServiceStateTracker {
    ...
    public void refreshSpnDisplay() {
        ...
        if (numeric != null) {
            newAlphaLong = ((RIL)cm).lookupOperatorName(numeric, true);
            newAlphaShort = ((RIL)cm).lookupOperatorName(numeric, false);
    ...
    // for MR1 migration
    // via support to modify this API 
    protected void updateSpnDisplay(boolean forceUpdate) {
        ...
        //String plmn = null;//ss.getOperatorAlphaLong();
        ...
        //if (!TextUtils.equals(plmn, mCurPlmn) || forceUpdate) {
            ...
            // [modified by via]
	    //if(isSimInserted(phone.getMySimId())) {
		//Log.d(LOG_TAG, "updateSpnDisplay phone isSimInsert = true");
		//showPlmn = true;
	    //}
