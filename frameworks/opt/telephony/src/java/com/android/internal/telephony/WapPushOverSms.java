...
public class WapPushOverSms {
    ...
    public int dispatchWapPdu(byte[] pdu) {
        ...
        if (pduDecoder.seekXWapApplicationId(index, index + headerLength - 1)) {
            ...
            try {
                ...
                if (wapPushMan == null) {
                    ...
                    if(bundle != null) {
                        Log.d(LOG_TAG, "put addr info into intent 1");
        ...
        if (mimeType.equals(WspTypeDecoder.CONTENT_TYPE_B_MMS)) {
            Log.d(LOG_TAG, "[WapPush set permission for MMS");
        ...
        if(bundle != null) {
            Log.d(LOG_TAG, "put addr info into intent 2");
            intent.putExtra(Telephony.WapPush.ADDR, bundle.getString(Telephony.WapPush.ADDR));
            intent.putExtra(Telephony.WapPush.SERVICE_ADDR, bundle.getString(Telephony.WapPush.SERVICE_ADDR));
        }
    ...
    public int dispatchWapPdu(byte[] pdu, Bundle extra){
        if (Config.LOGD) Log.i(LOG_TAG, "dispathchWapPdu!" 
