...
/**
 * Enumeration for representing the tone values for use with PLAY TONE proactive
 * commands. {@hide}
 */
public enum Tone implements Parcelable {
    ...
    /**
     * Critical alert. This tone is to be used in critical situations. The
     * terminal shall make every effort to alert the user when this tone is
     * indicated independent from the volume setting in the terminal.
     */
    CRITICAL_ALERT(0x15),
