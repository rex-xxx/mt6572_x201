...
//MTK-START [mtk80601][111212][ALPS00093395]IPO feature
    public void setRadioPowerOn(Message result) {
        Log.i("SIM", "[SimCmd] setRadioPowerOn");
        if (isSimLocked()) {
...
//MTK-END [mtk80601][111212][ALPS00093395]IPO feature
    ...
    public void progressConnectingCallState(int index, int msgType, boolean isMT, String number,
            int TOA) {
        Log.i("SimulatedCommands", "progressConnectingCallState!!!");
    ...
    getDeviceIdentity(Message response) {
        Log.w(LOG_TAG, "getDeviceIdentity CDMA not implemented in SimulatedCommands");
        unimplemented(response);
    }

    public void
    getCDMASubscription(Message response) {
        Log.w(LOG_TAG, "getCDMASubscription CDMA not implemented in SimulatedCommands");
        unimplemented(response);
    }
    ...
    public void queryCdmaRoamingPreference(Message response) {
        Log.w(LOG_TAG, "queryCdmaRoamingPreference CDMA not implemented in SimulatedCommands");
        unimplemented(response);
    }

    public void setCdmaRoamingPreference(int cdmaRoamingType, Message response) {
        Log.w(LOG_TAG, "setCdmaRoamingPreference CDMA not implemented in SimulatedCommands");
        unimplemented(response);
    }
    ...
    public void setPreferredVoicePrivacy(boolean enable, Message result) {
        Log.w(LOG_TAG, "setPreferredVoicePrivacy CDMA not implemented in SimulatedCommands");
        unimplemented(result);
    }
    ...
    public void setTTYMode(int ttyMode, Message response) {
        Log.w(LOG_TAG, "setTTYMode Not implemented in SimulatedCommands");
        unimplemented(response);
    }
    ...
    public void queryTTYMode(Message response) {
        Log.w(LOG_TAG, "setTTYMode CDMA not implemented in SimulatedCommands");
        unimplemented(response);
    }
    ...
    public void sendCDMAFeatureCode(String FeatureCode, Message response) {
        Log.w(LOG_TAG, "sendCDMAFeatureCode CDMA not implemented in SimulatedCommands");
        unimplemented(response);
    }
    ...
    public void sendCdmaSms(byte[] pdu, Message response){
        Log.w(LOG_TAG, "sendCdmaSms CDMA not implemented in SimulatedCommands");
    }
