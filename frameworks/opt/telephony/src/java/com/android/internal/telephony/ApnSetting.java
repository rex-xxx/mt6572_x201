    ...
    public boolean canHandleType(String type) {
        ...
        for (String t : types) {
            ...
            if (FeatureOption.MTK_DEDICATEDAPN_SUPPORT) {
                if (t.equals(PhoneConstants.APN_TYPE_TETHERING) && type.equals(PhoneConstants.APN_TYPE_DUN)) {
                    if (types.length == 1) {
                    ...
                    (t.equals(PhoneConstants.APN_TYPE_ALL) && !type.equals(PhoneConstants.APN_TYPE_DUN)))
                {
                    return true;
                } else if (t.equals(PhoneConstants.APN_TYPE_DEFAULT) && type.equals(PhoneConstants.APN_TYPE_HIPRI)) {
                    Log.d(LOG_TAG, "canHandleType(): use DEFAULT for HIPRI type");
                    return true;
                }
            } else {
                if (t.equals(type) || t.equals(PhoneConstants.APN_TYPE_ALL)) {
                    return true;
                } else if (t.equals(PhoneConstants.APN_TYPE_DEFAULT) && type.equals(PhoneConstants.APN_TYPE_HIPRI)) {
                    Log.d(LOG_TAG, "canHandleType(): use DEFAULT for HIPRI type");
                    return true;
