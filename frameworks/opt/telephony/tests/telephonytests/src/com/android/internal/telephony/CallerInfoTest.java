...
public class CallerInfoTest extends AndroidTestCase {
    ...
    public void testEmergencyIsProperlySetUsingAsyncQuery() throws Exception {
        ...
        ///M: It caused exception in getGeoDescription() of CallerInfo.java(Locale locale = context.getResources().getConfiguration().locale;), @{
        //In MR1 migration, this case will cause unexpected exception: UnsupportedOperationException 
