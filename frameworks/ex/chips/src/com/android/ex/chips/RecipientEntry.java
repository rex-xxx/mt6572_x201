...
public class RecipientEntry {
    ...
    /// M: Destination kind for this contact entry. Used for indicating the contact entry is queried from email or phone.
    private int mDestinationKind;
    /// M: The contact entry is queried from email.
    public static final int ENTRY_KIND_EMAIL = 1;
    /// M: The contact entry is queried from phone.
    public static final int ENTRY_KIND_PHONE = 2;
    ...
    private RecipientEntry(int entryType) {
        ...
        mPhotoBytes = null;
        mIsDivider = true;
        mDestinationKind = -1; /// M: Initial Destination kind for this contact entry
    }
    ...
    /**
     * M: Set bitmap.
     * @param bmp The bitmap of recipient entry
     * @hide
     */
