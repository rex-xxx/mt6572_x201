...
ifeq ($(WITH_FOTA),true)
LOCAL_CFLAGS += -DSUPPORT_FOTA -DFOTA_SELF_UPGRADE -DFOTA_UI_MESSAGE
...
#LOCAL_CFLAGS += -fno-short-enums
#LOCAL_CFLAGS += -DSUPPORT_FOTA -DNO_UI_MESSAGE
#LOCAL_MODULE := fota1
#LOCAL_MODULE_TAGS := optional
#LOCAL_STATIC_LIBRARIES :=  libext4_utils_static libmincrypt libcutils libstdc++ libc libmtdutils upi_v7
