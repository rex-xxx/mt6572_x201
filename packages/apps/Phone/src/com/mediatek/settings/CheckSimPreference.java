...
public class CheckSimPreference extends CheckBoxPreference {
    ...
    public CheckSimPreference(Context context) {
        this(context, null);
    }

    public CheckSimPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onBindView(View view) {
        ...
        TextView simNumber = (TextView)view.findViewById(R.id.showNumber);
        if (simNumber != null) {
        ...
        TextView simIconNumber = (TextView)view.findViewById(R.id.simNum);
