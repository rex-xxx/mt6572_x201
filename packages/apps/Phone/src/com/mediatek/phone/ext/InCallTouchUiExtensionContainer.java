...
public class InCallTouchUiExtensionContainer extends InCallTouchUiExtension {
    ...
    private LinkedList<InCallTouchUiExtension> mSubExtensionList;

    /**
     * 
     * @param extension 
     */
    public void add(InCallTouchUiExtension extension) {
        if (null == mSubExtensionList) {
            log("create sub extension list");
            mSubExtensionList = new LinkedList<InCallTouchUiExtension>();
        }
     ...
     * @param extension 
     */
    public void remove(InCallTouchUiExtension extension) {
        if (null == mSubExtensionList) {
    ...
    public void onFinishInflate(View inCallTouchUi) {
        ...
        log("onFinishInflate(), inCallTouchUi is " + inCallTouchUi);
        Iterator<InCallTouchUiExtension> iterator = mSubExtensionList.iterator();
        while (iterator.hasNext()) {
            iterator.next().onFinishInflate(inCallTouchUi);
        }
    }
