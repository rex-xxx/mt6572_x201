...
public final class VTInCallScreenFlagsLoopback {
    ...
    private static VTInCallScreenFlagsLoopback sVTInCallScreenFlags
            = new VTInCallScreenFlagsLoopback();

    /**
     * Get the VTInCallScreenFlags instance
     * @return    VTInCallScreenFlags instance
     */
    public static VTInCallScreenFlagsLoopback getInstance() {
        return sVTInCallScreenFlags;
    }

    private VTInCallScreenFlagsLoopback() {
