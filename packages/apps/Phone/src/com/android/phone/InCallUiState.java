 ...
 * the telephony layer.
 *
 * The singleton instance of this class is owned by the PhoneGlobals instance.
 */
public class InCallUiState {
    ...
    InCallScreenMode mLastInCallScreenMode = InCallScreenMode.UNDEFINED;
    ...
    /**
     * Sets the SIM slot and number.
     */
    public void setNumberSlot(int slot, String number) {
        mSlot = slot;
        mStrNumber = number;
    ...
    //Add for handle the mmi running when incallscreen not ready
    private Message mMmiMsg = null;
    void setPendingUssdMessage(Message msg) {
        mMmiMsg = msg;
    }
    ...
    FakeCall latestDisconnectCall = null;
    ...
    //Define the incallscreen not exit status
    ...
    static boolean isNormalInCallScreenState() {
        return sLastInCallScreenStatus == INCALLSCREEN_NOT_EXIT_NORMAL;
    }
    
    public void clearState() {
        log("clearState()");
        // Here just clear dialpad visibility state, if needed,
