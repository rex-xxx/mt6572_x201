...
public class SpecialCharSequenceMgr {
    ...
    static private boolean handlePinEntry(Context context, String input,
                                          Activity pukInputActivity) {
        return handlePinEntryGemini(context, input, pukInputActivity, PhoneConstants.GEMINI_SIM_1);
    }
    ...
    static private boolean handlePinEntryGemini(Context context, String input,
        ...
        if ((input.startsWith("**04") || input.startsWith("**05"))
            ...
            boolean isMMIHandled = GeminiUtils.handlePinMmi(app.phone, input, simId);
            log("SpecialCharSequenceMgr , handlePinEntryGemini(), simId:" + simId + ", isMMIHandled:"
                    + isMMIHandled);
