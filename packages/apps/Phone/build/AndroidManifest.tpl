...
>
    ...
    <application android:name="PhoneApp"
        ...
        <activity android:name="com.mediatek.settings.NetworkSettingList"
                android:label="@string/networks"
                android:configChanges="orientation|screenSize|keyboardHidden|mcc|mnc"
                android:theme="@android:style/Theme.Holo.DialogWhenLarge">
            <intent-filter>
        ...
        <activity android:name="com.mediatek.settings.CdmaCallForwardOptions"
                android:label="@string/cdma_cfu_title"
                android:configChanges="orientation|screenSize|keyboardHidden"
                android:theme="@android:style/Theme.Holo.DialogWhenLarge">
            <intent-filter>
                <action android:name="android.intent.action.MAIN" />
        ...
        <activity android:name="com.mediatek.settings.CdmaCallWaitingOptions"
                android:label="@string/cdma_cfu_title"
                android:configChanges="orientation|screenSize|keyboardHidden"
                android:theme="@android:style/Theme.Holo.DialogWhenLarge">
            <intent-filter>
        ...
        <activity android:name="com.mediatek.settings.CellBroadcastSettings"
        ...
        <activity android:name="com.mediatek.settings.CallRejectSetting"
            android:label="call reject"
            android:configChanges="orientation|keyboardHidden|screenSize">
            <intent-filter>
                <action android:name="android.intent.action.MAIN" />
            </intent-filter>
        </activity>
        <activity android:name="com.mediatek.settings.CallRejectListSetting"
            android:label="call reject list"
            android:uiOptions = "splitActionBarWhenNarrow"
            android:configChanges="orientation|keyboardHidden|screenSize">
            <intent-filter>
                <action android:name="android.intent.action.MAIN" />
        ...
        <activity android:name="com.mediatek.settings.CallRejectListModify"
            android:label="call reject list modify"
            android:screenOrientation = "nosensor"
            android:uiOptions = "splitActionBarWhenNarrow"
            android:configChanges="orientation|keyboardHidden|screenSize">
            <intent-filter>
        ...
        <!-- fdn setting -->
        <activity android:name="com.mediatek.settings.FdnSetting2" android:label="@string/fdn"
        ...
        <!-- vt setting -->
        <activity android:name="com.mediatek.settings.VTAdvancedSetting"
        ...
        <activity android:name="com.mediatek.settings.VTAdvancedSettingEx"
            android:label="@string/vt_call_settings"
            android:configChanges="orientation|keyboardHidden|screenSize">
            <intent-filter>
                <action android:name="android.intent.action.MAIN" />
        ...
        <!-- Add for Phone settings begin -->
        <activity android:name="com.mediatek.settings.Modem3GCapabilitySwitch"
            android:label="@string/vt_call_settings"
        ...
        <activity android:name="com.mediatek.settings.PLMNListPreference"
            android:uiOptions="splitActionBarWhenNarrow"
            android:configChanges="orientation|keyboardHidden|screenSize|mcc|mnc">
            <intent-filter>
                <action android:name="android.intent.action.MAIN" />
        ...
        <activity android:name="com.mediatek.settings.NetworkEditor"
            android:configChanges="orientation|keyboardHidden|screenSize|mcc|mnc">
            <intent-filter>
                <action android:name="android.intent.action.MAIN" />
            </intent-filter>
        </activity>
       <!-- Add for Phone settings end -->
        <activity android:name="EnableFdnScreen"
                android:label=""
                android:theme="@android:style/Theme.Holo.DialogWhenLarge">
        </activity>
        ...
        <activity android:name="ChangeIccPinScreen"
                android:label="@string/change_pin2"
				android:configChanges="orientation|screenSize|keyboardHidden"
                android:theme="@android:style/Theme.Holo.DialogWhenLarge">
            <intent-filter>
                <action android:name="android.intent.action.MAIN" />
        ...
        <activity android:name="com.mediatek.settings.CallSettings" android:label="@string/call_settings"
                android:configChanges="orientation|screenSize|keyboardHidden"
        ...
        <activity android:name="com.mediatek.settings.SipCallSetting" android:label="@string/sip_settings"
            android:configChanges="orientation|keyboardHidden|screenSize">
            <intent-filter>
                <action android:name="android.intent.action.VIEW" />
                <action android:name="android.intent.action.MAIN" />
...
<!-- BLUEANGEL::PLACEHOLDER -->
        ...
        <activity android:name="com.mediatek.settings.CallBarring"
        ...
        <activity android:name="com.mediatek.settings.OthersSettings" 
        ...
        <activity android:name="com.mediatek.settings.MultipleSimActivity" 
        ...
        <activity android:name="com.mediatek.settings.VoiceMailSetting" 
            android:label="@string/call_settings"
            android:launchMode="singleTask"
            android:excludeFromRecents="true"
            android:configChanges="orientation|keyboardHidden|screenSize">
        ...
        <activity android:name="com.mediatek.settings.IpPrefixPreference" 
        ...
        <activity android:name="com.mediatek.settings.CellBroadcastActivity" 
        ...
        <activity android:name="com.mediatek.phone.UssdAlertActivity"
                  android:process="com.android.phone"
                  android:excludeFromRecents="true"
                  android:launchMode="singleInstance"
                  android:theme="@*android:style/Theme.Holo.Dialog.Alert">
        </activity>
        <activity android:name="com.mediatek.phone.VoicemailDialog" android:theme = "@android:style/Theme.Dialog"></activity>
        <service android:name="com.mediatek.phone.recording.PhoneRecorderServices"></service>
        <provider android:name="com.mediatek.settings.CallRejectContentProvider" android:authorities="reject" />
        
<!--StkSelection begin-->
         <activity android:name="com.mediatek.phone.StkListEntrance"
        ...
        <activity android:name="com.mediatek.phone.SimInfoPreference"
              android:label="@string/sim_toolkit"
              android:process="com.android.phone">
            <intent-filter>
...
<!--VT loopback activity begin -->
    <activity android:name="com.mediatek.vt.loopback.VTLoopbackActivity"
            android:process="com.android.phone">
        <intent-filter>
            <action android:name="android.intent.action.MAIN" />
...
<!--VT loopback activity end -->

<!--VT test activity begin-->
     <activity android:name="com.mediatek.vt.test.VTTestActivity"></activity>
<!--VT test activity end-->
    </application>
</manifest>
