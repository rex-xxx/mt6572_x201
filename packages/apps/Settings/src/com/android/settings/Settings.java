...
public class Settings extends PreferenceActivity
    ...
    public void onResume() {
        ...
        invalidateHeaders();
        ///M: add for sim hot swap
        registerReceiver(mSiminfoReceiver, 
    ...
    private void updateHeaderList(List<Header> target) {
        ...
        while (i < target.size()) {
            ...
            /**M: add to remove sim management for wifi only project @{*/
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        public void isSimManagementAvailable(Context context) {
            ...
            boolean isHasSimCards = (android.provider.Telephony.SIMInfo.getInsertedSIMCount(context) != 0); 
     ...
     */
    public static class WapPushSettings extends Settings { /* empty */ }
    public static class SimDataRoamingSettings extends Settings { /* empty */ }
    ...
    ///M: add AudioProfileSettingsActivity to replace
    public static class AudioProfileSettingsActivity extends Settings { /* empty */ }
    ...
    public static class SimListEntranceActivity extends Settings { /* empty */ }
    public static class WifiGprsSelectorActivity extends Settings { /* empty */ }
    public static class HDMISettingsActivity extends Settings { /* empty */ }
    ...
    public static class TetherWifiSettingsActivity extends Settings { /*empty */ }
    public static class BeamShareHistoryActivity extends Settings { /* empty */ }
    public static class NfcSettingsActivity extends Settings {/*empty */}  
    /**@}*/
}
