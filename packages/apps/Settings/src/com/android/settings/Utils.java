...
public class Utils {
    ...
    /**
     * @return true if Monkey is running.
     */
     ...
     * @return whether the device is voice-capable (meaning, it is also a phone).
     */
     ...
     * 
     * @param context Context 
     * @return whether the device is wifi-capable
     */
    ...
    public static ISettingsMiscExt getMiscPlugin(Context context) {
        ...
        try {
            ...
            ext = new DefaultSettingsMiscExt();    
        }
        return ext;
    }
    /**
    ...
    /**
     * M: create apn editor plugin object
     * @param context Context
    ...
    public static IApnEditorExt getApnEditorPlugin(Context context) {
        IApnEditorExt ext;
        try {
            ext = (IApnEditorExt)PluginManager.createPluginObject(context,
                IApnEditorExt.class.getName());
        } catch (Plugin.ObjectCreationException e) {
            ext = new DefaultApnEditorExt();    
        }
        return ext;
    }
    /**
