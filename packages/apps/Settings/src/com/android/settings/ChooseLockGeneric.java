...
public class ChooseLockGeneric extends PreferenceActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
            ...
            } else if (KEY_UNLOCK_SET_VOICE_WEAK.equals(key)) {  ///M: add for voice unlock
                updateUnlockMethodAndFinish(
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            final boolean onlyShowFallback = getActivity().getIntent()
                    .getBooleanExtra(LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK, false);
            if (onlyShowFallback) {
                final String fallBackFor = getActivity().getIntent().getStringExtra(LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK_FOR);
                View header = null;
                if (fallBackFor.equals(LockPatternUtils.FACE_UNLOCK)) {
                    header = v.inflate(getActivity(),
                            R.layout.weak_biometric_fallback_header, null);
                } else if (fallBackFor.equals(LockPatternUtils.VOICE_UNLOCK)){
                    header = v.inflate(getActivity(),
                            R.layout.weak_voice_fallback_header, null);
                }
             //M @}
            ...
            if (encryptionQuality > quality) {
                ...
                if (allowBiometric != null) {
                    allowBiometric.value = quality <=
                            ...
                            || quality == DevicePolicyManager.PASSWORD_QUALITY_VOICE_WEAK) {  //M: modify for voice unlock
            ...
            for (int i = entries.getPreferenceCount() - 1; i >= 0; --i) {
                ...
                if (pref instanceof PreferenceScreen) {
                    ...
                    if (KEY_UNLOCK_SET_OFF.equals(key)) {
                        ...
                        enabled = quality <= DevicePolicyManager.PASSWORD_QUALITY_VOICE_WEAK;
                        //add feature option control here
        ...
        private Intent getBiometricSensorIntent() {
            ...
            fallBackIntent.putExtra(LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK_FOR, LockPatternUtils.FACE_UNLOCK);
            //@}
        ...
        void updateUnlockMethodAndFinish(int quality, boolean disabled) {
            ...
            if (quality >= DevicePolicyManager.PASSWORD_QUALITY_NUMERIC) {
                ...
                intent.putExtra(LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK, isFallback);  //M: modify for voice unlock
                if (isFallback) {
                    //M: add for voice unlock @{ 
                ...
                intent.putExtra(CONFIRM_CREDENTIALS, false);
                intent.putExtra(LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK,
        ...
        /**
         * M: add for voice unlock
         * Get voice unlock intent to start.
         */
        private Intent getVoiceSensorIntent() {
            Intent fallBackIntent = new Intent().setClass(getActivity(), ChooseLockGeneric.class);
            fallBackIntent.putExtra(LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK, true);
            fallBackIntent.putExtra(LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK_FOR, LockPatternUtils.VOICE_UNLOCK);
            fallBackIntent.putExtra(CONFIRM_CREDENTIALS, false);
            fallBackIntent.putExtra(EXTRA_SHOW_FRAGMENT_TITLE,
                    R.string.backup_lock_settings_picker_title);
