...
public class PowerUsageSummary extends PreferenceFragment implements Runnable {
    ...
    private void refreshStats() {
        ...
        if (FeatureOption.MTK_POWER_SAVING_SWITCH_UI_SUPPORT) {
            CheckBoxPreference powerSavingPrf = new CheckBoxPreference(getActivity());
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case H_CHECK_POWER_SAVING_MESSAGE:
                    ((CheckBoxPreference)findPreference(KEY_CPU_DTM)).setChecked(true);
                    break;
                case H_UNCHECK_POWER_SAVING_MESSAGE:
                    ((CheckBoxPreference)findPreference(KEY_CPU_DTM)).setChecked(false);
                    break;
               /// @}
            }
