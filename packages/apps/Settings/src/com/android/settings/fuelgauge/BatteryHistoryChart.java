...
public class BatteryHistoryChart extends View {
    ...
    /// M: to let the text not overlap on the status bar
    int mOffSpace;
    ...
    public BatteryHistoryChart(Context context, AttributeSet attrs) {
        ...
        /// M: maybe the values should change according with resolution ?
        ///mOffSpace = 6;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mLargeMode) {
            ...
            /// M: +5 for tablet 800*480 resolution 
            int barOffset = textHeight + mLineWidth + 5;
