...
public final class DeviceProfilesSettings extends SettingsPreferenceFragment
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen screen, Preference preference) {
        ...
        if (key.equals(KEY_UNPAIR)) {
            ...
            /** M: CR ALPS00543021, if user chose to exist from the current fragment,
             * do not save the instanceState.
             * */
            noteStateNotSaved();
            finish();
            return true;
    ...
    /**
     * M: Invoke FragmentManager # NoteStateNotSaved() method.
     */
    private void noteStateNotSaved() {
        try {
            ...
            Field fragmentManagerField = cls.getDeclaredField("mFragments");
            fragmentManagerField.setAccessible(true);
            Object fragmentMgr = fragmentManagerField.get(this);
            cls = fragmentMgr.getClass();
            Method noteStateNotSavedMethod = cls.getDeclaredMethod("noteStateNotSaved", new Class[] {});
            noteStateNotSavedMethod.invoke(fragmentMgr, new Object[] {});
        } catch (Exception ex) {
            Log.e(TAG, "Exception happens, exception : " + ex);
        }
    }
}
