...
final class A2dpProfile implements LocalBluetoothProfile {
    ...
    public boolean connect(BluetoothDevice device) {
        ...
        if (sinks != null) {
            /** M: The attempt connecting device is already in the connected device list, do not
             *  need to disconnect & then connect again, just return true. CR ALPS00454900.{ */
            if (sinks.contains(device)) {
                Log.d(TAG, "Device is already in the connected list, just return true");
                return true;
            }
            /** @} */
