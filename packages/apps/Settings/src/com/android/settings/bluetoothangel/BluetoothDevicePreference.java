...
public final class BluetoothDevicePreference extends Preference implements
    ...
    public void onDeviceAttributesChanged() {
         ...
         */
        Log.d(TAG, mCachedDevice.getName() + " onDeviceAttributesChanged");
    ...
    protected void onBindView(View view) {
        // Disable this view if the bluetooth enable/disable preference view is
        // off
        ...
        if (mCachedDevice.getBondState() == BluetoothDevice.BOND_BONDED) {
            ImageView deviceDetails = (ImageView) view
                    .findViewById(R.id.deviceDetails);
    ...
    private void askDisconnect() {
        ...
        String message = context.getString(
                R.string.bluetooth_disconnect_all_profiles, name);
        ...
        mDisconnectDialog = Utils.showDisconnectDialog(context,
                mDisconnectDialog, disconnectListener, title,
    ...
    private int getConnectionSummary() {
        ...
        Log.d(TAG, "getConnectionSummary");
        ...
        for (LocalBluetoothProfile profile : cachedDevice.getProfiles()) {
            if (profile != null) {
                Log.d(TAG, "profile name is " + profile.toString());
            }

            int connectionStatus = cachedDevice
                    .getProfileConnectionState(profile);
            Log.d(TAG, "profile connection state is " + connectionStatus);
            ...
            case BluetoothProfile.STATE_DISCONNECTED:
                if (profile.isProfileReady()
                        && profile.isPreferred(cachedDevice.getDevice())) {
                    if (profile instanceof A2dpProfile) {
                        Log.d(TAG, "a2dpNotConnected = true");
                        a2dpNotConnected = true;
                    } else if (profile instanceof HeadsetProfile) {
                        Log.d(TAG, "headsetNotConnected = true");
    ...
    private int getBtClassDrawable() {
        ...
        if (btClass != null) {
            ...
            default:
                ...
                Log.d(TAG, "unrecognized device class " + mClass);
            }
        } else {
