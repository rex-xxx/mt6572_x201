...
final class LocalBluetoothProfileManager {
    ...
    // / M: add Uuid for mediatek supported profile @{
    ...
    LocalBluetoothProfileManager(Context context,
       ...
       // as we do not need to monitor the profile as part of profile list
        ...
        // / M: Always add FTP profile for FTP client.
        // / If FTP client is removed in the future, this requirement can be
        // done by
    ...
    void updateLocalProfiles(ParcelUuid[] uuids) {
        ...
        // Headset / Handsfree
        // / M: Remove hsf local uuid limitation temporarily @{
        /*
        ...
        // / M: Remove hsf local uuid limitation temporarily @{
        /*
         * } else if (mHeadsetProfile != null) { Log.w(TAG,
         * "Warning: HEADSET profile was previously added but the UUID is now missing."
         * ); }
         */
        // / @}
        ...
        if (BluetoothUuid.isUuidPresent(uuids, BluetoothUuid.ObexObjectPush)) {
            ...
            Log.w(TAG,
                    "Warning: OPP profile was previously added but the UUID is now missing.");
        }
        mEventManager.registerProfileIntentReceiver();

        // There is no local SDP record for HID and Settings app doesn't control
        // PBAP
    }
    ...
    private void addProfile(LocalBluetoothProfile profile, String profileName,
        ...
        mEventManager.addProfileHandler(stateChangedAction,
                new StateChangedHandler(profile));
    ...
    synchronized void updateProfiles(ParcelUuid[] uuids, ParcelUuid[] localUuids,
        ...
        // / M: When update profiles, firstly update local profile @{
        ...
        if ((BluetoothUuid.isUuidPresent(uuids, BluetoothUuid.NAP)
                && BluetoothUuid.isUuidPresent(localUuids,
                        BluetoothUuid.PANU) &&
        ...
        // / M: If remote device uuid contains FTP profile uuid add ftp to the
        // profile list @{
