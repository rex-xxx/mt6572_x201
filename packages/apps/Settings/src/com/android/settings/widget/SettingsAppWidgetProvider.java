...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, "onReceive , intent.hasCategory(Intent.CATEGORY_ALTERNATIVE)= "
...
//                        com.android.internal.R.bool.config_automatic_brightness_available)) {
                ...
                Log.d(TAG, "begin ------toggleBrightness() ,brightnessMode ="
                ...
                if (brightnessMode == Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL) {
                  Log.i(TAG, "-----------toggleBrightness()----setBacklightBrightness()----brightness: "
                            + brightness);
                    power.setTemporaryScreenBrightnessSettingOverride(brightness);
                    Settings.System.putInt(cr, Settings.System.SCREEN_BRIGHTNESS, brightness);
                }
                Log.d(TAG, "end ------toggleBrightness(),brightnessMode ="
                        + Settings.System.getInt(cr,
                        Settings.System.SCREEN_BRIGHTNESS_MODE) + " brightness = "
                        + Settings.System.getInt(cr,
                                Settings.System.SCREEN_BRIGHTNESS));
            }
