...
public class ChooseLockPattern extends PreferenceActivity {
    ...
    public static class ChooseLockPatternFragment extends Fragment
        ...
        private void saveChosenPatternAndFinish() {
            ...
            final String commandKey = getActivity().getIntent().getStringExtra(
                    LockPatternUtils.SETTINGS_COMMAND_KEY);
            final String commandValue = getActivity().getIntent()
                    .getStringExtra(LockPatternUtils.SETTINGS_COMMAND_VALUE);
            
            utils.saveLockPattern(mChosenPattern, isFallback, isFallbackFor);
            if (commandKey != null) {
            ...
            getActivity().setResult(RESULT_OK); //M: modify for voice unlock
            getActivity().finish();
        }
    }
}
