...
public class MasterClear extends Fragment {
    ...
    private void establishInitialState() {
        ...
        // /M: add new feature for shared sd card feature by mtk @{
        boolean isSomeStorageEmulated = Utils.isSomeStorageEmulated();
        Xlog.d(TAG, "isExtStorageEmulated=" + isExtStorageEmulated
                + " isSomeStorageEmulated=" + isSomeStorageEmulated);
        ///@}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ///M: get the lable of storage to show correct one @{
    ...
    private void getVolumeDescription() {
        ...
        Xlog.d(TAG, "mVolumeDescription=" + mVolumeDescription);
    }

    private String getVolumeString(int stringId) {
        if (mVolumeDescription == null) { // no volume description
            Xlog.d(TAG, "+mVolumeDescription is null and use default string");
        ...
        if (str != null && str.equals(getString(stringId))) {
            ...
            Xlog.d(TAG, "Not any available then replase key word sd str=" + str);
        }
