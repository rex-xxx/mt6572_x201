...
public class RunningServiceDetails extends Fragment
    ...
    void addProcessDetailsView(RunningState.ProcessItem pi, boolean isMain) {
        ...
        // M: init the launch button {@
            detail.mLaunchButton = (Button)root.findViewById(R.id.launch_button);
            detail.mCategory = root.findViewById(R.id.main_launch_category);
            detail.mLaunch = root.findViewById(R.id.main_launch);
            detail.mLaunchButton.setVisibility(View.VISIBLE);
            detail.mCategory.setVisibility(View.VISIBLE);
            detail.mLaunch.setVisibility(View.VISIBLE);
            detail.mLaunchButton.setOnClickListener(detail);
            detail.mIntent = getActivity().getPackageManager().getLaunchIntentForPackage(
                    detail.mActiveItem.mItem.mPackageInfo.packageName);
            detail.mLaunchButton.setEnabled(detail.mIntent != null);
        // @}
