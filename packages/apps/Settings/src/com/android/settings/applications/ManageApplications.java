...
final class CanBeOnSdCardChecker {
    ...
    boolean check(ApplicationInfo info) {
        ...
        if ((info.flags & ApplicationInfo.FLAG_EXTERNAL_STORAGE) != 0) {
            canBe = true;
        /// M: [ALPS00270065] @{
        } else if ((info.flags & ApplicationInfo.FLAG_UNINSTALL_APP) == 0) {
        /// @}
...
public class ManageApplications extends Fragment implements
        ...
        public View build(LayoutInflater inflater, ViewGroup contentParent, View contentChild) {
            ...
            if (mListContainer != null) {
                ...
                if (mFilter == FILTER_APPS_SDCARD) {
                    mStorageChartLabel.setText(sSdDescription);
                } else {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // M: get the sd card description from Storage Manager {@
        ...
        if (!Environment.isExternalStorageEmulated() 
            ...
            tab = new TabInfo(this, mApplicationsState,
                   sSdDescription,LIST_TYPE_SDCARD, this, savedInstanceState);
            mTabs.add(tab);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (FeatureOption.MTK_THEMEMANAGER_APP) {
            ...
            if (themeColor != 0) {
                tabs.setTabIndicatorColor(themeColor);
            }
        }
