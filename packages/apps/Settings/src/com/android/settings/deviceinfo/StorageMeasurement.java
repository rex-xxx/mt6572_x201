...
public class StorageMeasurement {
    ...
    private class MeasurementHandler extends Handler {
        ...
        private void measureApproximateStorage(IMediaContainerService imcs) {
             ...
             * when calculating the internal storage  total size and avail size, use the
        ...
        private void measureExactStorage(IMediaContainerService imcs) {
            ...
            final boolean measureMedia = (mIsInternal && Environment.isExternalStorageEmulated())
                    || mIsPrimary;
            Log.d(TAG, "measureMedia is " + measureMedia + "mIsInternal is " + mIsInternal + " isEmulated: " + Environment.isExternalStorageEmulated()
                    + " mIsPrimary is " +mIsPrimary );
            if (measureMedia) {
