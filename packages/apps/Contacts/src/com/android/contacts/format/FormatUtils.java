...
public class FormatUtils {
     ...
     */
    public static int indexOfWordPrefix(CharSequence text, char[] prefix, OffsetValues offsetValue) {
        ...
        while (i < textLength) {
            ...
            for (j = 0; j < prefixLength; j++) {
                while (n < textLength) {
                    textChar = Character.toUpperCase(text.charAt(n));
                    n++;
                ...
                while (j < prefixLength) {
                    preChar = Character.toUpperCase(prefix[j]);
    ...
    static public class OffsetValues {
        public int mOffset;

        public OffsetValues(int offset) {
            mOffset = offset;
        }
    }
}
