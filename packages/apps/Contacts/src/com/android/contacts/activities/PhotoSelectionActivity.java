...
public class PhotoSelectionActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (mPhotoHandler != null) {
            ...
            /**
             * M: [ANR] avoid ANR, execute the handlePhotoActivityResult Async @{
             */
            if (mPhotoHandler.canHandleActivityResultRequest(requestCode, resultCode)) {
                ...
                mPhotoHandler.handlePhotoActivityResultAsync(requestCode, resultCode, data);
            /**
             * @}
             */
