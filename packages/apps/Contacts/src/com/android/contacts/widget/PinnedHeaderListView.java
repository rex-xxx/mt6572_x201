...
public class PinnedHeaderListView extends AutoScrollListView
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        /**
         * M: Make sure that mHeaderWidth is the latest value, because
         * mHeaderWidth will be used to ensurePinnedHeaderLayout(int) method
         * which belongs to super.onLayout(changed, l, t, r, b) calling process.
         * */
