...
///M: import a Toast Control class
...
public class ImportVCardActivity extends ContactsActivity {
    private static final String LOG_TAG = ImportVCardActivity.class.getSimpleName();
    ...
    private class ImportRequestConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            if (mVCardCacheThread == null) {
                Log.e(LOG_TAG, "[onServiceConnected]mVCardCacheThread is null, some error happens.");
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        MtkToast.toast(getApplicationContext(), R.string.vcard_import_request_rejected_message);
                        finish();
                    }
                });
                return;
    ...
    private class VCardCacheThread extends Thread
        ...
        public void run() {
            ...
            try {
                ...
                mWakeLock.release();
                // The following lines are provided and maintained by Mediatek Inc.
                if (!ImportVCardActivity.this.isFinishing() && (null != mConnection) && mConnection.isServiceBinded()) {
        ...
        public void onClick(DialogInterface dialog, int which) {
            if (which == DialogInterface.BUTTON_POSITIVE) {
                ...
                case IMPORT_MULTIPLE:
                    ...
                    /** M: Default show dialog_select_multiple_vcard,should disable the OK button @{ */
                    Button btnOK = mVcardFileSelectDialog.getButton(DialogInterface.BUTTON_POSITIVE);
        ...
        if (!TextUtils.isEmpty(accountName) && !TextUtils.isEmpty(accountType)) {
            ...
            if (accountList.size() == 0) {
                ...
                for (AccountWithDataSet account : accountList) {
                    if (AccountType.ACCOUNT_TYPE_SIM.equals(account.type)
                            || AccountType.ACCOUNT_TYPE_USIM.equals(account.type)
                            || AccountType.ACCOUNT_TYPE_UIM.equals(account.type)) {
                        validAccountSize--;
                    } else {
                        mAccount = account;
                    }
    ...
    protected Dialog onCreateDialog(int resId, Bundle bundle) {
        switch (resId) {
            case R.string.import_from_sdcard: {
                Log.d(LOG_TAG, "[onCreateDialog]import_from_sdcard");
            ...
            case R.id.dialog_vcard_not_found: {
                 ...
                 *   Descriptions: 
                 */
                final String message = getString(R.string.import_no_vcard_dialog_text, volumeName);
                AlertDialog.Builder builder = new AlertDialog.Builder(this)
                        .setMessage(message)
                        .setOnCancelListener(mCancelListener)
                        .setPositiveButton(android.R.string.ok, mCancelListener);
            ...
            case R.id.dialog_cache_vcard: {
                ...
                if (mProgressDialogForCachingVCard == null) {
                    Log.i(LOG_TAG, "[onCreateDialog][dialog_cache_vcard]Dialog first created");
    ...
    private void doScanExternalStorageAndImportVCard() {
        ...
        Log.i("[doScanExternalStorageAndImportVCard]","file.path : "+file.getPath());
        /*
         * Bug Fix by Mediatek Begin.
         *   Original Android's code:
         *     xxx
        ...
        if (volumes != null){
            for (StorageVolume volume : volumes){
                if (path != null && volume.getPath().equals(path)){
                    ...
                    Log.i(LOG_TAG,"[doScanExternalStorageAndImportVCard] volumeName : "+volumeName);
                }
            }
        }
        /*
    ...
    /* package */ void showFailureNotification(int reasonId) {
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                MtkToast.toast(ImportVCardActivity.this, getString(R.string.vcard_import_failed), Toast.LENGTH_LONG);
                ///@}
            }
        });
    }
    ...
    private static File getDirectory(String path, String defaultPath) {
