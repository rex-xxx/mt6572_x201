        ...
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
    ...
    public static class CustomFilterConfigurationLoader extends AsyncTaskLoader<AccountSet> {
         ...
         * ALPS00116855 Descriptions:
         */
        private static final String CLAUSE_GROUP_VISIBLE = Groups.DELETED + "=0";
        /*
         * Bug Fix by Mediatek End.
         */
        ...
        public AccountSet loadInBackground() {
            ...
            for (AccountWithDataSet account : accountTypes.getAccounts(false)) {
                 ...
                 * groupsUri.build(), null, null, null, null)); CR ID:
                 * ALPS00116855 Descriptions:
                 */

                EntityIterator iterator = ContactsContract.Groups.newEntityIterator(resolver.query(
                        groupsUri.build(), null, CLAUSE_GROUP_VISIBLE, null, null));
                /*
                 * Bug Fix by Mediatek End.
                 */
                ...
                try {
                    ...
                    Log.i(TAG,"loadInBackground befor fromSettings");
    ...
    protected static class GroupDelta extends ValuesDelta {
        ...
        public static GroupDelta fromSettings(ContentResolver resolver, String accountName,
            ...
            try {
                ...
                if (cursor != null && cursor.moveToFirst()) {
                    Log.d(TAG, "fromSettings(), Read existing values when present**** ");
                    ...
                    Log.d(TAG, "fromSettings(), Nothing found, so treat as create**** ");
        ...
        Log.d(TAG, "buildDiff() mUngrouped =" + mUngrouped);
            if (isInsert()) {
                // Only allow inserts for Settings
                if (mUngrouped) {
                    mAfter.remove(mIdColumn);
                    Log.d(TAG, "isInsert, buildDiff() **** ");
                ...
                if (mUngrouped) {
                    ...
                    Log.d(TAG, "selection.toString()= "+ selection.toString());
    ...
    protected static class DisplayAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ...
            displayName = AccountFilterUtil.getAccountDisplayNameByAccount(account.mType,
                    account.mName);
            if (null == displayName) {
                text1.setText(account.mName);
            } else {
