...
public abstract class ContactListAdapter extends ContactEntryListAdapter {
    ...
    /** M: New Feature Gemini <br>
     *    Original Code:<br>
     *      protected static class ContactQuery { <br>
     *  @{ */
    public static class ContactQuery {
        private static final String[] CONTACT_PROJECTION_PRIMARY = new String[] {
            ...
            Contacts.CONTACT_STATUS_RES_PACKAGE,    // 12
            Contacts.CONTACT_STATUS_ICON,           // 13
            ///@}
            /** @} */
        };
        ...
        ///M: for SNS plugin @{
        public static final int STATUS_RES_PACKAGE       = 12;
        public static final int STATUS_ICON              = 13;
        ///@}
        /** @} */
    }
