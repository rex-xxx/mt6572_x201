...
public class ContactsRequest implements Parcelable {
    ...
    public static final int ACTION_PICK_MULTIPLE_CONTACTS = 61;

    /** Show all contacts and delete all of checked items */
    public static final int ACTION_DELETE_MULTIPLE_CONTACTS = 62;

    /** Show all contacts in one group and move all of checked items */
    public static final int ACTION_GROUP_MOVE_MULTIPLE_CONTACTS = 63;

    /** Show all contacts and share all of checked items */
    public static final int ACTION_SHARE_MULTIPLE_CONTACTS = 64;

    /** Show all contacts in multiple choice view and add all of checked items */
    public static final int ACTION_GROUP_ADD_MULTIPLE_CONTACTS = 65;

    /** Show all email addresses and pick all of checked items */
    public static final int ACTION_PICK_MULTIPLE_EMAILS = 106;

    /** Show all phone numbers and pick all of checked items */
    public static final int ACTION_PICK_MULTIPLE_PHONES = 91;

    /** Show all phone numbers & emails and pick all of checked items */
    public static final int ACTION_PICK_MULTIPLE_PHONEANDEMAILS = 92;
    
    /** Show all the specified mimetypes datas and pick all of checked items */
    public static final int ACTION_PICK_MULTIPLE_DATAS = 93;
