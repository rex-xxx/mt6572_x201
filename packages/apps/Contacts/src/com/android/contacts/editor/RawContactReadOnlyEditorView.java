...
public class RawContactReadOnlyEditorView extends BaseRawContactEditorView
    ...
    public void setState(RawContactDelta state, AccountType type, ViewIdGenerator vig,
        ...
        if (isProfile) {
            ...
            if (!TextUtils.isEmpty(mAccountName) && !type.accountType.equals(AccountType.ACCOUNT_TYPE_LOCAL_PHONE)) {
            ...
            /**
             * M: Change feature by Mediatek Begin. Original Android's code:
             * mAccountTypeTextView
             * .setText(mContext.getString(R.string.account_type_format,
             * accountType)); CR ID: ALPS00453091 Descriptions: if local phone
             * account, set string to "Phone contact" @{
             */
            if (type.accountType.equals(AccountType.ACCOUNT_TYPE_LOCAL_PHONE)) {
        ...
        mAccountTypeTextView.setTextColor(mContext.getResources().getColor(R.color.secondary_text_color));
