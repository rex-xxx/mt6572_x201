...
public class ContactLoaderFragment extends Fragment implements FragmentKeyListener {
    ...
    public void loadUri(Uri lookupUri) {
        ...
        if (mLookupUri == null) {
            ...
            /// destroy loader for CR ALPS00558044.
            getLoaderManager().destroyLoader(LOADER_DETAILS);
    ...
    private final LoaderManager.LoaderCallbacks<Contact> mDetailLoaderListener =
        ...
        public void onLoadFinished(Loader<Contact> loader, Contact data) {
            if (!mLookupUri.equals(data.getRequestedUri())) {
                ...
                /** M: change for CR ALPS00609736.
                 * Don't return here, if user Join Contacts, the lookupUri will change.
                 * origin code: return;
                 */
            }
            ...
            if (data.isError()) {
                ...
                /** M: fixed CR ALPS00566438. @{
                 * This will happen when load contact data and at the same time ContactsProvider process has died.
                 * So Don't let it throw exception here.
                 * Original Code:
                 * throw new IllegalStateException("Failed to load contact", data.getException());
                 */
                Log.i(TAG, "Failed to load contact: " + data.getException());
                return;
                /** @} */
            ...
            if (mListener != null) {
                if (mContactData == null) {
                    ...
                    Log.d(TAG, "onLoadFinished() contact not found.");
                } else {
                    /// Change for CR ALPS00609736, update lookup uri.
    ...
    /** @} */
        ...
        ExtensionManager.getInstance().getContactListExtension().setMenuItem(blockVoiceCallmenu,mOptionsMenuOptions,
     ...
     */
        ...
        if (this.mContactData != null && this.mContactData.getIndicate() >= 0) {
            ...
            Log.i(TAG, "[onPrepareOptionsMenu] this.mContactData.getIndicate() : "
                    + this.mContactData.getIndicate());
        } else {
            createContactShortcutMenu.setVisible(mOptionsMenuCanCreateShortcut);
        }
        /** @} */
    ...
    /** M: New Feature xxx @{ */
        /* orignal code return mContactData != null && !mContactData.isDirectoryEntry();*/
        return mContactData != null && !mContactData.isDirectoryEntry()
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_delete: {
                if (mListener != null) {
                    if (mContactData != null) {
                        mListener.onDeleteRequested(mContactData.getLookupUri());
                    } else {
            ...
            case R.id.menu_share: {
                ...
                if (mContactData.isUserProfile()) {
                    ...
                    intent.setType(Contacts.CONTENT_VCARD_TYPE);
                    // intent.setDataAndType(shareUri,
                    // Contacts.CONTENT_VCARD_TYPE);
                    intent.putExtra("contactId", String.valueOf(mContactData.getContactId()));
                    /** @} */
                }
                /** M: New Feature xxx @{ */
                /*
                 * remove orignal code final Intent intent = new
    ...
    /** M: New Feature xxx @{ */
            ...
            */
            case R.id.menu_block_voice_incoming_call: {
                mSendToVoicemailState = !mSendToVoicemailState;
                item.setChecked(mSendToVoicemailState);
                Intent intent = ContactSaveService.createSetSendToVoicemail(mContext, mLookupUri,
            ...
            case R.id.menu_block_video_incoming_call: {
                ...
                Intent intent = ContactSaveService.createSetBlockVideoCall(mContext, mLookupUri,
                        mBlockVideoCallState);
                mContext.startService(intent);
                return true;
            }
    /** @} */
...
/** @} */
    ...
    /**
     *Close soft keyboard when pressing item men if searchView is expanded.
     */
    private void closeSoftKeyboard() {
        ActionBar actionBar = getActivity().getActionBar();
        View searchViewContainer = actionBar.getCustomView();
        SearchView mSearchView = (SearchView) searchViewContainer.findViewById(R.id.search_view);
