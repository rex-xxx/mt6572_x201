...
public final class ContactTileLoaderFactory {
    ...
    public final static int PHONE_INDICATE_PHONE_SIM = 8;
    public final static int PHONE_IS_SDN_CONTACT = 9;
    ...
    public static CursorLoader createStrequentPhoneOnlyLoader(Context context) {
         ...
         * return new CursorLoader(context, uri, COLUMNS_PHONE_ONLY, null, null, null);
         */
        return new CursorLoader(context, uri, COLUMNS_PHONE_ONLY, Contacts.INDICATE_PHONE_SIM
                + "=-1 ", null, null);
        /** @} */
    }
