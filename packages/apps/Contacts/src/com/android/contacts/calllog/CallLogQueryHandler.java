...
//        }
    ...
    public void fetchCallsJionDataView(int simFilter, int typeFilter) {
        ...
        cancelFetch();
        int requestId = newCallsRequest();
        fetchCalls(QUERY_ALL_CALLS_JOIN_DATA_VIEW_TOKEN, requestId ,simFilter, typeFilter);
    }
    ...
    private void fetchCalls(int token, int requestId, int simFilter, int typeFilter) {
        ...
        String[] queryProjection = CallLogQuery._PROJECTION;
        ...
        startQuery(token, requestId, queryUri, queryProjection, selection, null,
                Calls.DEFAULT_SORT_ORDER);
    }
    ...
    public void fetchSearchCalls(Uri uri) {
        ...
        startQuery(QUERY_SEARCH_TOKEN, null, uri,
                CallLogQuery.PROJECTION_CALLS_JOIN_DATAVIEW, null, null,
                Calls.DEFAULT_SORT_ORDER);
    }
