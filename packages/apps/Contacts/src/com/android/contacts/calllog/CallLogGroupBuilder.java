...
public class CallLogGroupBuilder {
    ...
    public void addGroups(Cursor cursor) {
        ...
        // The number of the first entry in the group.
        String firstNumber = cursor.getString(CallLogQuery.CALLS_JOIN_DATA_VIEW_NUMBER);
        // This is the type of the first call in the group.
        int firstCallType = cursor.getInt(CallLogQuery.CALLS_JOIN_DATA_VIEW_CALL_TYPE);
        
        //The following lines are provided and maintained by Mediatek Inc.
        int firstSimId = cursor.getInt(CallLogQuery.CALLS_JOIN_DATA_VIEW_SIM_ID);
        int firstVtCall = cursor.getInt(CallLogQuery.CALLS_JOIN_DATA_VIEW_VTCALL);
        long firstDate = cursor.getLong(CallLogQuery.CALLS_JOIN_DATA_VIEW_DATE);
        ...
        while (cursor.moveToNext()) {
            ...
            final String currentNumber = cursor.getString(CallLogQuery.CALLS_JOIN_DATA_VIEW_NUMBER);
            final int callType = cursor.getInt(CallLogQuery.CALLS_JOIN_DATA_VIEW_CALL_TYPE);
            /** @ } */
            final boolean sameNumber = equalNumbers(firstNumber, currentNumber);
            final boolean shouldGroup;
            /** M: add @ { */
            final int simId = cursor.getInt(CallLogQuery.CALLS_JOIN_DATA_VIEW_SIM_ID);
            final int vtCall = cursor.getInt(CallLogQuery.CALLS_JOIN_DATA_VIEW_VTCALL);
            final long date = cursor.getLong(CallLogQuery.CALLS_JOIN_DATA_VIEW_DATE);
