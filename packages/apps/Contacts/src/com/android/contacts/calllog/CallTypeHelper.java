...
public class CallTypeHelper {
    ...
    public CallTypeHelper(Resources resources) {
        ...
        /**M: [VVM] set voice mail icon color red, same with missed call type. @{*/
        //mNewVoicemailColor = resources.getColor(R.color.call_log_voicemail_highlight_color);
        mNewVoicemailColor = resources.getColor(R.color.call_log_missed_call_highlight_color);
        /** @}*/
        /** M: add @ { */
        mAutoRejectedName = resources.getString(R.string.call_log_auto_rejected_label);
    }
    ...
    /** M: add @ { */
    /** Name used to identify auto rejected calls. */
    private final CharSequence mAutoRejectedName;
}
