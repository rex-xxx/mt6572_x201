...
public class ContactsVoiceMailCallOptionHandler extends VoiceMailCallOptionHandler {

    private static final String TAG = "PhoneVoiceMailCallOptionHandler";

    protected void showMissedingVoiceMailDialog(final Request request,
        ...
        builder.setTitle(R.string.no_vm_number)
               ...
               .setPositiveButton(R.string.add_vm_number_str, clickListener);
