...
public class Rfc822Output {
    ...
    private static void writeOneAttachment(Context context, Writer writer, OutputStream out,
        ...
        long previewSize = attachment.mSize;
        ...
        try {
            ...
            int copyLength = IOUtils.copy(inStream, base64Out);
            base64Out.close();
            ...
            out.write('\n');
            out.flush();
            Logging.d("writeOneAttachment: attachment.mId=" + attachment.mId + 
                    ", attachment.mFileName=" + attachment.mFileName + ", previewSize="
                    + previewSize +", copyLength=" + copyLength);
        }
        catch (FileNotFoundException fnfe) {
            Logging.w("Attachment can not found for sending.", fnfe);
            throw new MessagingException(MessagingException.ATTACHMENT_NOT_FOUND,
                    "Attachment can not found.");
        }
