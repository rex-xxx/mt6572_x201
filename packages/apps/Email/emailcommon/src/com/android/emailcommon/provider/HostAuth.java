...
public final class HostAuth extends EmailContent implements HostAuthColumns, Parcelable {
    ...
    // M: use for test
    public static final String SCHEME_MOCK = "mock";
    ...
    public void setConnection(String protocol, String address,
        ...
        if (mPort == PORT_UNKNOWN) {
            ...
            if (SCHEME_POP3.equals(mProtocol)) {
                mPort = useSSL ? Configuration.POP3_DEFAULT_SSL_PORT : Configuration.POP3_DEFAULT_PORT;
            } else if (SCHEME_IMAP.equals(mProtocol)) {
                mPort = useSSL ? Configuration.IMAP_DEFAULT_SSL_PORT : Configuration.IMAP_DEFAULT_PORT;
            } else if (SCHEME_EAS.equals(mProtocol)) {
                mPort = useSSL ? Configuration.EAS_DEFAULT_SSL_PORT : Configuration.EAS_DEFAULT_PORT;
            } else if (SCHEME_SMTP.equals(mProtocol)) {
                mPort = useSSL ? Configuration.SMTP_DEFAULT_SSL_PORT : Configuration.SMTP_DEFAULT_PORT;
            }
        }
