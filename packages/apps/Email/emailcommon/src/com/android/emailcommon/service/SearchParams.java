...
public class SearchParams implements Parcelable {
    ...
    // M: Flag local search or remote search @{
    ...
    /**
     * M: support search field
     */
    public SearchParams(long mailboxId, String filter, String field, boolean isLocal) {
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(mMailboxId, mFilter, mOffset, mField, mIsLocal);
    }

    @Override
    public String toString() {
        return "[SearchParams " + mMailboxId + ":" + mField + ":" + mIsLocal + ":" + mFilter + " (" + mOffset + ", " + mLimit + "]";
    }
    ...
    public SearchParams(Parcel in) {
        ...
        mIsLocal = (in.readString()) == "1" ? true:false;
        mLimit = in.readInt();
        mOffset = in.readInt();
    }
}
