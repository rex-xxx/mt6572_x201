...
public final class Account extends EmailContent implements AccountColumns, Parcelable {
    ...
    /// M: Add notify vip new mail flag to support vip mail notification
    public static final int FLAGS_NOTIFY_VIP_NEW_MAIL = 1<<13;

    /// M: Whether or not the user has asked for vibration notifications with VIP mail
    public static final int FLAGS_VIP_VIBRATE_ALWAYS = 1<<14;
    ...
    public static final int CHECK_INTERVAL_SMART_PUSH = -5;
    ...
    public static final int CONTENT_VIP_RINGTONE_URI_COLUMN = 20;
    ...
    public static final String[] CONTENT_PROJECTION = new String[] {
        ...
        AccountColumns.VIP_RINGTONE_URI
    };
    ...
    public void restore(Cursor cursor) {
        ...
        mVipRingtoneUri = cursor.getString(CONTENT_VIP_RINGTONE_URI_COLUMN);
    }
    ...
    /**
     * @return the VIP ringtone Uri for this account
     */
    public String getVipRingtone() {
        return mVipRingtoneUri;
    }

    /**
     * Set the VIP ringtone Uri for this account
     * @param newUri the new URI string for the ringtone for this account
     */
    public void setVipRingtone(String newUri) {
        mVipRingtoneUri = newUri;
    }
    ...
    /**
     * Clear the security hold flag
     * @param context the caller's context
     * @param accountId the id of the account
     */
    public static void clearSecurityHoldFlag(Context context, long accountId) {
        ContentResolver resolver = context.getContentResolver();
        Uri uri = ContentUris.withAppendedId(Account.CONTENT_URI, accountId);
        Cursor c = resolver.query(uri, ACCOUNT_FLAGS_PROJECTION, null, null, null);
        try {
            while (c.moveToNext()) {
                int flags = c.getInt(ACCOUNT_FLAGS_COLUMN_FLAGS);
                if (0 != (flags & FLAGS_SECURITY_HOLD)) {
    ...
    public ContentValues toContentValues() {
        ...
        values.put(AccountColumns.VIP_RINGTONE_URI, mVipRingtoneUri);
        return values;
    }
