...
LOCAL_SRC_FILES += $(call all-java-files-under, src/com/ibm)
...
LOCAL_SRC_FILES += src/com/android/emailcommon/service/EmailExternalCalls.aidl
LOCAL_SRC_FILES += $(imported_unified_email_files)
# If set LOCAL_SDK_VERSION like this,MTK dependence code will can't successful compile.
