...
import com.android.email.activity.setup.AccountCheckSettingsFragment.Callbacks;
...
public class OofGetWaitingFragment extends SafeFragment {
    ...
    private static long mAccountId = DEFAULT_ID;
    private boolean mNeedRecoverDialog;
    ...
    public static OofGetWaitingFragment newInstance(long accountId, Fragment parentFragment) {
        OofGetWaitingFragment f = new OofGetWaitingFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mOofCheckTask == null) {
            ...
            Logging.d(this + " ### onActivityCreated  #### "
                    + "  " + mOofCheckTask);
        }
    }
        ...
        if (mAttached && !mPaused) {
            ...
            switch (newState) {
                ...
                case ServerCommandInfo.OofInfo.NETWORK_SHUT_DOWN:
                	if(UiUtilities.isWifiOnly(mContext)) { //For wifi only case,ALPS00458924.
    ...
    /**
     * M: Task for update out of office settings.
     *
     */
    private class OofTask extends EmailAsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            AccountSettingsFragment.sOofParams = controller.syncOof(mAccount.mId, null, true);
            if (AccountSettingsFragment.sOofParams == null) {
                Log.d(TAG, "OofTask return oofParams is null.");
                return ServerCommandInfo.OofInfo.SYNC_OOF_UNINITIALIZED;
            }
            return AccountSettingsFragment.sOofParams.getmStatus();
        }
    ...
    /**
     * M: DialogFragment for waiting update out of office settings.
     *
     */
