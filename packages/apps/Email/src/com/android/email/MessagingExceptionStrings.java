...
public class MessagingExceptionStrings {
    private static final int NO_ERROR_STRING = 0;
    
    public static String getErrorString(Context context, MessagingException e) {
        return (getErrorStringResourceId(e) == NO_ERROR_STRING) ?
                "" : context.getResources().getString(getErrorStringResourceId(e));
    }
    ...
    private static int getErrorStringResourceId(MessagingException e) {
        switch (e.getExceptionType()) {
            ...
            default:
                return NO_ERROR_STRING; // default
        }
    }
}
