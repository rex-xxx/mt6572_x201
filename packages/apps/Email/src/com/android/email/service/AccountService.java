...
public class AccountService extends Service {
    ...
    private final IAccountService.Stub mBinder = new IAccountService.Stub() {
        ...
        @Override
        public void notifySendFailed(long accountId) {
            NotificationController.getInstance(mContext).showSendFailedNotification(accountId);
        }

        @Override
        public void notifySendSucceeded(long accountId) {
            NotificationController.getInstance(mContext).cancelSendFailedNotification(accountId);
        }
