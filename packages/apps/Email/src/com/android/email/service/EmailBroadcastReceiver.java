...
public class EmailBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Logging.d(Email.TAG,
                "EmailBroadcastReceiver function onReceive() start time: " + startTime);
        EmailBroadcastProcessorService.processBroadcastIntent(context, intent);
        Logging.d(Email.TAG, "EmailBroadcastReceiver function onReceive() end time: "
                + System.currentTimeMillis());
        Logging.d(Email.TAG, "EmailBroadcastReceiver function onReceive() spend time: "
