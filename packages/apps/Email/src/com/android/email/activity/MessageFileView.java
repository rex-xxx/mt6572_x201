...
public class MessageFileView extends Activity implements MessageViewFragmentBase.Callback {
    ...
    private class LoadFilenameTask extends EmailAsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            EmailAsyncTask.printStartLog("LoadFilenameTask#doInBackground");
            String str = Utility.getContentFileName(MessageFileView.this, mContentUri);
            EmailAsyncTask.printStopLog("LoadFilenameTask#doInBackground");
            return str;
        }
