...
public class MailboxSettings extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** M: Do not show "smart push" entry for non-inbox mailbox @{ */
        if (Mailbox.TYPE_INBOX != Mailbox.getMailboxType(this, mailboxId)) {
            CharSequence[] entries = mSyncIntervalPref.getEntries();
            CharSequence[] entryValues = mSyncIntervalPref.getEntryValues();
            mSyncIntervalPref.setEntries(Arrays.copyOfRange(entries, 1, entries.length));
            mSyncIntervalPref.setEntryValues(Arrays.copyOfRange(entryValues, 1, entryValues.length));
        }
        /** @} */
    ...
    private class LoadMailboxTask extends EmailAsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            EmailAsyncTask.printStartLog("LoadMailboxTask#doInBackground");
            ...
            EmailAsyncTask.printStopLog("LoadMailboxTask#doInBackground");
            return null;
        }
