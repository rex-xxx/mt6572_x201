...
public class EditQuickResponseDialog extends DialogFragment
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        UiUtilities.setupLengthFilter(mQuickResponseEditText, context, Email.EDITVIEW_MAX_LENGTH_2,
                true);
        ...
        switch (which) {
            ...
            case DialogInterface.BUTTON_POSITIVE:
                ...
                EmailAsyncTask.runAsyncParallel(new Runnable() {
                    @Override
                    public void run() {
                        EmailAsyncTask.printStartLog("EditQuickResponseDialog#onClick");
                        ...
                        EmailAsyncTask.printStopLog("EditQuickResponseDialog#onClick");
                    }
