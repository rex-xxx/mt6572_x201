...
public class AccountSettingsEditQuickResponsesFragment extends Fragment
    ...
    private QuickResponseFinder mQuickResponseFinder;
        ...
        private OnClickListener mOnDeleteListener = new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EmailAsyncTask.runAsyncParallel(new Runnable() {
                    @Override
                    public void run() {
                        EmailAsyncTask.printStartLog("ArrayAdapterWithButtons#onClick");
                        EmailContent.delete(mContext, quickResponse.getBaseUri(),
                                quickResponse.getId());
                        EmailAsyncTask.printStopLog("ArrayAdapterWithButtons#onClick");
                    }
                });
            }
        };
    ...
    public static class QuickResponseFinder extends EmailAsyncTask<Void, Void, QuickResponse[]> {
        ...
        private AccountSettingsEditQuickResponsesFragment mFragment;
        ...
        public QuickResponseFinder(EmailAsyncTask.Tracker tracker, long accountId,
                ...
                OnItemClickListener listener, boolean isEditable,
                    AccountSettingsEditQuickResponsesFragment fragment) {
            super(tracker);
            mAccountId = accountId;
        ...
        protected QuickResponse[] doInBackground(Void... params) {
            EmailAsyncTask.printStartLog("QuickResponseFinder#doInBackground");
            QuickResponse[] quickResponses = QuickResponse.restoreQuickResponsesWithAccountId(
                    mContext, mAccountId);
            EmailAsyncTask.printStopLog("QuickResponseFinder#doInBackground");
        ...
        protected void onSuccess(QuickResponse[] quickResponseItems) {
            ...
            if (mFragment != null) {
                mFragment.mQuickResponseFinder = null;
            }
        }
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.getActivity().setTitle(R.string.account_settings_edit_quick_responses_label);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mQuickResponseFinder = new QuickResponseFinder(mTaskTracker, mAccount.mId,
                mQuickResponsesView, mContext, getFragmentManager(), null, true, this);

        mQuickResponseFinder.executeParallel();

        this.getActivity().getContentResolver().registerContentObserver(
                QuickResponse.CONTENT_URI, true, mContentObserver);
    ...
    private ContentObserver mContentObserver = new ContentObserver(new Handler()) {
        ...
        public void onChange(boolean selfChange) {
            if (mQuickResponseFinder == null) {
                mQuickResponseFinder = new QuickResponseFinder(mTaskTracker, mAccount.mId,
                        mQuickResponsesView, mContext, getFragmentManager(), null, true,
                        AccountSettingsEditQuickResponsesFragment.this);
                mQuickResponseFinder.executeParallel();
            }
        }
    };
