...
public class RecentMailboxManager {
    ...
    private static final String TAG = "RecentMailboxManager";
    ...
    public static final String RECENT_MAILBOXES_SORT_ORDER = MailboxColumns.DISPLAY_NAME;
    ...
    private EmailAsyncTask<Void, Void, Void> fireAndForget(
        ...
        return EmailAsyncTask.runAsyncParallel(new Runnable() {
            @Override
            public void run() {
                EmailAsyncTask.printStartLog("RecentMailboxManager#fireAndForget");
                ensureDefaultsInitialized(accountId, time);
                try {
                    touchMailboxSynchronous(accountId, mailboxId, time);
                } catch(SQLiteException e) {
                    Log.d(TAG, "fireAndForget throw out SQLiteException", e);
                }
                EmailAsyncTask.printStopLog("RecentMailboxManager#fireAndForget");
            }
        });
    }
