...
public class AccountSetupOutgoing extends Activity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Bundle bundle = getIntent().getBundleExtra(SetupData.SETUPDATA_EXTRA_DATA);
            Logging.d("AccountSetupOutgoing.onCreate():Use Intent restore SetupData! " + bundle);
            if (bundle != null && SetupData.getAccount() == null) {
    ...
    public void onCheckSettingsComplete(int result, int setupMode) {
        if (result == AccountCheckSettingsFragment.CHECK_SETTINGS_OK) {
            if (SetupData.getFlowMode() != SetupData.FLOW_MODE_CHANGE_PASSWORD) {
