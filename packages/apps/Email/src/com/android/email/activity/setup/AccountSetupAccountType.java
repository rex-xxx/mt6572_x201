...
public class AccountSetupAccountType extends AccountSetupActivity implements OnClickListener {
    private static final String DEFAULT_PREFIX_POP3_SERVER = "pop";
    ...
    private void onPop() {
        ...
        String serverName = AccountSettingsUtils.findManualInfoForDomain(this, hostAuth.mAddress,
                HostAuth.SCHEME_POP3);
        if (serverName != null) {
            hostAuth.mAddress = serverName;
        } else {
            hostAuth.mAddress = AccountSettingsUtils.inferServerName(hostAuth.mAddress,
                    DEFAULT_PREFIX_POP3_SERVER, null);
        }
    ...
    private void onImap() {
        ...
        hostAuth.mLogin = hostAuth.mLogin + "@" + hostAuth.mAddress;
        String serverName = AccountSettingsUtils.findManualInfoForDomain(this, hostAuth.mAddress,
                HostAuth.SCHEME_IMAP);
        if (serverName != null) {
            hostAuth.mAddress = serverName;
        } else {
            hostAuth.mAddress = AccountSettingsUtils.inferServerName(
                    hostAuth.mAddress, HostAuth.SCHEME_IMAP, null);
        }
    ...
    private void onExchange() {
        ...
        String serverName = AccountSettingsUtils.findManualInfoForDomain(this, recvAuth.mAddress,
                HostAuth.SCHEME_EAS);
        if (serverName != null) {
            recvAuth.mAddress = serverName;
        }
