...
public class DeleteMessageConfirmationDialog extends DialogFragment
    ...
    public static final String TAG = "DeleteMessageConfirmationDialog";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String messageBody = countMessages > 1 ? res.getQuantityString(
                R.plurals.message_delete_confirm, countMessages) : res
                .getString(R.string.delete_message_confirm);
        b.setTitle(res.getString(R.string.delete_message_dialog_title))
