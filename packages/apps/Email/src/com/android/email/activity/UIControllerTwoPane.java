...
class UIControllerTwoPane extends UIControllerBase implements ThreePaneLayout.Callback {
    ...
    public boolean onCreateOptionsMenu(MenuInflater inflater, Menu menu) {
        ...
        switch (state) {
            case ThreePaneLayout.STATE_LEFT_VISIBLE:
                ...
                // TODO: Check Local Search or Remote Search
    ...
    protected void installMessageListFragment(MessageListFragment fragment) {
        ...
        // TODO: Check Local Search or Remote Search
        mThreePane.setIsSearch(getMessageListFragment().getListContext().isRemoteSearch());
    }
    ...
    public void openInternal(final MessageListContext listContext, final long messageId) {
        ...
        if (messageId != Message.NO_MESSAGE) {
            ...
            mThreePane.showRightPane();
            // TODO: Check Local Search or Remote Search
        } else if (mListContext.isRemoteSearch() 
                && UiUtilities.showTwoPaneSearchResults(mActivity)) {
            mThreePane.showRightPane();
        } else {
    ...
    /**
     * Take the way mobile phone refreshes the mailbox,
     * cause the original behavior (Android) of tablet gots some problems.
     */
    @Override
    protected void onRefresh() {
        if (!isRefreshEnabled()) {
        ...
        if (isMessageListInstalled()) {
            if (mListContext != null && mListContext.isRemoteSearch()) {
                UIControllerTwoPane.this.onSearchSubmit(mListContext.getSearchParams().mFilter,
    ...
    private class ActionBarControllerCallback implements ActionBarController.Callback {
        ...
        public void onSearchSubmit(final String queryTerm, final String queryField) {
            UIControllerTwoPane.this.onSearchSubmit(queryTerm, queryField);
        }
        ...
        public void onLocalSearchSubmit(final String queryTerm, final String queryField) {
            ...
            UIControllerTwoPane.this.onLocalSearchSubmit(queryTerm, queryField);
        }
