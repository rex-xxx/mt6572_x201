...
public class GroupMessagingListener extends MessagingListener {
    ...
    */
    ...
    @Override
    public synchronized void synchronizeEnvelopeFinished(long accountId, long mailboxId) {
        for (MessagingListener l : mListeners) {
    ...
    @Override
    public synchronized void synchronizeMailboxFinished(long accountId, long mailboxId,
