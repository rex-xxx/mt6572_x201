...
public class IOUtils {
    ...
    /**
     * M: Copy bytes from an <code>InputStream</code> to an
     * <code>OutputStream</code>, limit the copy size.
     * @param input
     * @param output
     * @param size
     * @return
     * @throws IOException
     */
    public static int copy(InputStream input, OutputStream output, long size) throws IOException {
        byte[] buffer = new byte[DEFAULT_BUFFER_SIZE];
        long count = 0;
        int n = 0;
