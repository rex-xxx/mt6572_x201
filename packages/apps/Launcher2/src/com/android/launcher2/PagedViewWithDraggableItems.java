...
public abstract class PagedViewWithDraggableItems extends PagedView
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (LauncherLog.DEBUG_MOTION) {
            LauncherLog.d(TAG, "onInterceptTouchEvent: ev = " + ev + ", mTouchState = "
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (LauncherLog.DEBUG_MOTION) {
            LauncherLog.d(TAG, "onTouchEvent ev = " + ev + ",mTouchState = " + mTouchState
                    + ", mIsDragging = " + mIsDragging + ", mIsDragEnabled = " + mIsDragEnabled
    ...
    public boolean onLongClick(View v) {
        if (LauncherLog.DEBUG) {
            LauncherLog.d(TAG, "onLongClick v = " + v + ", v.getTag() = " + v.getTag()
                    ...
                    + ",isAllAppsCustomizeOpen() = " + mLauncher.isAllAppsVisible()
