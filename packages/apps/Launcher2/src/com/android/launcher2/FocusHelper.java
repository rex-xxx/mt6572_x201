...
public class FocusHelper {
    ...
    static boolean handlePagedViewGridLayoutWidgetKeyEvent(PagedViewWidget w, int keyCode,
    	...
    	if (LauncherLog.DEBUG_KEY) {
            LauncherLog.d(TAG, "handlePagedViewGridLayoutWidgetKeyEvent: w = " + w 
            		+ ", keyCode = " + keyCode + ", event = " + e);
        }
    ...
    static boolean handleAppsCustomizeKeyEvent(View v, int keyCode, KeyEvent e) {
        ...
        int countY;
        if (LauncherLog.DEBUG_KEY) {
            LauncherLog.d(TAG, "handleAppsCustomizeKeyEvent: v = " + v + ", keyCode = " + keyCode
                    + ", event = " + e + ", parent = " + v.getParent());
        }
    ...
    static boolean handleHotseatButtonKeyEvent(View v, int keyCode, KeyEvent e, int orientation) {
        if (LauncherLog.DEBUG_KEY) {
            LauncherLog.d(TAG, "handleHotseatButtonKeyEvent: v = " + v + ", tag = " + v.getTag()
                    + ", event = " + e + ", orientation = " + orientation);
        }
    ...
    static boolean handleIconKeyEvent(View v, int keyCode, KeyEvent e) {
        if (LauncherLog.DEBUG_KEY) {
            LauncherLog.d(TAG, "handleIconKeyEvent: v = " + v + ", tag = " + v.getTag()
                    + ", event = " + e);
        }
    ...
    static boolean handleFolderKeyEvent(View v, int keyCode, KeyEvent e) {
        if (LauncherLog.DEBUG_KEY) {
            LauncherLog.d(TAG, "handleFolderKeyEvent: v = " + v + ", event = " + e);
        }
