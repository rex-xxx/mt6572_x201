...
public class DragController {
    ...
    public void forceMoveEvent() {
        if (mDragging) {
            // M: ALPS00583860
            //
            // Don't use mDragObject.x and mDragObject.y. The goal of these two variables isn't
            // clear. Sometimes, they are used to represent the touch event coordination on the drag
            // layer. However, in most cases, they are used to represent the coordination on the
            // drop target, which isn't what we want here.
            //
            // To resolve this issue, we directly pass the mLastTouch, which is the last touch event
            // position on the drag layer.
