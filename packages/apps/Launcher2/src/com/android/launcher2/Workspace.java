...
public class Workspace extends SmoothPagedView
    ...
    */
    ...
    private Bitmap createDragOutline(View v, Canvas canvas, int padding) {
        ...
        final int outlineColor = Launcher.getThemeColor(getResources(), android.R.color.holo_blue_light);
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    private boolean isNeedToDelayRemoveFolderItems(FolderInfo info, HashSet<String> packageNames,
        ...
        if (LauncherLog.DEBUG) {
            LauncherLog.d(TAG, "isNeedToDelayRemoveFolderItems info = " + info + ", packageNames = " + packageNames
    ...
    private int getRemoveFolderItems(FolderInfo info, HashSet<String> packageNames,
        ...
        if (LauncherLog.DEBUG) {
            LauncherLog.d(TAG, "getRemoveFolderItems info = " + info + ", packageNames = " + packageNames
