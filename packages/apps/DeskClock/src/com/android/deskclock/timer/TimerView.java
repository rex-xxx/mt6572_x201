    ...
    protected void onFinishInflate() {
        ...
        if (mSeconds == null) {
            if (mMinutesTens != null) {
                mMinutesTens.setTypeface(sAndroidClockMonoThin);
                mMinutesTens.updatePadding();
            }
            if (mMinutesOnes != null) {
                mMinutesOnes.setTypeface(sAndroidClockMonoThin);
                mMinutesOnes.updatePadding();
            }
        } else {
            mSeconds.setTypeface(sAndroidClockMonoThin);
        }
    }
    ...
    public void setTime(int hoursTensDigit, int hoursOnesDigit, int minutesTensDigit,
        ...
        if (mHoursTens != null) {
            ...
            if (hoursTensDigit == -2) {
                ...
                mHoursTens.setText("-");
                mHoursTens.setTypeface(sAndroidClockMonoThin);
        ...
        if (mHoursOnes != null) {
            if (hoursOnesDigit == -1) {
                mHoursOnes.setText("-");
                mHoursOnes.setTypeface(sAndroidClockMonoThin);
