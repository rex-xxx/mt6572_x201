...
public final class Alarm implements Parcelable {
    ...
    public static class Columns implements BaseColumns {
        ...
        static final String[] ALARM_FULL_QUERY_COLUMNS = {
            _ID, HOUR, MINUTES, DAYS_OF_WEEK, ALARM_TIME,
            ENABLED, VIBRATE, MESSAGE, ALERT, PATH };
        ...
        public static final int ALARM_PATH_INDEX = 9;
    }
    //////////////////////////////
    ...
    public Alarm(Cursor c) {
        ...
        if(Alarms.SUPPORT_SDSWAP){
            path = c.getString(Columns.ALARM_PATH_INDEX);
        }
    ...
    ///M: Creates a default alarm at the current time. @{
    public Alarm(Context context) {
        ...
        if (alert == null) {
            silent = true;
            Log.v("new alarm alert is null then set silent as true");
        }
    }
    /// @}
        ...
        private String toString(Context context, boolean showNever, boolean forAccessibility) {
            ...
            if (mRepeatPreferenceExtension == null) {
                PluginManager<IRepeatPreferenceExtension> pm
                        = PluginManager.<IRepeatPreferenceExtension>create(context,
            ...
            if (mRepeatPreferenceExtension != null
                ...
                if (mDays == 0x1f) {
                    return context.getText(R.string.repeat_weekdays).toString();
                }
            }
            // count selected days
