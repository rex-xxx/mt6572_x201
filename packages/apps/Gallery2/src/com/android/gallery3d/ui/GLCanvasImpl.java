...
public class GLCanvasImpl implements GLCanvas {
    ...
    private static final String TAG = "Gallery2/GLCanvasImp";
    ...
    public void setSize(int x, int y, int width, int height) {
        ...
        gl.glMatrixMode(GL11.GL_PROJECTION);
        gl.glLoadIdentity();
        GLU.gluOrtho2D(gl, x, x + width, y, height);
        ...
        // to match the graphic coordinate system in android, we flip it vertically.
        if (mTargetTexture == null) {
            Matrix.translateM(matrix, 0, 0, tempHeight, 0);
            Matrix.scaleM(matrix, 0, 1, -1, 1);
        }
