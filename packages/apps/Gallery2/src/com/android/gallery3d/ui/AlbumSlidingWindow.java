...
public class AlbumSlidingWindow implements AlbumDataLoader.DataListener {
    ...
    private boolean requestSlotImage(int slotIndex) {
        ...
        /// M: this will overwrite entry.isPanorama, so mask this line.
    ...
    private void prepareSlotContent(int slotIndex) {
        ...
        // M: added for sub-type
        entry.subType = (item == null) ? 0 : item.getSubType();
    ...
    private class ThumbnailLoader extends BitmapLoader  {
        ...
        public void updateEntry() {
            ...
            if (isActiveSlot(mSlotIndex) && mActiveRequestCount == 0) {
                ...
                mDecodeFinishTime = SystemClock.uptimeMillis();
            }
        }
    }
    ...
    public boolean isAllActiveSlotsFilled() {
        ...
        for (int i = start; i < end; ++i) {
            AlbumEntry entry = mData[i & mData.length];
            boolean isLoaded = (entry != null && entry.contentLoader != null && entry.contentLoader.mBitmapLoaded);
            if (!isLoaded) {
                return false;
            }
        }
