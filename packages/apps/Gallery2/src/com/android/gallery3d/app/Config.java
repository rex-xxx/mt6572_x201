...
final class Config {
    ...
    public static class PhotoPage {                                                         
        ...
        public final int mavSeekBarWidthInPortrait;                                     
        public final int mavSeekBarWidthInLandscape;                                    
        ...
        private PhotoPage(Context context) {                                            
            ...
            if(r.getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                mavSeekBarWidthInPortrait = r.getDisplayMetrics().widthPixels / 2;      
                mavSeekBarWidthInLandscape = r.getDisplayMetrics().heightPixels / 3;    
            } else {                                                                    
                mavSeekBarWidthInLandscape = r.getDisplayMetrics().widthPixels / 3;     
                mavSeekBarWidthInPortrait = r.getDisplayMetrics().heightPixels / 2;     
            }                                                                           
        }                                                                               
    }      
