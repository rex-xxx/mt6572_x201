...
public class WidgetDatabaseHelper extends SQLiteOpenHelper {
    private static final String TAG = "Gallery2/PhotoDatabaseHelper";
    ...
    private static final String[] NEW_EXT_PATH_MTK =
        ((StorageManager) MediatekFeature.sContext.getSystemService(Context.STORAGE_SERVICE)).getVolumePaths();
    public static final String EXTERNAL_SDCARD_PATH = (NEW_EXT_PATH_MTK != null && NEW_EXT_PATH_MTK.length > 1)
                                                        ? NEW_EXT_PATH_MTK[1] : null;
