...
public class ImageShow extends View implements OnGestureListener,
    ...
    /// M: while ImageGeometry can not get image ,should use the backUpImage for drawing.
    protected Bitmap backUpImage = null;
    ...
    public void recycleBitmaps() {
        ...
        if (mGeometryOnlyImage != null) {
            mGeometryOnlyImage.recycle();
            mGeometryOnlyImage = null;
        }

        if (mFiltersOnlyImage != null) {
            mFiltersOnlyImage.recycle();
            mFiltersOnlyImage = null;
        }
