 ...
 */
public class MTKVideoView extends VideoView implements ScreenModeListener {
...
//    }
    ...
    public void setResumed(final boolean resume) {
        if (LOG) {
            MtkLog.v(TAG, "setResumed(" + resume + ") mUri=" + mUri + ", mOnResumed=" + mOnResumed);
        }
        mOnResumed = resume;
    }
    ...
    public void resume() {
        if (LOG) {
            MtkLog.v(TAG, "resume() mTargetState=" + mTargetState + ", mCurrentState=" + mCurrentState);
        }
        setResumed(true);
        openVideo();
    }
    ...
    public void suspend() {
        if (LOG) {
            MtkLog.v(TAG, "suspend() mTargetState=" + mTargetState + ", mCurrentState=" + mCurrentState);
        }
        super.suspend();
    }
