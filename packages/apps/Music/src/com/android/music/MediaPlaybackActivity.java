    ...
    public void onResume() {
        ...
        if (MusicFeatureOption.IS_SUPPORT_VOICE_COMMAND_UI && (mVoiceCmdManager != null)) {
            ...
            try {
                ...
                MusicLogUtils.i(TAG, "register voice listener and send commond with RemoteException: " + e);
            } catch (IllegalAccessException e) {
                MusicLogUtils.i(TAG, "register voice listener and send commond with IllegalAccessException: " + e);
            }
        }
        /// @}
        updateTrackInfo();
