...
public final class MusicFeatureOption {
    ...
    static final boolean IS_SUPPORT_VOICE_COMMAND_UI = FeatureOption.MTK_VOICE_UI_SUPPORT;
    static final boolean IS_SUPPORT_SHARED_SDCARD = FeatureOption.MTK_SHARED_SDCARD;
