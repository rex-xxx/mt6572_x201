...
public class DefaultMusicTrackBrowserExtensions extends ContextWrapper implements IMusicTrackBrowser {

    public DefaultMusicTrackBrowserExtensions(Context context) {
        super(context);
    }
