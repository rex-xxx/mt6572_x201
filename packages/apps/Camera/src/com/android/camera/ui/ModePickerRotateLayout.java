...
public class ModePickerRotateLayout extends ViewGroup implements Rotatable {
    private static final String TAG = "ModePickerRotateLayout";
    ...
    public ModePickerRotateLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setOrientation(int orientation, boolean animation) {
        ...
        if (mOrientation != orientation) {
            ...
            Util.setOrientation(mChild, mOrientation, true);
            requestLayout();
        }
    }
}
