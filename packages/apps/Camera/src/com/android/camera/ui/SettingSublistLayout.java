...
public class SettingSublistLayout extends RotateLayout implements
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            //SettingUtils.setEnabledState(convertView, mPreference.isEnabled(position));
            return convertView;
        }
    ...
    public void reloadPreference() {
        ...
        if (LOG) {
            Log.v(TAG, "reloadPreference() mPreference=" + mPreference + ", index=" + index);
        }
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int index, long id) {
        if (LOG) {
            Log.v(TAG, "onItemClick(" + index + ", " + id + ") oldIndex=" + mAdapter.getSelectedIndex());
        }
