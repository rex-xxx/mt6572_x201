...
public class SettingUtils {
    ...
    public static boolean isDisableValue(String value) {
        ...
        if (LOG) {
            Log.v(TAG, "isResetValue(" + value + ") return " + reset);
        }
        return reset;
    }
    ...
    public static String buildEnableList(String[] list, String current) {
        ...
        if (LOG) {
            Log.v(TAG, "buildEnableList(" + current + ") return " + listStr);
        }
        return listStr;
    }
    ...
    public static boolean isBuiltList(String listString) {
        ...
        if (LOG) {
            Log.v(TAG, "isBuiltList(" + listString + ") return " + isList);
        }
        return isList;
    }
...
//        }
//        if (LOG) {
//            Log.v(TAG, "getEnabledArray(" + listString + ") return " + list);
//        }
//        return list;
//    }
    ...
    public static List<String> getEnabledList(String listString) {
        ...
        if (LOG) {
            Log.v(TAG, "getEnabledList(" + listString + ") return " + list);
        }
        return list;
    }
    ...
    public static String getDefaultValue(String listString) {
        ...
        if (LOG) {
            Log.v(TAG, "getDefaultValue(" + listString + ") return " + value);
        }
        return value;
    }
    ...
    public static boolean contains(int[] list, int value) {
        ...
        if (LOG) {
            Log.v(TAG, "contains(" + list + ", " + value + ") return " + find);
        }
        return find; 
    }
    ...
    public static Point getSize(String sizeString) {
        ...
        if (LOG) {
            Log.v(TAG, "getSize(" + sizeString + ") return " + size);
        }
        return size;
    }
    ...
    public static int getMainColor(Context context) {
        ...
        if (LOG) {
            Log.v(TAG, "getMainColor(" + context + ") get " + themeColor + ", return " + finalColor);
        }
        return finalColor;
    }
}
