...
public class Eas {
    ...
    public static final int EAS_SYNC_IDLE = 0;
    public static final int EAS_SYNC_INIT = 1;
    public static final int EAS_SYNC_NORMAL = 2;
    /// M: Just used for the bad sync key recovery
    public static final int EAS_SYNC_RECOVER = 3;
    ...
    /// M: For EAS 2.5 fetch full message body once
