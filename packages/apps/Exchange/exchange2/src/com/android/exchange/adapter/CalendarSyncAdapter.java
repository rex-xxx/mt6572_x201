...
public class CalendarSyncAdapter extends AbstractSyncAdapter {
    ...
    public void wipe() {
        ...
        Uri eventsAsSyncAdapter = asSyncAdapter(Events.CONTENT_URI,
                mAccount.mEmailAddress, Eas.EXCHANGE_ACCOUNT_MANAGER_TYPE);
        mService.mContentResolver.delete(eventsAsSyncAdapter,
                WHERE_CALENDAR_ID, new String[] { Long.toString(mCalendarId) });
