...
public abstract class AbstractSyncAdapter {
    ...
    protected static final String PIM_WINDOW_SIZE = "20";
    /// M: Change from 20 to 10 to break down the duration of batch
    //  insert of Contacts when there are already a lot of contacts
    public static final String CONTACTS_WINDOW_SIZE = "10";
    ...
    // Are there more local changes need to up-sync
    protected boolean mMoreLocalChanges = false;
    ...
    public abstract void sendSyncOptions(Double protocolVersion, Serializer s, int syncStatus)
            throws IOException;
    /**
    ...
    protected void setPimSyncOptions(Double protocolVersion, String filter, Serializer s)
        ...
        /// M: Set Contacts window to 10, just in case, to reduce insert transaction duration
        s.data(Tags.SYNC_WINDOW_SIZE, (filter != null) ?
                PIM_WINDOW_SIZE : CONTACTS_WINDOW_SIZE);
    ...
    public boolean moreLocalChanges() {
        return mMoreLocalChanges;
    }
}
