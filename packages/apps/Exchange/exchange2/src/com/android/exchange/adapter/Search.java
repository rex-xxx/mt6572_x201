...
public class Search {
    ...
    public static int searchMessages(Context context, long accountId, SearchParams searchParams,
        ...
        try {
            ...
            s.data(Tags.BASE_TRUNCATION_SIZE, Eas.EAS12_TRUNCATION_SIZE_PARTIAL);
    ...
    /**
     *  M:This class is just designed for test purpose
     */
    @VisibleForTesting
    public class TestSearchParser extends SearchParser {
        public TestSearchParser(InputStream in, EasSyncService service,
                String query) throws IOException {
            super(in, service, query);
        }
