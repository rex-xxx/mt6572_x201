...
public class RequestTests extends AndroidTestCase {
    ...
    public void testRequestEquals() {
        ...
        // M:Test FetchMailRequest equals
        FetchMailRequest req6 = new FetchMailRequest(1L);
        assertFalse(req6.equals(req5));
        FetchMailRequest req7 = new FetchMailRequest(1L);
        assertTrue(req6.equals(req7));
    }
}