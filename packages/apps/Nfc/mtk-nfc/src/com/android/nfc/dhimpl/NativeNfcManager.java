...
public class NativeNfcManager implements DeviceHost {
    ...
    static {
        // MTK NFC Dynamic TEST code
        try {
            switch(NativeDynamicLoad.queryVersion()) {
                case MTK_NFC_CHIP_TYPE_MSR3110 :
                    Log.d(TAG, "Load MSR3110 jni library.");                    
                    NFC_CONTROLLER_FIRMWARE_FILE_NAME = "/vendor/firmware/MSR3110.BIN";
                    System.loadLibrary("nfc_msr3110_jni");
                    break;
                case MTK_NFC_CHIP_TYPE_MT6605 :
                    Log.d(TAG, "Load MT6605 jni library.");
                    NFC_CONTROLLER_FIRMWARE_FILE_NAME = "/vendor/firmware/libpn544_fw.so";
                    System.loadLibrary("nfc_mt6605_jni");
                    break;
                default :
                    Log.e(TAG, "Unknown Chip. default.");
		    NFC_CONTROLLER_FIRMWARE_FILE_NAME = "/vendor/firmware/MSR3110.BIN";
                    System.loadLibrary("nfc_msr3110_jni");
                    break;
            }
    ...
    public void checkFirmware() {
	    ...
	    Log.d(TAG,"firmware does not update ");
            return;
        }
