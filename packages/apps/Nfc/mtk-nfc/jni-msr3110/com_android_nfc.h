...
#include <opennfc_mock.h>
#endif
}
#include <cutils/properties.h> // for property_get

/* undefined id for uint32_t parameter (f.e. for Secure Elemet slot) */
...
/* Transceive case priority */
typedef enum techListForTransceive
{
	T_NOT_SUPPORT_TYPE = 0,
	T_W_PROP_MIFARE,
	T_W_PROP_MY_D_NFC,
	T_W_PROP_ISO_7816_4_A,
	T_W_PROP_FELICA,
	T_W_PROP_ISO_15693_3,
	T_W_PROP_ISO_7816_4_B,
	T_W_PROP_BPRIME,
	T_W_PROP_ISO_14443_3_B,
	T_W_PROP_ISO_14443_3_A,
	T_W_PROP_ISO_14443_4_B,
	T_W_PROP_ISO_14443_4_A,
	T_W_PROP_NFC_TAG_TYPE_1,
	T_W_PROP_NFC_TAG_TYPE_4_A,
	T_W_PROP_NFC_TAG_TYPE_4_B,
	T_W_PROP_NFC_TAG_TYPE_3,
	T_W_PROP_TOPAZ,
	T_W_INIT
	//T_W_PROP_MY_D_MOVE
} techListForTransceive;
...
const uint8_t  GENERAL_BYTES [] = {(uint8_t)0x42};
#	define	GENERAL_BYTES_LENGTH	1
