            ...
            try {
                ...
                while (running) {
                    ...
                    if (handoverRequestMsg != null) {
                        ...
                        /// M: @ {   
                        Log.d(TAG, "!!!! nfchandover :: Ori BT path.  HandoverManager.tryHandoverRequest not using SNEP on p2plink");
                        /// }

                        NdefMessage resp = null;
            			...
            			if(MtkHandoverManager.BEAM_PLUS_SUPPORT == true)
            	            resp = MtkHandoverManager.getInstance().tryMtkHandoverRequest(handoverRequestMsg);
            			else/// }
            	            resp = mHandoverManager.tryHandoverRequest(handoverRequestMsg);
