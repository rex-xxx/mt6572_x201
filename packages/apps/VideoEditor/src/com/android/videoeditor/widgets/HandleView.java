...
public class HandleView extends ImageView {
    ...
    public void setLimitReached(boolean beginLimitReached, boolean endLimitReached) {
        if (LOG) MtkLog.v(TAG, "setLimitReached(" + beginLimitReached + ", " + endLimitReached + ") this=" + this);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (LOG) MtkLog.v(TAG, "onDraw() mBeginLimitReached=" + mBeginLimitReached + ", mEndLimitReached="
                + mEndLimitReached + ", this=" + this);
    ...
    public void saveVisibility() {
        ...
        if (LOG) MtkLog.v(TAG, "saveVisibility() mLastVisibility=" + mLastVisibility);
    }
    
    public void restoreVisibility() {
        if (LOG) MtkLog.v(TAG, "restoreVisibility() mLastVisibility=" + mLastVisibility);
