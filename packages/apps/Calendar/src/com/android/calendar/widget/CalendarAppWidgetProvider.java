...
public class CalendarAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ///M:add ACTION_TIMEZONE_CHANGED intent-filter,so when time-zone change,it
        ///can update widget.
    ...
    static PendingIntent getLaunchPendingIntentTemplate(Context context) {
        ...
        ///M: change start {AllInOneActivity} to {EventInfoActivity}
        launchIntent.setClass(context, EventInfoActivity.class);
