...
public class GeneralPreferences extends PreferenceFragment implements
    ...
    ///M:mTimezones here cann't be static,because if it static,when
    ///onCreate,it willn't be reLoad resource,so when change language
    ///the timezone's language will not be changed.@{
