...
public class CalendarViewAdapter extends BaseAdapter {
    ...
    private String buildWeekDate() {
        ...
        Time t = new Time(mTimeZone);
        t.set(mMilliTime);
        ///M: Calculate the range start with start day's 9:00 am (or other time)
        /// if start from 0:00, the formatted range will lack 1 day. 
        /// for example: 1.1 0:00 + 24 hours will get the range of 1.1~1.1 not to 1.2 @{
        t.hour = 9;
        t.minute = 0;
        t.second = 0;
        /// @}
