    ...
    public void onPause() {
        ...
        if (listAdapter != null) {
            ...
            if (changes != null && changes.size() > 0) {
                ///M:#isNeedUpdateView# is used to mark whether need to update agenda view.
                ...
                changes.clear();
                ///M:Clean the status, when the statuses has been sync, because there is another entry to modify the sync status.
