...
import com.mediatek.calendar.extension.IAccountExt;
...
//TODO change to something that supports group by queries.
        ///M: #extension# the query should filter out the #PC Sync# account @{
        IAccountExt ext = ExtensionFactory.getAccountExt(this);
        mCursor = ext.accountQuery(PROJECTION);
        ///@}
        if (mCursor == null) {
