...
public class AgendaFragment extends Fragment implements CalendarController.EventHandler,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            ...
            /// M: Get the data to set the deviation of the listView top, will be used in
            //  AgendaWindowAdapter after listView refresh finished. @{
            int[] listTopDeviationInfo = savedInstanceState.getIntArray(BUNDLE_KEY_RESTORE_TOP_DEVIATION);
...
//        mContentResolver.registerContentObserver(Events.CONTENT_URI, true, mObserver);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        /// M: Store the top deviation data to make the rotary smoothly, get it in onCreatView. @{
        int[] listTopDeviationInfo = mAdapter.saveTopDeviation(mTime);
        outState.putIntArray(BUNDLE_KEY_RESTORE_TOP_DEVIATION, listTopDeviationInfo);
        /// @}
