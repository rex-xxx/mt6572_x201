...
public class AlertService extends Service {
    ...
    /**
     * M: NotificationManagerService limitation, max notifications that one
     * package could post is 20, so we should set high priority events max
     * notifications to 18.
     */
    public static final int MAX_NOTIFICATIONS = 18; // 20;
    ...
    static boolean updateAlertNotification(Context context) {
        ...
        if (alertCursor == null || alertCursor.getCount() == 0) {
            ...
            nm.cancelAll();
            /// M: may have some IGNORE state alerts, so should update unread number @{
    ...
    public static boolean generateAlerts(Context context, NotificationMgr nm,
        ...
        /// M: Post unread number again, cause processQuery may fire new alerts @{
        AlertUtils.postUnreadNumber(context);
        /// @}
