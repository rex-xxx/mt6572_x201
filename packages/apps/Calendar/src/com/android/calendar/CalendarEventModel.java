...
public class CalendarEventModel implements Serializable {
    ...
    protected boolean checkOriginalModelFields(CalendarEventModel originalModel) {
        ...
        ///M:#Lunar# if date display method changed, save it.@{
        if (mIsLunar != originalModel.mIsLunar) {
            return false;
        }
        ///@}
    ...
    /**
     * M: #Lunar# whether the event use the lunar date.
     */
    public boolean mIsLunar = false;
    /**
     * M: #PC Sync# the account type, "LOCAL" means PC Sync
     */
