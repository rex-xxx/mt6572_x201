...
//        SearchView.OnCloseListener {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (mInfoFragment == null) {
            ...
            ft.replace(R.id.main_frame, mInfoFragment, EventInfoFragment.FRAGMENT_TAG);
            ft.commit();
        }
...
//    };
    ...
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        /** M: we need to save response when user press 'home' on action bar @{ */
        if (item.getItemId() == android.R.id.home) {
            if (mInfoFragment != null) {
                mInfoFragment.setNeedSaveEvent(true);
            }
        }
        /** @} */
        return super.onOptionsItemSelected(item);
    ...
    public void onBackPressed() {
        /** M: we need to save response when user press 'back' @{ */
        if (mInfoFragment != null) {
            mInfoFragment.setNeedSaveEvent(true);
        }
        /** @} */
