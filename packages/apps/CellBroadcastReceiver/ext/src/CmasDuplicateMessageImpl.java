...
public class CmasDuplicateMessageImpl extends ContextWrapper implements ICmasDuplicateMessage {
    private static final String TAG = "CellBroadcastReceiver/CmasDuplicateMessageImpl";

    public CmasDuplicateMessageImpl(Context context) {
        super(context);
    }
    ...
    public int handleDuplicateMessage(CellBroadcastContentProvider provider,
        ...
        return ICmasDuplicateMessage.NEW_CMAS_PROCESS;
    }
}
