...
public class SearchEngines {
    ...
    public static SearchEngineInfo getSearchEngineInfo(Context context, String name) {
        try {
            ISearchEngineManager searchEngineManger = 
        	    (ISearchEngineManager)context.getSystemService(Context.SEARCH_ENGINE_SERVICE);        	
            return searchEngineManger.getSearchEngineByName(name);
