...
public class AccessibilityPreferencesFragment extends PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        e = findPreference(PreferenceKeys.PREF_FONT_FAMILY);
        
        /// M: Operator Feature for add a preference to set the FontFamily. @{
        mBrowserSmallFeatureEx = Extensions.getSmallFeaturePlugin(getActivity());
        mBrowserSmallFeatureEx.updatePreferenceItemAndSetListener(e, settings.getFontFamily(), this);
        /// @}
    ...
    public boolean onPreferenceChange(Preference pref, Object objValue) {
        ...
        /// M: Operator Feature for update a FontFamily preference. @{
        mBrowserSmallFeatureEx = Extensions.getSmallFeaturePlugin(getActivity());
        mBrowserSmallFeatureEx.updatePreferenceItem(pref, objValue.toString());
        /// @}
        return true;
    }
