...
public class SiteNavigationProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        case WEB_SITES_ID:
            ...
            break;
        default:
            Xlog.e(TAG, "SiteNavigationProvider query Unknown URI: " + uri);
            return null;
        }
    ...
    public int update(Uri uri, ContentValues values, String selection, 
        ...
        case WEB_SITES_ID:
            ...
            break;
        default:
            Xlog.e(TAG, "SiteNavigationProvider update Unknown URI: " + uri);
            return count;
        }
    ...
    private class SiteNavigationDatabaseHelper extends SQLiteOpenHelper {
        ...
        private void initTable(SQLiteDatabase db) {
            ...
            /// M: Operator Feature change the default websites. @{
            mBrowserSmallFeatureEx = Extensions.getSmallFeaturePlugin(mContext);
            if (null == (websites = mBrowserSmallFeatureEx.getPredefinedWebsites())) {
                websites = mContext.getResources().getTextArray(R.array.predefined_websites_default_optr);
            }
            /// @}
            if (websites == null) {
                return;
            ...
            try {
                for (int i = 0; i < websiteSize; i = i + 3) {
                    ...
                    try {
                        ...
                        android.util.Log.e("SiteNavigationProvider", e.getMessage() +
                                ": " + fileName + "not found, use default.");
                    } finally {
                        if (bm == null) {
                            bm = BitmapFactory.decodeResource(mContext.getResources(),
                                    R.raw.sitenavigation_thumbnail_default);
                    ...
                    CharSequence websiteDestination = BrowserProvider2.replaceSystemPropertyInString(
                ...
                Xlog.e(TAG, "initTable: ArrayIndexOutOfBoundsException: " + e);
            }
        }
    }
