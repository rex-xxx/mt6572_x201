...
public class BrowserHistoryPage extends Fragment
    ...
    private OnItemClickListener mGroupItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(
            ...
            //Refer to CR ALPS00247715, we don't want to show the title (Tablet only, doesn't affect Phone's behavior).
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        /// M: Operator Feature Create HistoryPageOptionMenu. @{
        mBrowserSmallFeatureEx = Extensions.getSmallFeaturePlugin(getActivity());
        if (mBrowserSmallFeatureEx.shouldCreateHistoryPageOptionMenu(menu, inflater)) {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        mBrowserSmallFeatureEx = Extensions.getSmallFeaturePlugin(getActivity());
        if (mBrowserSmallFeatureEx.shouldConfigHistoryPageMenuItem(menu, mAdapter == null ? true : false,
                mAdapter.isEmpty())) {
    ...
    private class HistoryAdapter extends DateSortedExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
            ...
            if (data != null) {
                ...
                /// M: here need set the default image for initial.
