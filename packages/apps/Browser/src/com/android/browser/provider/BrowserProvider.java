...
public class BrowserProvider extends ContentProvider {
    ...
    static final String[] TABLE_NAMES = new String[] {
        "bookmarks", "searches", "bookmark_folders"
    };
    ...
    static final int URI_MATCH_BOOKMARK_FOLDERS = 2;
    ...
    /// M: add for feature bookmark folders
    private static final int URI_MATCH_BOOKMARK_FOLDERS_ID = 12;
    //
    ...
    static {
        ...
        /// M: add for feature bookmark folders @{
        URI_MATCHER.addURI("browser", TABLE_NAMES[URI_MATCH_BOOKMARK_FOLDERS],
                URI_MATCH_BOOKMARK_FOLDERS);
        URI_MATCHER.addURI("browser", TABLE_NAMES[URI_MATCH_BOOKMARK_FOLDERS] + "/#",
                URI_MATCH_BOOKMARK_FOLDERS_ID);
        /// @}
