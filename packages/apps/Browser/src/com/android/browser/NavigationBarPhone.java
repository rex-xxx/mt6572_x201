...
public class NavigationBarPhone extends NavigationBarBase implements
    ...
    private static IBrowserSmallFeatureEx mBrowserSmallFeatureEx = null;
    ...
    public void onFocusChange(View view, boolean hasFocus) {
        if (view == mUrlInput) {
            ...
            mBrowserSmallFeatureEx = Extensions.getSmallFeaturePlugin(mUiController.getActivity());
            if (mBrowserSmallFeatureEx.shouldOverrideFocusContent()) {
                Tab activeTab = mBaseUi.getActiveTab();
                if (activeTab == null) {
                    activeTab = mBaseUi.mTabControl.getCurrentTab();
                }
                if (activeTab != null) {
                    final String url = activeTab.getUrl();
                    if (hasFocus) {
                        ...
                        setDisplayTitle(activeTab.getTitle());
                    }
                }
            } else {
