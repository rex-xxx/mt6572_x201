...
import com.android.browser.TabControl.OnTabCountChangedListener;
...
public class PhoneUi extends BaseUi {
    ...
    public void onActionModeFinished(boolean inLoad) {
        if (isEditingUrl()) {
            final ObjectAnimator anim1 = ObjectAnimator.ofFloat(mTitleBar, "y", mActionBarHeight, 0).setDuration(100);
