...
public interface UI {
    ...
    /// M: add for voice @{
    void showVoiceTitleBar(String title, List<String> results);

    void revertVoiceTitleBar(Tab tab);
    /// @}
    ...
    void updateBottomBarState(boolean pageCanScroll, boolean back, boolean forward);
}
