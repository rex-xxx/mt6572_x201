...
public interface PreferenceKeys {
    ...
    /// M: Add font family
    String PREF_FONT_FAMILY = "font_family";
    ...
    static final String KEY_WEB_NOTIFICATION = "pref_content_webnotification";
    static final String KEY_NOTIFICATION_STATE = "notification_state";
    static final String PREF_PRIVACY_CLEAR_NOTIFICATION = "privacy_clear_notification";
