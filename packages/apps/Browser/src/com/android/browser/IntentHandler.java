...
public class IntentHandler {
    ...
    private static final String XLOGTAG = "browser/IntentHandler";
    ...
    private static boolean handleWebSearchRequest(Activity activity,
        ...
        /// M: Operator Feature check whether need to change to the wap browser @{
        sBrowserSmallFeatureEx = Extensions.getSmallFeaturePlugin(activity);
        if (sBrowserSmallFeatureEx.shouldTransferToWapBrowser()) {
            return isTransferToWapBrowser(activity, url, searchEngine);
        }
        /// @}
        return true;
    }

    private static boolean isTransferToWapBrowser(Activity activity, String url,
