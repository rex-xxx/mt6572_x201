...
public class HomeProvider extends ContentProvider {
    ...
    /**
     * M: If url is content://com.android.browser.site_navigation, return site navigation.
     */
    public static WebResourceResponse shouldInterceptRequest(Context context,
            String url) {
        try {
            if (url.equals("content://com.android.browser.site_navigation/websites") ||
                url.equals("content://com.android.browser.home/")) {
