...
public class Config {
    ...
    /**
     * M: Get the limited count of shortcuts when only show shortcuts.
     * @return limited count of shortcuts
     */
    public int getShortcutsOnlyLimitedCount() {
        return mContext.getResources().getInteger(R.integer.shortcuts_only_limited);
    }
}
