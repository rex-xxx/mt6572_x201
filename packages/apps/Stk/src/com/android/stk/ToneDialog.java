...
public class ToneDialog extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (settings.vibrate && mVibrator != null) {
            ...
            CatLog.d(this, "onCreate - settings.vibrate = " + settings.vibrate);
            CatLog.d(this, "onCreate - mVibrator is null " + (mVibrator == null));
        }
    ...
    private class AirplaneBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
                // do not care about whether enable areplane mode or not, just
                // finish the screen.
