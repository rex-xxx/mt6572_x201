...
public class MmsDialogNotifyImpl extends ContextWrapper implements IMmsDialogNotify {

    private static final String TAG = "Mms/MmsDialogNotifyImpl";

    public MmsDialogNotifyImpl(Context context) {
        super(context);
    }

    public void notifyNewSmsDialog(Uri msgUri) {
        MmsLog.d(TAG, "notifyNewSmsDialog:" + msgUri.toString());
    ...
    public void closeMsgDialog() {
        MmsLog.d(TAG, "MmsDialogNotifyExt.closeMsgDialog");
        Context context = this; //getApplicationContext();
        Context test = getApplicationContext();
        if (test == null) {
            MmsLog.d(TAG, "test null");
        }
    ...
    private List<String> getHomes(Context context) {
        MmsLog.d(TAG, "SmsReceiverService.getHomes");
