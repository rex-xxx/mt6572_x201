...
public class MmsTextSizeAdjustImpl extends ContextWrapper implements IMmsTextSizeAdjust {
    
    private IMmsTextSizeAdjustHost mHost = null;      
    
    public MmsTextSizeAdjustImpl(Context context) {
        super(context);
    }
   ...
   /**
    ...
    public IMmsTextSizeAdjustHost getHost() {
        return mHost;
    }
