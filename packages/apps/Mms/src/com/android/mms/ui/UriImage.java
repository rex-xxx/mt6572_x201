...
public class UriImage {
    ...
    private void initFromFile(Context context, Uri uri) {
        ...
        MmsLog.i(TAG, "ImageModel got file path: " + mPath);
        MmsLog.i(TAG, "ImageModel got file extension: " + extension);
        ...
        if (mContentType == null && extension.equals("dcf")) {
            ...
            MmsLog.i(TAG, "ImageModel got drm content, mContentType: " + mContentType);
        }
        /// @}
    ...
    private void buildSrcFromPath() {
        ...
        // before saveDraft @{
        File mTempFile = EncapsulatedStorageManager.getExternalCacheDir(mContextTemp.getPackageName());
    ...
    public static byte[] getResizedImageData(int width, int height,
        ...
        /// @}
            ...
            Log.v(TAG, "getResizedImageData: Uri = " + uri + " wlimit=" + widthLimit +
        ...
        /// @}
                    ...
                    Log.v(TAG, "getResizedImageData:  attempt=" + attempts
