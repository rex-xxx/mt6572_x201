...
public class PduBodyCache {
    private static final String TAG = "Mms/PduBodyCache";
    ...
    public static PduBody getPduBody(Context context, long msgid) {
        return getPduBody(context, ContentUris.withAppendedId(Mms.CONTENT_URI, msgid));
    }
