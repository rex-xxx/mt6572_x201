...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    public final CharSequence convertToString(Cursor cursor) {
        ...
        String nameAndNumber = Contact.formatNameAndNumber(
                name, number, cursor.getString(NORMALIZED_NUMBER));
    ...
    public final void bindView(View view, Context context, Cursor cursor) {
        ...
        String numberString = PhoneNumberUtils.formatNumber(cursor.getString(NUMBER_INDEX),
        ...
        QuickContactDivot avatar = (QuickContactDivot) view.findViewById(R.id.avatar);
        updateAvatarView(context, numberString, avatar, contactId);
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        ...
        //no need to query if constraint is null
        if(constraint == null){
            return null;
        }
        /// @}
    ...
    /// M:
    private void updateAvatarView(Context context, String addr, QuickContactDivot avatar, long contactId) {
        ...
        if (contactId > 0) {
            ...
            if (data != null) {
                ...
                avatarDrawable = new BitmapDrawable(context.getResources(), b);
            } else {
                avatarDrawable = context.getResources().getDrawable(R.drawable.ic_contact_picture); // default avatar
            }
        } else {
            avatarDrawable = context.getResources().getDrawable(R.drawable.ic_contact_picture); // default avatar
        }
