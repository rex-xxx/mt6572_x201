...
public class CBMessagingNotification {
    ...
    private static final Uri URL_MESSAGES = EncapsulatedTelephony.SmsCb.CONTENT_URI;
    
    // This must be consistent with the column constants below.
    private static final String[] CB_STATUS_PROJECTION = new String[] {
            EncapsulatedTelephony.SmsCb.THREAD_ID, EncapsulatedTelephony.SmsCb.DATE,
            EncapsulatedTelephony.SmsCb.CHANNEL_ID, EncapsulatedTelephony.SmsCb.BODY, EncapsulatedTelephony.SmsCb._ID };
    ...
    private static final String NEW_INCOMING_SM_CONSTRAINT =
            "(" + EncapsulatedTelephony.SmsCb.SEEN + " = 0)";
    ...
    public static final CBNotificationInfo getCBNewMessageNotificationInfoBase(
        ...
        try {
            ...
            String address;
            if (isForGemini == false) {
                address = CBMessage.getCBChannelName(channelId);
            } else {
                address = CBMessage.getCBChannelNameGemini(channelId, simId);
            }
    ...
    private static void updateNotification(
        ...
        appNotificationEnabled = sp.getBoolean(NotificationPreferenceActivity.NOTIFICATION_ENABLED, true);
    ...
    private static int getUndeliveredMessageCount(Context context, long[] threadIdResult) {
        Cursor undeliveredCursor = SqliteWrapper.query(context, context.getContentResolver(),
                URL_MESSAGES, new String[] { EncapsulatedTelephony.SmsCb.THREAD_ID }, "read=0", null, null);
