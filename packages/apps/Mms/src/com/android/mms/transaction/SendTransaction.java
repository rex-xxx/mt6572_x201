...
public class SendTransaction extends Transaction implements Runnable {
    ...
    /// M:Code analyze 001,add for useless,new members @{
    ...
    public void run() {
        /// M:
        MmsLog.d(MmsApp.TXN_TAG, "SendTransaction: run");
        try {
            ...
            /// M:Code analyze 002,set all from part as insert-address-token in default @{
            ...
            if (conf == null) {
                /// M:Code analyze 003, change to Xlog @{
                MmsLog.e(MmsApp.TXN_TAG, "No M-Send.conf received.");
                /// @}
            }
            ...
            if (!Arrays.equals(reqId, confId)) {
                /// M:Code analyze 004, change to Xlog @{
                MmsLog.w(MmsApp.TXN_TAG, "Inconsistent Transaction-ID: req="
            ...
            /// M:Code analzye 005, add for gemini,store simId info into corresponding key value @{
            ...
            if (respStatus != PduHeaders.RESPONSE_STATUS_OK) {
                SqliteWrapper.update(mContext, mContext.getContentResolver(),
                                     mSendReqURI, values, null, null);
                /// M:Code analyze 006, change to Xlog @{
                MmsLog.w(MmsApp.TXN_TAG, "Server returned an error code: " + respStatus);
                /// @}
                return;
            }
            ...
            if (mTransactionState.getState() != TransactionState.SUCCESS) {
                ...
                /// M:Code analyze 007, change log to Xlog @{
                MmsLog.e(MmsApp.TXN_TAG, "Delivery failed.");
                /// @}
            }
            /// M:Code analyze 001,add for useless,new members @{
            sMMSSent = true;
    ...
    /// M:Code analyze 008, new constructor methods,add a simId info parameter for gemini @{
    public SendTransaction(Context context,
    ...
    /// M:Code analyze 009,aim to get uri of sendTransaction @{
