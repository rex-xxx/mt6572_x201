...
public class VideoModel extends RegionMediaModel {
    ...
    public void initFromFile(Uri uri) throws MmsException {
        ...
        /// M: Code analyze 004, fix bug ALPS00069048 79872, drm support,
        /// resolve JNE and set default when mContenType==null @{
        ...
        if (c != null) {
            try {
                if (c.moveToFirst()) {
                    ...
                    if (mContentType.equals(EncapsulatedContentType.VIDEO_MP4) && !(TextUtils.isEmpty(mSrc))) {
                        ...
                        if (index != -1) {
                            try {
                                ...
                                if (!(TextUtils.isEmpty(extension)) &&
                                    ...
                                    mContentType = EncapsulatedContentType.VIDEO_3GPP;
                                }
