...
public class SlideModel extends Model implements List<MediaModel>, EventListener {
    ...
    private void internalAdd(MediaModel media) throws IllegalStateException {
        ...
        if (media.isText()) {
            ...
            if (TextUtils.isEmpty(contentType) || EncapsulatedContentType.TEXT_PLAIN.equals(contentType)
                    || EncapsulatedContentType.TEXT_HTML.equals(contentType)) {
    ...
    public void updateDuration(int duration) {
        ...
        /// M: Code analyze 005, new feature, set real mediafile duration, not DEFAULT_SLIDE_DURATION @{
        mDuration = duration; // > DEFAULT_SLIDE_DURATION ? duration : DEFAULT_SLIDE_DURATION;
        /// @}
    }
