...
public interface ContentRestriction {
    ...
    /// M: Code analyze 001, For new feature, Add vCard FileAttachment ContentType check method @{
    /// M: add for vCard
    void checkFileAttachmentContentType(String contentType) throws ContentRestrictionException;
    /// @}
}
