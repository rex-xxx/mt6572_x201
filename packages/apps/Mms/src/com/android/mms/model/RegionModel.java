...
public class RegionModel extends Model {
    ...
    /// M: Code analyze 001, fix bug ALPS00267318, print log about RegionModel argument @{
    @Override
    public String toString() {
        return "RegionModel [" + "mRegionId=" + mRegionId + ", mLeft=" + mLeft + ", mTop=" + mTop + ", mWidth=" + mWidth
                + ", mHeight=" + mHeight + ", mFit=" + mFit + ", mBackgroundColor=" + mBackgroundColor + "]";
    }
    /// @}
}
