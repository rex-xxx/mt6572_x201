...
public class LogTag {
    ...
    /// M:
    public static final String CB = "Mms/Cb";
    ...
    private static String logFormat(String format, Object... args) {
        ...
        String s = "";
        /// M: fix bug ALPS00511076
        try {
            s = String.format(format, args);
        } catch (MissingFormatArgumentException e) {
            // TODO: handle exception
            Log.d(TAG, "String.format catch MissingFormatArgumentException");
        }
            ...
            activity.runOnUiThread(new Runnable() {
                public void run() {
                    new AlertDialog.Builder(activity)
                        /// M: change setIcon to setIconAttribute, and with different res
