...
import com.mediatek.encapsulation.com.mediatek.pushparser.co.CoMessage;
import com.mediatek.encapsulation.com.mediatek.pushparser.si.SiMessage;
import com.mediatek.encapsulation.com.mediatek.pushparser.sl.SlMessage;
...
public abstract class WapPushManager  {
    ...
    public static WapPushManager createManager(Context context,String type){
        ...
        if(type.equals(SiMessage.TYPE)){
            ...
            MmsLog.e(TAG,"createManager: wrong type!" + type);
        }
