...
import com.mediatek.encapsulation.com.mediatek.pushparser.si.SiMessage;
...
public class SiManager extends WapPushManager {
    ...
    public void handleIncoming(ParsedMessage message) {
         ...
         * 
         */
         String []projection = {WapPush._ID,WapPush.SIID,WapPush.URL,WapPush.CREATE, WapPush.ADDR, WapPush.TEXT, WapPush.SIM_ID};
         String selection = WapPush.SIID + "=?" + " AND " + WapPush.SIM_ID + "=?";
         String []selectionArgs = {siMsg.siid, Integer.toString(siMsg.getSimId())};
