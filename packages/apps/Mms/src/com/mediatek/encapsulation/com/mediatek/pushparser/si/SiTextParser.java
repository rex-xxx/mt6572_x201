...
package com.mediatek.encapsulation.com.mediatek.pushparser.si;
...
import static com.mediatek.encapsulation.com.mediatek.pushparser.si.SiMessage.*;
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if(SI.equalsIgnoreCase(name)){
                            ...
                            if(siMsg != null){
                                ...
                                siMsg.create = SiDateDecoderUtil.XmlDateDecoder(pxmlPullParser.getAttributeValue(uri, "created"));
                                siMsg.expiration = SiDateDecoderUtil.XmlDateDecoder(pxmlPullParser.getAttributeValue(uri, "si-expires"));
