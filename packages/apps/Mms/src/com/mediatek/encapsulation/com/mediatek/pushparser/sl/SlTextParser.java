...
package com.mediatek.encapsulation.com.mediatek.pushparser.sl;
...
import static com.mediatek.encapsulation.com.mediatek.pushparser.sl.SlMessage.*;
                ...
                switch (eventType){
                    case XmlPullParser.START_TAG:
                        ...
                        if (SL.equalsIgnoreCase(name)){
                            ...
                            uri = xmlPullParser.getNamespace();
                            
                            slMsg = new SlMessage(SlMessage.TYPE);
                            slMsg.url = xmlPullParser.getAttributeValue(uri, "href");
                            String action = xmlPullParser.getAttributeValue(uri, "action");
