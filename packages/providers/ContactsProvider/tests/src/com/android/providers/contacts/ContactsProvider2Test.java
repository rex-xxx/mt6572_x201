...
public class ContactsProvider2Test extends BaseContactsProvider2Test {
    ...
    public void testRawContactsProjection() {
        assertProjection(RawContacts.CONTENT_URI, new String[]{
                ...
                RawContacts.TIMESTAMP,
                RawContacts.IS_SDN_CONTACT,
                RawContacts.SEND_TO_VOICEMAIL_VT,
                RawContacts.SEND_TO_VOICEMAIL_SIP,
                /// @}
        });
    }
    ...
    public void testPhoneLookupProjection() {
        assertProjection(PhoneLookup.CONTENT_FILTER_URI.buildUpon().appendPath("123").build(),
            new String[]{
                ...
                /// M: @{
                PhoneLookup.SEND_TO_VOICEMAIL_VT,
                PhoneLookup.SEND_TO_VOICEMAIL_SIP,
                PhoneLookup.INDICATE_PHONE_SIM,
                PhoneLookup.INDEX_IN_SIM,
                PhoneLookup.FILTER,
    ...
    */
    ...
    public void testMissingAccountTypeParameter() {
        ...
        Cursor cursor = null;
        try {
            cursor = mResolver.query(queryUri, null, null, null, null);
