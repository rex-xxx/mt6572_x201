...
public class CallLogProviderTest extends BaseContactsProvider2Test {
    ...
    public void testCallLogFilter() {
        ...
        filterUri = Uri.parse("content://call_log/calls/search_filter/" + "1-888-4664-411");
        c = mResolver.query(filterUri, null, null, null, null);
        assertEquals(0, c.getCount());
        c.close();

        filterUri = Uri.parse("content://call_log/callsjoindataview");
        c = mResolver.query(filterUri, null, null, null, null);
        assertEquals(1, c.getCount());
        c.close();

        filterUri = Uri.parse("content://call_log/callsjoindataview/" + "1");
        c = mResolver.query(filterUri, null, null, null, null);
        assertEquals(1, c.getCount());
        c.close();
    }
    ...
    */
    ...
    /// M: Comment out by mediatek @{
    /// Do not support voicemail
    /*
