...
public class ContactsDatabaseHelper extends SQLiteOpenHelper {
     ...
     */
    /**
     * M: Android update from 4.2_r1 to 4.2.2
     * 4.2_r1 version: 705
     * 4.2.2 version: 706
     * Original Code:
     * static final int DATABASE_VERSION = 706;
     * 
     * MTK version is upgraded from 747 to 748 correspondingly
     * @{
     */
     static final int DATABASE_VERSION = 748;
    /** @} */
    ...
    public interface Tables {
        ...
        // * ALPS00251330 Descriptions:
        // *
        // +"("
        // + "raw_contacts.account_name IS NULL AND "
        // + "settings.account_name = 'Phone' AND "
        // + "raw_contacts.account_type IS NULL AND "
        // + "settings.account_type = 'Local Phone Account'"
        // + ") OR "
        // *
        ...
        // + "LEFT OUTER JOIN groups ON (groups._id = data." +
                ...
                + "LEFT OUTER JOIN " + Tables.SETTINGS + " ON ("
                    ...
                    + " ("
                        ...
                        + SettingsColumns.CONCRETE_ACCOUNT_NAME + " = '" 
                            + ContactsProvider2.ACCOUNT_NAME_LOCAL_PHONE + "' AND "
                        + AccountsColumns.CONCRETE_ACCOUNT_TYPE + " IS NULL AND "
                        + SettingsColumns.CONCRETE_ACCOUNT_TYPE + " = '" 
                            + ContactsProvider2.ACCOUNT_TYPE_LOCAL_PHONE + "'"
                    + " ) OR "
                    /** @} */
    ...
    public interface Joins {
         ...
         *   Original Android's code:
         *   
         *   public static final String GROUP_MEMBER_COUNT_1 =
        ...
        public static final String GROUP_MEMBER_COUNT =
                " LEFT OUTER JOIN (SELECT "
                    + "data1 AS member_count_group_id, "
                    //+ "COUNT(raw_contact_id) AS group_member_count "
                    + "COUNT(distinct contact_id) AS group_member_count "
                + "FROM view_data "
                    + "WHERE "
    ...
    public interface ContactsColumns {
        ...
        /// M: @{
        public static final String CONCRETE_INDICATE_PHONE_SIM = Tables.CONTACTS + "."
                + Contacts.INDICATE_PHONE_SIM;
        public static final String CONCRETE_INDEX_IN_SIM = Tables.CONTACTS + "."
                + Contacts.INDEX_IN_SIM;
        public static final String CONCRETE_SEND_TO_VOICEMAIL_VT = Tables.CONTACTS
                + "." + Contacts.SEND_TO_VOICEMAIL_VT;
        public static final String CONCRETE_SEND_TO_VOICEMAIL_SIP = Tables.CONTACTS
                + "." + Contacts.SEND_TO_VOICEMAIL_SIP;
        public static final String CONCRETE_FILTER = Tables.CONTACTS
                + "." + Contacts.FILTER;
        public static final String CONCRETE_IS_SDN_CONTACT = Tables.CONTACTS   // add by MTK
                + "." + Contacts.IS_SDN_CONTACT;                      // add by MTK
        /// @}
    }
    ...
    public interface RawContactsColumns {
        ...
        public static final String CONCRETE_TIMESTAMP =
                Tables.RAW_CONTACTS + "." + RawContacts.TIMESTAMP;  //add by MTK      
        ...
        /// M: @{
        public static final String INDICATE_PHONE_SIM = 
                Tables.RAW_CONTACTS + "." + RawContacts.INDICATE_PHONE_SIM;
        public static final String INDEX_IN_SIM = 
                Tables.RAW_CONTACTS + "." + RawContacts.INDEX_IN_SIM;
        
        public static final String IS_SDN_CONTACT =                      // add by MTK
                Tables.RAW_CONTACTS + "." + RawContacts.IS_SDN_CONTACT;  // add by MTK
        /// @}
    }
    ...
    public interface DataColumns {
        ...
        /// M: @{
        public static final String CONCRETE_SIM_ID = Tables.DATA + "."
                + Data.SIM_ASSOCIATION_ID;
        public static final String CONCRETE_IS_ADDITIONAL_NUMBER = 
                Tables.DATA + "." + Data.IS_ADDITIONAL_NUMBER;
        /// @}
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Tables.CONTACTS + " (" +
                ...
                Contacts.SEND_TO_VOICEMAIL_VT + " INTEGER NOT NULL DEFAULT 0," +    //add by MTK
                Contacts.SEND_TO_VOICEMAIL_SIP + " INTEGER NOT NULL DEFAULT 0," +   //add by MTK
                ...
                Contacts.INDICATE_PHONE_SIM + " INTEGER NOT NULL DEFAULT -1," + //add by MTK
                Contacts.INDEX_IN_SIM + " INTEGER NOT NULL DEFAULT -1," +       //add by MTK
                Contacts.FILTER + " INTEGER NOT NULL DEFAULT 0," +              //add by MTK
                ContactsColumns.LAST_STATUS_UPDATE_ID + " INTEGER REFERENCES data(_id)" +
                "," + Contacts.IS_SDN_CONTACT + " INTEGER NOT NULL DEFAULT 0" +  // add by MTK
        ");");
        ...
        db.execSQL("CREATE TABLE " + Tables.RAW_CONTACTS + " (" +
                ...
                RawContacts.TIMESTAMP + " INTEGER," +                               //add by MTK
                ...
                RawContacts.SEND_TO_VOICEMAIL_VT + " INTEGER NOT NULL DEFAULT 0," + // add by MTK
...
//        ");");
        ...
        db.execSQL("CREATE TABLE " + Tables.DATA + " (" +
                ...
                Data.SYNC3 + " TEXT, " +
                Data.SYNC4 + " TEXT, " +
                Data.SIM_ASSOCIATION_ID + " INTEGER NOT NULL DEFAULT -1, " +    //add by MTK
                Data.IS_ADDITIONAL_NUMBER + " INTEGER NOT NULL DEFAULT 0 " +    //add by MTK
        ");");
        ...
        db.execSQL("CREATE TABLE " + Tables.CALLS + " (" +
                ...
                Calls.SIM_ID + " INTEGER DEFAULT -1," +             //add by MTK
                Calls.VTCALL + " INTEGER DEFAULT -1," +             //add by MTK
                Calls.RAW_CONTACT_ID + " INTEGER DEFAULT NULL," +   //add by MTK
                Calls.DATA_ID + " INTEGER DEFAULT NULL," +           //add by MTK
                Calls.IP_PREFIX +  " TEXT" +                         //add by MTK
        ");");
         ...
         * @{
         */
        createContactsTriggersEx(db);
        createDialerSearchView(db);
        /*
         * @}
         */
    ...
    private void createContactsTriggers(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TRIGGER " + Tables.RAW_CONTACTS + "_marked_deleted "
                ...
                +         RawContacts.TIMESTAMP + "=" + "strftime(\"%s\", 'now') * 1000"   //add by MTK
    ...
    private void createContactsViews(SQLiteDatabase db) {
        ...
        String dataColumns =
                ...
                + Data.SYNC3 + ", "
                + Data.SYNC4 + ", "
                + Data.SIM_ASSOCIATION_ID + ", "    // add by MTK
                + Data.IS_ADDITIONAL_NUMBER         // add by MTK
                ;
        ...
        String syncColumns =
                ...
                + RawContactsColumns.CONCRETE_TIMESTAMP + " AS " + RawContacts.TIMESTAMP + ","    //add by MTK
        ...
        String contactOptionColumns =
                ...
                + ContactsColumns.CONCRETE_SEND_TO_VOICEMAIL_VT             // add by MTK
                        + " AS " + RawContacts.SEND_TO_VOICEMAIL_VT + ","   // add by MTK
                + ContactsColumns.CONCRETE_SEND_TO_VOICEMAIL_SIP            // add by MTK
                        + " AS " + RawContacts.SEND_TO_VOICEMAIL_SIP        // add by MTK
                ;
        ...
        String contactNameColumns =
                ...
                + "name_raw_contact." + RawContacts.INDICATE_PHONE_SIM  //add by MTK
                        + " AS " + Contacts.INDICATE_PHONE_SIM + ", "   //add by MTK
                + "name_raw_contact." + RawContacts.INDEX_IN_SIM        //add by MTK
                        + " AS " + Contacts.INDEX_IN_SIM                //add by MTK
                + ", " + "name_raw_contact." + RawContacts.IS_SDN_CONTACT      // add by MTK
                        + " AS " + Contacts.IS_SDN_CONTACT              // add by MTK
                ;
        ...
        String rawContactOptionColumns =
                ...
                + RawContacts.STARRED + ","
                + RawContacts.SEND_TO_VOICEMAIL_VT + ", "   //add by MTK
                + RawContacts.SEND_TO_VOICEMAIL_SIP         //add by MTK
                ;
        ...
        String rawContactsSelect = "SELECT "
                ...
                + RawContacts.SORT_KEY_ALTERNATIVE + ", "
                + dbForProfile() + " AS " + RawContacts.RAW_CONTACT_IS_USER_PROFILE + ", "
                + RawContacts.INDICATE_PHONE_SIM + ", "     //add by MTK
                + RawContacts.INDEX_IN_SIM + ", "           //add by MTK
                + rawContactOptionColumns + ", "
                + syncColumns
                + ", " + RawContacts.IS_SDN_CONTACT  // add by MTK
                + " FROM " + Tables.RAW_CONTACTS
                + " JOIN " + Tables.ACCOUNTS + " ON ("
                +   RawContactsColumns.CONCRETE_ACCOUNT_ID + "=" + AccountsColumns.CONCRETE_ID
                    + ")";
        ...
        String contactsColumns =
                ...
                + ContactsColumns.CONCRETE_FILTER                       //add by MTK
                        + " AS " + Contacts.FILTER + ", "               //add by MTK
                + ContactsColumns.CONCRETE_SEND_TO_VOICEMAIL_VT         //add by MTK
                        + " AS " + Contacts.SEND_TO_VOICEMAIL_VT + ", " //add by MTK
                + ContactsColumns.CONCRETE_SEND_TO_VOICEMAIL_SIP        //add by MTK
                        + " AS " + Contacts.SEND_TO_VOICEMAIL_SIP       //add by MTK
                //+ ", " + Contacts.IS_SDN_CONTACT                      // add by MTK
                ;
        ...
        String rawEntitiesSelect = "SELECT "
                ...
                + dbForProfile() + " AS " + RawContacts.RAW_CONTACT_IS_USER_PROFILE + ","
                + Tables.GROUPS + "." + Groups.SOURCE_ID + " AS " + GroupMembership.GROUP_SOURCE_ID + ", "
                + RawContactsColumns.INDICATE_PHONE_SIM + " AS " + RawContacts.INDICATE_PHONE_SIM + ", "
                + RawContactsColumns.INDEX_IN_SIM + " AS " + RawContacts.INDEX_IN_SIM
                + ", " + RawContactsColumns.IS_SDN_CONTACT + " AS " + RawContacts.IS_SDN_CONTACT  // add by MTK
                + " FROM " + Tables.RAW_CONTACTS
                + " JOIN " + Tables.ACCOUNTS + " ON ("
                +   RawContactsColumns.CONCRETE_ACCOUNT_ID + "=" + AccountsColumns.CONCRETE_ID
                    + ")"
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        /// M: process sim contacts when upgrading.
        boolean upgradeDeleteSimContacts = false;
        ...
        /// M: @{
        if (oldVersion < 666) {
            upgradeToVersion666(db);
            upgradeViewsAndTriggers = true;
            oldVersion = 666;
        }

        if (oldVersion < 667) {
            Log.d(TAG, "SDN and IP prefix upgrade: oldVersion = " + oldVersion);
            upgradeToVersion667(db);
            upgradeViewsAndTriggers = true;
            oldVersion = 667;
        }
        
        if (oldVersion < 668) {
            /// M: Mapping andorid default version is 626
        ...
        /// M: database adjustment @{
        if (oldVersion < 745) {
            upgradeViewsAndTriggers = true;
            upgradeDeleteSimContacts = true;
            oldVersion = 745;
        }
        ///@}

        /** M: SNSOne removed from all branches, but in order to confirm
        database upgrade successfully, it should reserve this code @{ */
        if (oldVersion < 746) {
            oldVersion = 746;
        }
        /** @} */
        ...
        /**
         * M: Android update from 4.2_r1 to 4.2.2
         * Original 4.2_r1 version is 706
         * do the same thing as 705 -> 706
         * @{
         */
        if (oldVersion < 748) {
            rebuildSqliteStats = true;
        ...
        if (upgradeDeleteSimContacts) {
            upgradeDeleteAllSimData(db);
        }
    ...
    /// M: @{
    private void upgradeToVersion666(SQLiteDatabase db) {
        db.execSQL("UPDATE groups SET "
                + " account_type='Local Phone Account', system_id=null, group_is_read_only=0 "
                + " WHERE account_name='Phone' AND account_type='DeviceOnly';");

        db.execSQL("UPDATE calls SET data_id=null, raw_contact_id=null WHERE raw_contact_id IN " +
                " (SELECT _id FROM raw_contacts WHERE " + RawContacts.INDICATE_PHONE_SIM + ">0)");

        db.execSQL("DELETE FROM dialer_search WHERE raw_contact_id IN " +
                " (SELECT _id FROM raw_contacts WHERE " + RawContacts.INDICATE_PHONE_SIM + ">0)");

        db.execSQL("DELETE FROM raw_contacts WHERE " + RawContacts.INDICATE_PHONE_SIM + ">0");

        db.execSQL("UPDATE raw_contacts SET "
                + RawContacts.ACCOUNT_NAME + "='Phone', "
                + RawContacts.ACCOUNT_TYPE + "='Local Phone Account' "
                + " WHERE ("
                + RawContacts.ACCOUNT_NAME + " IS NULL OR " + RawContacts.ACCOUNT_NAME
                + "='') AND ("
        ...
        final Cursor contactIdCursor = db.rawQuery(
                "SELECT DISTINCT contact_id " +
                "FROM raw_contacts " +
                "WHERE deleted=0 AND account_type='Local Phone Account'",
                null);
        try {
            while (contactIdCursor.moveToNext()) {
                final long contactId = contactIdCursor.getLong(0);
    ...
    private void upgradeToVersion667(SQLiteDatabase db) {
        db.execSQL(
                "ALTER TABLE " + Tables.RAW_CONTACTS +
                        " ADD " + RawContacts.IS_SDN_CONTACT + " INTEGER NOT NULL DEFAULT 0;");

        db.execSQL(
                "ALTER TABLE " + Tables.CONTACTS +
                        " ADD " + Contacts.IS_SDN_CONTACT + " INTEGER NOT NULL DEFAULT 0;");

        // add IP prefix together
        db.execSQL("ALTER TABLE " + Tables.CALLS + " ADD " + Calls.IP_PREFIX
                + " TEXT DEFAULT NULL;");
    }

    private void upgradeDeleteAllSimData(SQLiteDatabase db) {
        ...
        db.execSQL("DELETE FROM raw_contacts WHERE " + RawContacts.INDICATE_PHONE_SIM + ">0");
        db.execSQL("DELETE FROM groups WHERE account_id IN ("
                + " SELECT _id FROM accounts WHERE account_type ='"
                + SimCardUtils.getSimAccountType(SimCardUtils.SimType.SIM_TYPE_USIM) + "') ");
    }
    /// @}
    ...
    private void appendPhoneLookupSelection(StringBuilder sb, String number, String numberE164) {
        ...
        if (hasNumberE164 || hasNumber) {
            ...
            if (hasNumber) {
                /** M: Android update from 4.1.2 to 4.2_r1, add if(cond) */
    ...
    public void updateRawContactDisplayName(SQLiteDatabase db, long rawContactId) {
        ...
        // / M: @{
        if (FeatureOption.MTK_SEARCH_DB_SUPPORT) {
            setNameForDialerSearch(db, rawContactId, displayNamePrimary,
    ...
    public interface DialerSearchLookupColumns {
        ...
        static final String CALL_LOG_ID = "call_log_id";
        static final String NUMBER_COUNT = "number_count";
        static final String SEARCH_DATA_OFFSETS = "search_data_offsets";
        static final String NORMALIZED_NAME_ALTERNATIVE = "normalized_name_alternative";
        static final String SEARCH_DATA_OFFSETS_ALTERNATIVE = "search_data_offsets_alternative";
        static final String IS_VISIABLE = "is_visiable";
    }

    public static final class DialerSearchLookupType {
    ...
    private void createDialerSearchTable(SQLiteDatabase db) {
        if (FeatureOption.MTK_SEARCH_DB_SUPPORT) {
            db.execSQL("CREATE TABLE " + Tables.DIALER_SEARCH + " ("
                    + DialerSearchLookupColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                    + DialerSearchLookupColumns.DATA_ID + " INTEGER REFERENCES data(_id) NOT NULL,"
    ...
    private void createDialerSearchView(SQLiteDatabase db) {
        if (FeatureOption.MTK_SEARCH_DB_SUPPORT) {
            ...
            String mDSViewSelect = "SELECT "
                    + mDSNumberTable + "." + DialerSearchLookupColumns._ID + " AS "
                    + DialerSearch.NAME_LOOKUP_ID + ","
                    + Tables.CONTACTS + "." + Contacts._ID + " AS " + DialerSearch.CONTACT_ID + ","
                    + mDSNumberTable + "." + DialerSearchLookupColumns.RAW_CONTACT_ID + " AS "
                    + DialerSearch.RAW_CONTACT_ID + ","
                    + Tables.RAW_CONTACTS + "." + RawContacts.DISPLAY_NAME_PRIMARY + " AS "
                    + DialerSearch.NAME + ","
                    + Tables.RAW_CONTACTS + "." + RawContacts.DISPLAY_NAME_ALTERNATIVE + " AS "
                    + DialerSearch.NAME_ALTERNATIVE + ","
                    + Tables.CALLS + "." + Calls.DATE + " AS " + DialerSearch.CALL_DATE + ","
                    + mDSNumberTable + "." + DialerSearchLookupColumns.CALL_LOG_ID + " AS "
                    ...
                    + Tables.CALLS + "." + Calls.GEOCODED_LOCATION + " AS "
                    + DialerSearch.CALL_GEOCODED_LOCATION + ","
                    + " (CASE "
                    + " WHEN " + mDSNumberTable + "." + DialerSearchLookupColumns.CALL_LOG_ID
                    + " > 0 "
                    ...
                    + ","
                    + Tables.CONTACTS + "." + Contacts.LOOKUP_KEY + " AS "
                    ...
                    + "," // add by MTK
                    + Tables.RAW_CONTACTS + "." + RawContacts.SORT_KEY_PRIMARY + " AS "
                    + DialerSearch.SORT_KEY_PRIMARY + ","
                    + Tables.RAW_CONTACTS + "." + RawContacts.SORT_KEY_ALTERNATIVE + " AS "
                    + DialerSearch.SORT_KEY_ALTERNATIVE + ","
                    + mDSNameTable + "." + DialerSearchLookupColumns._ID + " AS "
                    + DialerSearch.NAME_ID
                    + " FROM (SELECT * FROM " + Tables.DIALER_SEARCH + " WHERE "
                    + DialerSearchLookupColumns.NAME_TYPE + " = "
                    + DialerSearchLookupType.PHONE_EXACT + ") AS " + mDSNumberTable
                    + " LEFT JOIN " + Tables.RAW_CONTACTS + " ON " + Tables.RAW_CONTACTS + "."
                    + RawContacts._ID + " = " + mDSNumberTable + "."
                    + DialerSearchLookupColumns.RAW_CONTACT_ID
                    + " LEFT JOIN " + Tables.CONTACTS + " ON " + Tables.CONTACTS + "."
                    + Contacts._ID + " = " + Tables.RAW_CONTACTS + "." + RawContacts.CONTACT_ID
                    + " LEFT JOIN " + Tables.CALLS + " ON " + Tables.CALLS + "." + Calls._ID
                    + " = " + mDSNumberTable + "." + DialerSearchLookupColumns.CALL_LOG_ID
                    + " LEFT JOIN " + Tables.DATA + " ON " + Tables.DATA + "." + Data._ID + " = "
                    + mDSNumberTable + "." + DialerSearchLookupColumns.DATA_ID
                    + " LEFT JOIN " + Tables.DIALER_SEARCH + " AS " + mDSNameTable + " ON "
                    + mDSNameTable + "." + DialerSearchLookupColumns.RAW_CONTACT_ID + " = "
                    ...
                    + " WHERE " + Tables.CONTACTS + "." + Contacts._ID + " >0 OR " + mDSNumberTable
                    + "." + DialerSearchLookupColumns.CALL_LOG_ID + ">0";
            db.execSQL("CREATE VIEW " + Views.DIALER_SEARCH_VIEW + " AS " + mDSViewSelect);
        }
    }

    private void createContactsTriggersEx(SQLiteDatabase db) {
        if (FeatureOption.MTK_SEARCH_DB_SUPPORT) {
            createContactsTriggersWithDialerSearch(db);
        } else {
            createContactsTriggers(db);
        }
    }
    private void createContactsTriggersWithDialerSearch(SQLiteDatabase db) {
        /*
         * Automatically delete Data rows when a raw contact is deleted. For
         * dialer search, update dialer search table and calls table when a raw
         * contact is deleted.
         */
        db.execSQL("DROP TRIGGER IF EXISTS " + Tables.RAW_CONTACTS + "_deleted;");
        db.execSQL("CREATE TRIGGER " + Tables.RAW_CONTACTS + "_deleted "
        ...
        // It used to SYNC dialer_search table and calls table when a contact
        // was deleted.
        db.execSQL("CREATE TRIGGER " + Tables.RAW_CONTACTS + "_marked_deleted "
                + "   AFTER UPDATE ON " + Tables.RAW_CONTACTS
                + " BEGIN "
                ...
                + "     SET "
                + RawContacts.VERSION + "=OLD." + RawContacts.VERSION + "+1, "
                + RawContacts.TIMESTAMP + "=" + "strftime(\"%s\", 'now') * 1000"
                + "     WHERE " + RawContacts._ID + "=OLD." + RawContacts._ID
                + "       AND NEW." + RawContacts.DELETED + "!= OLD." + RawContacts.DELETED + ";"
                + " END");
        ...
        db.execSQL("CREATE TRIGGER " + Tables.AGGREGATION_EXCEPTIONS
                ...
                + "   WHERE " + DialerSearchLookupColumns.RAW_CONTACT_ID + " IN (" + "NEW."
                + AggregationExceptions.RAW_CONTACT_ID1 + ",NEW."
                + AggregationExceptions.RAW_CONTACT_ID2 + ")"
    ...
    private void setNameForDialerSearch(SQLiteDatabase db, long rawContactId,
        ...
        String mSearchName = HanziToPinyin.getInstance().getTokensForDialerSearch(displayNamePrimary, mSearchNameOffsets);
        StringBuilder mSearchNameOffsetsAlt = new StringBuilder();
        String mSearchNameAlt = HanziToPinyin.getInstance().getTokensForDialerSearch(displayNameAlternative, mSearchNameOffsetsAlt);

        bindString(mDialerSearchNameUpdate,1,mSearchName);
        bindString(mDialerSearchNameUpdate,2,mSearchNameOffsets.toString());
        bindString(mDialerSearchNameUpdate,3,mSearchNameAlt);
        bindString(mDialerSearchNameUpdate,4,mSearchNameOffsetsAlt.toString());
        mDialerSearchNameUpdate.bindLong(5, rawContactId);
        mDialerSearchNameUpdate.execute();
    }

    private void appendPresenceAndStautsTable(StringBuilder sb) {
        // append this table for some query which need presence & status
        sb.append(" LEFT OUTER JOIN " + Tables.STATUS_UPDATES + " " + ContactsStatusUpdatesColumns.ALIAS + " ON ("
                + ContactsColumns.LAST_STATUS_UPDATE_ID + "=" + ContactsStatusUpdatesColumns.CONCRETE_DATA_ID + ")");
        sb.append(" LEFT OUTER JOIN " + Tables.AGGREGATED_PRESENCE + " ON (" + RawContacts.CONTACT_ID + " = "
