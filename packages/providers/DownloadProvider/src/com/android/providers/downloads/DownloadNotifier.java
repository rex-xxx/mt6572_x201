        ...
        for (String tag : clustered.keySet()) {
            ...
            if (type == TYPE_ACTIVE || type == TYPE_WAITING) {
                ...
                builder.setContentIntent(PendingIntent.getBroadcast(mContext, 0, intent, 
                        /// M: add to updte intent instance in pendingIntent,to fix 506580. @{
                ...
                if (type == TYPE_ACTIVE) {
                    ...
                    if (Downloads.Impl.isStatusError(info.mStatus)) {
                        ...
                        if (info.mPackage != null && info.mMimeType != null) {
                            ...
                            caption = sDownloadProviderFeatureEx.getNotificationText(info.mPackage, info.mMimeType, info.mFileName);
                        }
