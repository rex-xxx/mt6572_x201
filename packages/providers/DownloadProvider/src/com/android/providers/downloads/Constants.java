...
public class Constants {
    ...
    /** M: Tag used for DRM log */
    public static final String DL_DRM = "DownloadManager/DRM";
    
    /** M: Tag used for Download enhancement log */
    ...
    /** M: The MIME type of special DRM files */
     ...
     */
    public static final int MAX_RETRIES = 20; //5
    ...
    /**
     * M: The maximum number of redirects.
     * Because we make first retry time short,
     * to ensure retry time is enough, change max redirect.
     */
    public static final int MAX_REDIRECTS = 7;//5; // can't be more than 7.

    /**
     * M: The time between a failure and the first retry after an IOException.
     * Each subsequent retry grows exponentially, doubling each time.
     * The time is in seconds.
     */
    public static final int RETRY_FIRST_DELAY = 3;//30;
    ...
    /**
     *  M: Variable to define DRM enable or not
     */
    public static final boolean MTK_DRM_ENABLED = FeatureOption.MTK_DRM_APP;
    
    
    /** 
     * M: This URI string is used to query file manager database.
     */
    public static final String FILE_MANAGER_URI = "content://com.mediatek.filemanager.provider";
    
    /** 
     *  M: Where we store downloaded audio files on the external storage.
     *  Add this to support OP02 customization
     */
    public static final String OP02_CUSTOMIZATION_AUDIO_DL_SUBDIR = "/Music";
    
    /**
     *  M: Add this to support OP01 My Favorites feature
     */
//    public static final String BROWSER_NOTIFICATION_CLASS = 
//      "com.android.browser.OpenDownloadReceiver";
//    
//    public static final String OMADL_NOTIFICATION_CLASS =
//      "com.android.providers.downloads.ui.OMADLOpenDownloadReceiver";
    ...
    /// M: network change broadcast, fix cr alps408332 @{
    public static final String ACTION_PS_STATE_RESUMED_BROADCAST = "com.mtk.ACTION_PS_STATE_RESUMED";
    /// @}

    /// M: network change broadcast, fix cr alps00641275 @{
    public static final String ACTION_EMMRRS_PS_RESUME_INDICATOR = "android.intent.action.EMMRRS_PS_RESUME";
    /// @}
}
