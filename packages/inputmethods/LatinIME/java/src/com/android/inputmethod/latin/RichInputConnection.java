...
public final class RichInputConnection {
    ...
    public void setComposingRegion(final int start, final int end) {
        ...
        /// M : Some time, there is a transitional state for input method switching,
        //      inputconection is inactive and will get null at such stage, we should
        //      try to avoid this stage from JE @{
        if (textBeforeCursor == null) {
            Log.e(TAG, "Error state for current input connection");
            throw new IllegalStateException("Invalid InputConnection");
        }
        /// @}
