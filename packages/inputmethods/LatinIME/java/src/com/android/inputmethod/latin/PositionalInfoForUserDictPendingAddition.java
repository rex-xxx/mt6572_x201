...
public class PositionalInfoForUserDictPendingAddition {
    ...
    public boolean tryReplaceWithActualWord(final RichInputConnection connection,
        ...
        /// M : Please refer to com.android.inputmethod.latin.RichInputConnection#setComposingRegion.
        //      To avoid JE on inactive inputconnection, an IllegalStateException is thrown, this
        //      exception should be caught and dealt here. Just return false to ask LatinIME remember
        //      this failed replace job and later when keyboard launched again, this replace will take
        //      place. @{
        try {
