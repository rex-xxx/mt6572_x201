...
public final class SuggestionStripView extends RelativeLayout implements OnClickListener,
    ...
    public SuggestionStripView(Context context, AttributeSet attrs, int defStyle) {
        ...
        ///M : This flag is disabled by mediatek, since this flag will force popupwindow
        //     to receive window focus, and whenever this popupwindow has gained window
        //     focus, it`s impossible for other application windows to focus on this
        //     popupwindow because this popup window is added by input method window,
        //     it has a higher priority on z-order. @{
    ...
    /// M : The scope is changed by MediaTek, it`s now ready for LatinIME
    //      to dismiss MoreSuggestionWindow on KEYCODE_BACK @{
