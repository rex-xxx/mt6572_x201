...
#include "SkRefCnt.h"
  ...
  #endif
#define MTK_MAX_SRC_BMP_FILE_SIZE (6*1024*1024)
#define MTK_MAX_SRC_BMP_PIXELS    (8*1024*1024)
#define MTK_MAX_SRC_GIF_FILE_SIZE (10*1024*1024)
#define MTK_MAX_SRC_GIF_PIXELS (1536*1024)
#else
#define MTK_MAX_SRC_JPEG_PROG_PIXELS (4096*4096)
#define MTK_MAX_SRC_BMP_FILE_SIZE (10*1024*1024)
#define MTK_MAX_SRC_BMP_PIXELS    (16*1024*1024)
#define MTK_MAX_SRC_GIF_FILE_SIZE (12*1024*1024)
#define MTK_MAX_SRC_GIF_PIXELS (1920*1088)
#endif
