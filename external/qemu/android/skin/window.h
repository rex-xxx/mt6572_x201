...
extern void skin_window_set_led_notification( SkinWindow*  window, const char* name, int  on, int off, int color );
extern void skin_window_set_vibrator_notification( SkinWindow*  window, const char* name, int  on, int off);
