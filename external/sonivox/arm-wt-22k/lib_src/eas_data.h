...
typedef struct s_eas_stream_tag
{
    void                            *pParserModule;
    //EAS_U32                         time;
    EAS_I64                         time;//Tina change type to long long
    EAS_U32                         frameLength;
    EAS_I32                         repeatCount;
    EAS_VOID_PTR                    handle;
    EAS_U8                          volume;
...
typedef struct s_eas_data_tag
{
    ...
    EAS_I32                         durationTime;
    EAS_BOOL                        mForceStopDuration;
    EAS_BOOL                        mRampUp;
    // specify whether it's IMY file with endless loop
    EAS_BOOL                        infiniteLoopFile;
} S_EAS_DATA;
