...
static void get_dir_dest(char *dir)
{
	char *delim = "/";
	char *p;
	char tmp[100];
...
int main(int argc, char *argv[])
{
	...
	printf("dir =%s,image=%s,dir_dest:%s,chunksize : %d sparesize: %d\n",dir,image,dir_dest,chunkSize,spareSize);
