...
namespace WebCore {
    ...
    public:
        ...
        void setIgnoreUserSelectNone(bool ignoreUserSelectNone) { m_ignoreUserSelectNone = ignoreUserSelectNone; }
        bool ignoreUserSelectNone() { return m_ignoreUserSelectNone; }
        /// @}
