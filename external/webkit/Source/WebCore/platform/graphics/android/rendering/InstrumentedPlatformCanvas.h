...
#endif
        /// M: Fix black tile on screen for ALPS00434141 @{
        ///  some cases the opacity is applied by layerAndroid's drawing
        ///  LayerAndroid is using DrawFilter. Must skip this case.
        if (getDrawFilter())
            m_isSolidColor = false;
        /// @}
