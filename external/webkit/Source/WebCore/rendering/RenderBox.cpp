...
IntRect RenderBox::maskClipRect()
{
    ...
    if (style()->maskBoxImage().image())
    {
        ...
        bbox.setX(bbox.x() - leftOutset);
        bbox.setY(bbox.y() - topOutset);
        bbox.setWidth(bbox.width() + leftOutset + rightOutset);
        bbox.setHeight(bbox.height() + topOutset + bottomOutset);
...
void RenderBox::paintFillLayers(const PaintInfo& paintInfo, const Color& c, const FillLayer* fillLayer, int tx, int ty, int width, int height, BackgroundBleedAvoidance bleedAvoidance, CompositeOperator op, RenderObject* backgroundObject)
{
    if (!fillLayer)
        return;
...
void RenderBox::paintFillLayer(const PaintInfo& paintInfo, const Color& c, const FillLayer* fillLayer, int tx, int ty, int width, int height, BackgroundBleedAvoidance bleedAvoidance, CompositeOperator op, RenderObject* backgroundObject)
{
