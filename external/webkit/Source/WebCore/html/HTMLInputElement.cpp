...
// According to HTML5 W3C Working Draft 2.5.5.7 Global dates and times
// date time string format : "2012-11-11T12:34Z"
const int maxDatetimeStringSize= 19;
/// @}
...
void HTMLInputElement::updateType()
{
    ...
    /// M: HTML5 date/time input type support @{
    if (isDateTime())
        m_data.setSize(maxDatetimeStringSize);
    /// @}
...
/// M: HTML5 date/time input type support @{
bool HTMLInputElement::isDateTime() const
{
    return m_inputType->formControlType() == InputTypeNames::datetimelocal() ||
           m_inputType->formControlType() == InputTypeNames::datetime() ||
           m_inputType->formControlType() == InputTypeNames::date() ||
           m_inputType->formControlType() == InputTypeNames::time() ||
           m_inputType->formControlType() == InputTypeNames::month()||
