...
P2P_BUILD_SUPPLICANT := false
ifneq ($(BOARD_P2P_SUPPLICANT_DRIVER),)
  P2P_BUILD_SUPPLICANT := true
  CONFIG_DRIVER_$(BOARD_P2P_SUPPLICANT_DRIVER) := y
else
  CONFIG_DRIVER_TEST := y
endif

ifeq ($(P2P_BUILD_SUPPLICANT),true)
...
ifeq ($(MTK_EAP_FAST), yes)
L_CFLAGS += -DMTK_EAP_FAST
endif
