...
static int eap_aka_umts_auth(struct eap_sm *sm, struct eap_aka_data *data)
{
	...
	else
	{
		...
		if(data->eap_method == EAP_TYPE_AKA)
			strcpy(conf->password,"90dca4eda45b53cf0f12d7c9c3bc6a89:cb9cccc4b9258e6dca4760379fb82581:000000000000");
		else if(data->eap_method == EAP_TYPE_AKA_PRIME)
			strcpy(conf->password,"5122250214c33e723a5dd523fc145fc0:981d464c7c52eb6e5036234984ad0bcf:16f3b3f70fc1");
