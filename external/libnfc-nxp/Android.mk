...
LOCAL_SHARED_LIBRARIES := libcutils libnfc_ndef_nxp libdl libhardware

include $(BUILD_SHARED_LIBRARY)

#
# libnfc_ndef_nxp, actually is not used in framework after JellyBeam
#
