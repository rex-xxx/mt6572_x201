...
#ifdef ANDROID
                                       , false        // wait_for_connect, true if it will block to wait for connect
                                       , false        // valid_uid, true if next parameter is a valid uid
                                       , 0            // calling_uid
#endif  //SISO Change added like http
/// @}
  );
