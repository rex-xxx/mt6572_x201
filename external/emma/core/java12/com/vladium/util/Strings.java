...
abstract class Strings
{
    ...
    public static final String CLASS_FILTER_PREFIX = "@";
    public static final String METHOD_FILTER_PREFIX="--";
        ...
        else
        {
            ...
            for (int i = 0; i < length; ++ i)
            {
                ...
                while (tokenizer.hasMoreTokens ())
                {
                    ...
                    if (ss.startsWith (CLASS_FILTER_PREFIX))
                    {
                    ...
                    //Added by MTK54039 for exclude methods.
                    else if (ss.startsWith(METHOD_FILTER_PREFIX)){
                        MethodFilter.sHasMethodFilter=MethodFilter.getExcludeMethods(new File(ss.substring(2)));
                    }
