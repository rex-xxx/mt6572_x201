...
//MTK modify for byte alignment
//origin :extern const WebRtc_Word16 WebRtcAecm_kSqrtHanning[];
extern const WebRtc_Word16 WebRtcAecm_kSqrtHanning[] __attribute__((aligned(8)));
