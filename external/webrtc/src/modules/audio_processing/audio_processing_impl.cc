...
#include <stdlib.h>
#include <string.h>
#define LOG_TAG "audio_processing_impl"
#include <utils/Log.h>
...
int AudioProcessingImpl::ProcessStream(AudioFrame* frame) {
  ...
  if (frame == NULL) {
#ifndef ANDROID_DEFAULT_CODE  	
    ALOGD("AudioProcessingImpl::ProcessStream kNullPointerError\n");
#endif    
...
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl::ProcessStream kBadSampleRateError\n");
#endif  	
...
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl::ProcessStream kBadNumberChannelsError\n");
#endif  	
  ...
  if (frame->_payloadDataLengthInSamples != samples_per_channel_*num_input_channels_) {
  	ALOGD("AudioProcessingImpl::ProcessStream kBadDataLengthError, samples_per_channel_=%d,frame->_payloadDataLengthInSamples=%d\n",samples_per_channel_,frame->_payloadDataLengthInSamples);
#else
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl high_pass_filter_ err\n");
#endif  	
    return err;
  }
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE
  	ALOGD("AudioProcessingImpl gain_control_ err\n");
#endif  	
    return err;
  }
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl echo_cancellation_ err\n");
#endif  	
    return err;
  }
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE  	
    ALOGD("AudioProcessingImpl noise_suppression_ err\n");
#endif    
    return err;
  }
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl echo_control_mobile_ err\n");
#endif  	
    return err;
  }
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE  	
    ALOGD("AudioProcessingImpl voice_detection_ err\n");
#endif    
    return err;
  }
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE  	
    ALOGD("AudioProcessingImpl gain_control_ err 2\n");
#endif    
    return err;
  }
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl level_estimator_ err\n");
#endif  	
    return err;
  }
...
int AudioProcessingImpl::AnalyzeReverseStream(AudioFrame* frame) {
  ...
  if (frame == NULL) {
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl::AnalyzeReverseStream kNullPointerError\n");
#endif  	
    return kNullPointerError;
  }
  ...
  if (frame->_frequencyInHz != sample_rate_hz_) {
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl::AnalyzeReverseStream kBadSampleRateError, _frequencyInHz=%d,sample_rate_hz_=%d\n",frame->_frequencyInHz,sample_rate_hz_);
#endif  	
    return kBadSampleRateError;
  }
...
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl::AnalyzeReverseStream kBadNumberChannelsError, _audioChannel=%d,num_reverse_channels_=%d\n",frame->_audioChannel,num_reverse_channels_);
#endif  	
    return kBadNumberChannelsError;
  }

#ifndef ANDROID_DEFAULT_CODE
  if (frame->_payloadDataLengthInSamples != samples_per_channel_*num_reverse_channels_) {
  	ALOGD("AudioProcessingImpl::AnalyzeReverseStream kBadDataLengthError, samples_per_channel_=%d,frame->_payloadDataLengthInSamples=%d\n",samples_per_channel_,frame->_payloadDataLengthInSamples);
#else
  if (frame->_payloadDataLengthInSamples != samples_per_channel_) {
#endif  	
    return kBadDataLengthError;
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl::AnalyzeReverseStream echo_cancellation_ err\n");
#endif  	
    return err;
  }
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE  	
  	ALOGD("AudioProcessingImpl::AnalyzeReverseStream echo_control_mobile_ err\n");
#endif  	
    return err;
  }
  ...
  if (err != kNoError) {
#ifndef ANDROID_DEFAULT_CODE  	
    ALOGD("AudioProcessingImpl:AnalyzeReverseStream: gain_control_ err\n");
#endif    
    return err;
  }
